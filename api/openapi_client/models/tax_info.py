...
class TaxInfo(object):
    ...
    def __init__(self, vat_id=None, company_code=None, exempt_certificate_id=None, exempt_certificate_type=None, exempt_description=None, exempt_effective_date=None, exempt_expiration_date=None, exempt_issuing_jurisdiction=None, exempt_status='No', local_vars_configuration=None):  # noqa: E501
        """TaxInfo - a model defined in OpenAPI"""  # noqa: E501
    ...
    def vat_id(self, vat_id):
        ...
        if (self.local_vars_configuration.client_side_validation and
                vat_id is not None and len(vat_id) > 25):
    ...
    def exempt_status(self, exempt_status):
        ...
        if self.local_vars_configuration.client_side_validation and exempt_status not in allowed_values:  # noqa: E501
            raise ValueError(
