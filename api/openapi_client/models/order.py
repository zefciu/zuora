...
class Order(object):
    ...
    def __init__(self, created_by=None, created_date=None, currency=None, custom_fields=None, description=None, existing_account_number=None, order_date=None, order_line_items=None, order_number=None, status=None, subscriptions=None, updated_by=None, updated_date=None, local_vars_configuration=None):  # noqa: E501
