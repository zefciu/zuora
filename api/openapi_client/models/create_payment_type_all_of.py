...
class CreatePaymentTypeAllOf(object):
    ...
    openapi_types = {
        ...
        'effective_date': 'date',
        'finance_information': 'CreatePaymentTypeAllOfFinanceInformation',
        'gateway_id': 'str',
        'gateway_options': 'CreatePaymentTypeAllOfGatewayOptions',
        'gateway_order_id': 'str',
        'invoices': 'list[PaymentInvoiceApplicationCreateRequestType]',
        'mit_transaction_source': 'str',
    ...
    def __init__(self, account_id=None, account_number=None, amount=None, auth_transaction_id=None, comment=None, currency=None, debit_memos=None, effective_date=None, finance_information=None, gateway_id=None, gateway_options=None, gateway_order_id=None, invoices=None, mit_transaction_source=None, payment_method_id=None, reference_id=None, soft_descriptor=None, soft_descriptor_phone=None, standalone=False, type=None, local_vars_configuration=None):  # noqa: E501
        """CreatePaymentTypeAllOf - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def account_id(self):
        """Gets the account_id of this CreatePaymentTypeAllOf.  # noqa: E501

        The ID of the customer account that the payment is created for.   # noqa: E501

        :return: The account_id of this CreatePaymentTypeAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def account_id(self, account_id):
        """Sets the account_id of this CreatePaymentTypeAllOf.

        The ID of the customer account that the payment is created for.   # noqa: E501

        :param account_id: The account_id of this CreatePaymentTypeAllOf.  # noqa: E501
        :type: str
        """
    ...
    def account_number(self):
        """Gets the account_number of this CreatePaymentTypeAllOf.  # noqa: E501

        The number of the customer account that the payment is created for, such as `A00000001`.  You can specify either `accountNumber` or `accountId` for a customer account. If both of them are specified, they must refer to the same customer account.   # noqa: E501

        :return: The account_number of this CreatePaymentTypeAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def account_number(self, account_number):
        """Sets the account_number of this CreatePaymentTypeAllOf.

        The number of the customer account that the payment is created for, such as `A00000001`.  You can specify either `accountNumber` or `accountId` for a customer account. If both of them are specified, they must refer to the same customer account.   # noqa: E501

        :param account_number: The account_number of this CreatePaymentTypeAllOf.  # noqa: E501
        :type: str
        """
    ...
    @property
    def amount(self):
        """Gets the amount of this CreatePaymentTypeAllOf.  # noqa: E501

        The total amount of the payment.   # noqa: E501

        :return: The amount of this CreatePaymentTypeAllOf.  # noqa: E501
        :rtype: float
        """
        return self._amount
    ...
    def amount(self, amount):
        """Sets the amount of this CreatePaymentTypeAllOf.

        The total amount of the payment.   # noqa: E501

        :param amount: The amount of this CreatePaymentTypeAllOf.  # noqa: E501
        :type: float
        """
    ...
    def auth_transaction_id(self):
        """Gets the auth_transaction_id of this CreatePaymentTypeAllOf.  # noqa: E501

        The authorization transaction ID from the payment gateway. Use this field for electronic payments, such as credit cards.  When you create a payment for capturing the authorized funds, it is highly recommended to pass in the gatewayOrderId that you used when authorizing the funds by using the [Create authorization](https://www.zuora.com/developer/api-reference/#operation/POST_CreateAuthorization) operation, together with the `authTransactionId` field.  The following payment gateways support this field:   - Adyen Integration v2.0   - CyberSource 1.28   - CyberSource 1.97   - CyberSource 2.0   - Chase Paymentech Orbital   - Ingenico ePayments   - SlimPay   - Verifi Global Payment Gateway   - WePay Payment Gateway Integration   # noqa: E501

        :return: The auth_transaction_id of this CreatePaymentTypeAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def auth_transaction_id(self, auth_transaction_id):
        """Sets the auth_transaction_id of this CreatePaymentTypeAllOf.

        The authorization transaction ID from the payment gateway. Use this field for electronic payments, such as credit cards.  When you create a payment for capturing the authorized funds, it is highly recommended to pass in the gatewayOrderId that you used when authorizing the funds by using the [Create authorization](https://www.zuora.com/developer/api-reference/#operation/POST_CreateAuthorization) operation, together with the `authTransactionId` field.  The following payment gateways support this field:   - Adyen Integration v2.0   - CyberSource 1.28   - CyberSource 1.97   - CyberSource 2.0   - Chase Paymentech Orbital   - Ingenico ePayments   - SlimPay   - Verifi Global Payment Gateway   - WePay Payment Gateway Integration   # noqa: E501

        :param auth_transaction_id: The auth_transaction_id of this CreatePaymentTypeAllOf.  # noqa: E501
        :type: str
        """
    ...
    @property
    def comment(self):
        """Gets the comment of this CreatePaymentTypeAllOf.  # noqa: E501

        Additional information related to the payment.   # noqa: E501

        :return: The comment of this CreatePaymentTypeAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def comment(self, comment):
        """Sets the comment of this CreatePaymentTypeAllOf.

        Additional information related to the payment.   # noqa: E501

        :param comment: The comment of this CreatePaymentTypeAllOf.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def currency(self):
        """Gets the currency of this CreatePaymentTypeAllOf.  # noqa: E501
        ...
        :return: The currency of this CreatePaymentTypeAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def currency(self, currency):
        """Sets the currency of this CreatePaymentTypeAllOf.

        When Standalone Payment is not enabled, the `currency` of the payment must be the same as the payment currency defined in the customer account settings through Zuora UI.  When Standalone Payment is enabled and `standalone` is `true`, the `currency` of the standalone payment can be different from the payment currency defined in the customer account settings. The amount will not be summed up to the account balance or key metrics regardless of currency.   # noqa: E501

        :param currency: The currency of this CreatePaymentTypeAllOf.  # noqa: E501
        :type: str
        """
    ...
    def debit_memos(self):
        """Gets the debit_memos of this CreatePaymentTypeAllOf.  # noqa: E501

        Container for debit memos. The maximum number of debit memos is 1,000.   # noqa: E501

        :return: The debit_memos of this CreatePaymentTypeAllOf.  # noqa: E501
    ...
    def debit_memos(self, debit_memos):
        """Sets the debit_memos of this CreatePaymentTypeAllOf.

        Container for debit memos. The maximum number of debit memos is 1,000.   # noqa: E501

        :param debit_memos: The debit_memos of this CreatePaymentTypeAllOf.  # noqa: E501
    ...
    def effective_date(self):
        """Gets the effective_date of this CreatePaymentTypeAllOf.  # noqa: E501

        The date when the payment takes effect, in `yyyy-mm-dd` format.   # noqa: E501

        :return: The effective_date of this CreatePaymentTypeAllOf.  # noqa: E501
        :rtype: date
        """
    ...
    def effective_date(self, effective_date):
        """Sets the effective_date of this CreatePaymentTypeAllOf.

        The date when the payment takes effect, in `yyyy-mm-dd` format.   # noqa: E501

        :param effective_date: The effective_date of this CreatePaymentTypeAllOf.  # noqa: E501
        :type: date
        """
    ...
    def finance_information(self):
        """Gets the finance_information of this CreatePaymentTypeAllOf.  # noqa: E501


        :return: The finance_information of this CreatePaymentTypeAllOf.  # noqa: E501
        :rtype: CreatePaymentTypeAllOfFinanceInformation
        """
        return self._finance_information

    @finance_information.setter
    def finance_information(self, finance_information):
        """Sets the finance_information of this CreatePaymentTypeAllOf.


        :param finance_information: The finance_information of this CreatePaymentTypeAllOf.  # noqa: E501
        :type: CreatePaymentTypeAllOfFinanceInformation
        """
    ...
    @property
    def gateway_id(self):
        """Gets the gateway_id of this CreatePaymentTypeAllOf.  # noqa: E501
        ...
        :return: The gateway_id of this CreatePaymentTypeAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def gateway_id(self, gateway_id):
        """Sets the gateway_id of this CreatePaymentTypeAllOf.

        The ID of the gateway instance that processes the payment. The ID must be a valid gateway instance ID and this gateway must support the specific payment method.   - When creating electronic payments, this field is required.  - When creating external payments, this field is optional.   # noqa: E501

        :param gateway_id: The gateway_id of this CreatePaymentTypeAllOf.  # noqa: E501
        :type: str
        """
    ...
    def gateway_options(self):
        """Gets the gateway_options of this CreatePaymentTypeAllOf.  # noqa: E501


        :return: The gateway_options of this CreatePaymentTypeAllOf.  # noqa: E501
        :rtype: CreatePaymentTypeAllOfGatewayOptions
        """
        return self._gateway_options

    @gateway_options.setter
    def gateway_options(self, gateway_options):
        """Sets the gateway_options of this CreatePaymentTypeAllOf.


        :param gateway_options: The gateway_options of this CreatePaymentTypeAllOf.  # noqa: E501
        :type: CreatePaymentTypeAllOfGatewayOptions
        """
    ...
    def gateway_order_id(self):
        """Gets the gateway_order_id of this CreatePaymentTypeAllOf.  # noqa: E501

        A merchant-specified natural key value that can be passed to the electronic payment gateway when a payment is created. If not specified, the payment number will be passed in instead.  Gateways check duplicates on the gateway order ID to ensure that the merchant do not accidentally enter the same transaction twice. This ID can also be used to do reconciliation and tie the payment to a natural key in external systems. The source of this ID varies by merchant. Some merchants use their shopping cart order IDs, and others use something different. Merchants use this ID to track transactions in their eCommerce systems.  When you create a payment for capturing the authorized funds, it is highly recommended to pass in the gatewayOrderId that you used when authorizing the funds by using the [Create authorization](https://www.zuora.com/developer/api-reference/#operation/POST_CreateAuthorization) operation, together with the `authTransactionId` field.   # noqa: E501

        :return: The gateway_order_id of this CreatePaymentTypeAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def gateway_order_id(self, gateway_order_id):
        """Sets the gateway_order_id of this CreatePaymentTypeAllOf.

        A merchant-specified natural key value that can be passed to the electronic payment gateway when a payment is created. If not specified, the payment number will be passed in instead.  Gateways check duplicates on the gateway order ID to ensure that the merchant do not accidentally enter the same transaction twice. This ID can also be used to do reconciliation and tie the payment to a natural key in external systems. The source of this ID varies by merchant. Some merchants use their shopping cart order IDs, and others use something different. Merchants use this ID to track transactions in their eCommerce systems.  When you create a payment for capturing the authorized funds, it is highly recommended to pass in the gatewayOrderId that you used when authorizing the funds by using the [Create authorization](https://www.zuora.com/developer/api-reference/#operation/POST_CreateAuthorization) operation, together with the `authTransactionId` field.   # noqa: E501

        :param gateway_order_id: The gateway_order_id of this CreatePaymentTypeAllOf.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                gateway_order_id is not None and len(gateway_order_id) > 50):
            raise ValueError("Invalid value for `gateway_order_id`, length must be less than or equal to `50`")  # noqa: E501

        self._gateway_order_id = gateway_order_id

    @property
    def invoices(self):
        """Gets the invoices of this CreatePaymentTypeAllOf.  # noqa: E501

        Container for invoices. The maximum number of invoices is 1,000.   # noqa: E501

        :return: The invoices of this CreatePaymentTypeAllOf.  # noqa: E501
    ...
    def invoices(self, invoices):
        """Sets the invoices of this CreatePaymentTypeAllOf.

        Container for invoices. The maximum number of invoices is 1,000.   # noqa: E501

        :param invoices: The invoices of this CreatePaymentTypeAllOf.  # noqa: E501
    ...
    def mit_transaction_source(self, mit_transaction_source):
        """Sets the mit_transaction_source of this CreatePaymentTypeAllOf.

        Payment transaction source used to differentiate the transaction source in Stored Credential Transaction framework.   - `C_Unscheduled`: Cardholder-initiated transaction (CIT) that does not occur on scheduled or regularly occurring dates.   - `M_Recurring`: Merchant-initiated transaction (MIT) that occurs at regular intervals.   - `M_Unscheduled`: Merchant-initiated transaction (MIT) that does not occur on scheduled or regularly occurring dates.   # noqa: E501

        :param mit_transaction_source: The mit_transaction_source of this CreatePaymentTypeAllOf.  # noqa: E501
        :type: str
        """
        allowed_values = ["C_Unscheduled", "M_Recurring", "M_Unscheduled"]  # noqa: E501
        if self.local_vars_configuration.client_side_validation and mit_transaction_source not in allowed_values:  # noqa: E501
            raise ValueError(
                "Invalid value for `mit_transaction_source` ({0}), must be one of {1}"  # noqa: E501
                .format(mit_transaction_source, allowed_values)
            )
    ...
    def payment_method_id(self):
        """Gets the payment_method_id of this CreatePaymentTypeAllOf.  # noqa: E501
        ...
        :return: The payment_method_id of this CreatePaymentTypeAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def payment_method_id(self, payment_method_id):
        """Sets the payment_method_id of this CreatePaymentTypeAllOf.

        The unique ID of the payment method that the customer used to make the payment.   If no payment method ID is specified in the request body, the default payment method for the customer account is used automatically. If the default payment method is different from the type of payments that you want to create, an error occurs.   # noqa: E501

        :param payment_method_id: The payment_method_id of this CreatePaymentTypeAllOf.  # noqa: E501
        :type: str
        """
    ...
    def reference_id(self):
        """Gets the reference_id of this CreatePaymentTypeAllOf.  # noqa: E501
        ...
        :return: The reference_id of this CreatePaymentTypeAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def reference_id(self, reference_id):
        """Sets the reference_id of this CreatePaymentTypeAllOf.

        The transaction ID returned by the payment gateway. Use this field to reconcile payments between your gateway and Zuora Payments.   # noqa: E501

        :param reference_id: The reference_id of this CreatePaymentTypeAllOf.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def soft_descriptor(self):
        """Gets the soft_descriptor of this CreatePaymentTypeAllOf.  # noqa: E501

        A payment gateway-specific field that maps to Zuora for the gateways, Orbital, Vantiv and Verifi.  # noqa: E501

        :return: The soft_descriptor of this CreatePaymentTypeAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def soft_descriptor(self, soft_descriptor):
        """Sets the soft_descriptor of this CreatePaymentTypeAllOf.

        A payment gateway-specific field that maps to Zuora for the gateways, Orbital, Vantiv and Verifi.  # noqa: E501

        :param soft_descriptor: The soft_descriptor of this CreatePaymentTypeAllOf.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def soft_descriptor_phone(self):
        """Gets the soft_descriptor_phone of this CreatePaymentTypeAllOf.  # noqa: E501

        A payment gateway-specific field that maps to Zuora for the gateways, Orbital, Vantiv and Verifi.  # noqa: E501

        :return: The soft_descriptor_phone of this CreatePaymentTypeAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def soft_descriptor_phone(self, soft_descriptor_phone):
        """Sets the soft_descriptor_phone of this CreatePaymentTypeAllOf.

        A payment gateway-specific field that maps to Zuora for the gateways, Orbital, Vantiv and Verifi.  # noqa: E501

        :param soft_descriptor_phone: The soft_descriptor_phone of this CreatePaymentTypeAllOf.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def standalone(self, standalone):
        """Sets the standalone of this CreatePaymentTypeAllOf.

        This field is only available if support for standalone payments is enabled.  Specify `true` to create a standalone payment that will be processed in Zuora through Zuora gateway integration but will be settled outside of Zuora.  When `standalone` is set to `true`:   - `accountId`, `amount`, `currency`, and `type` are required.    - `type` must be `Electronic`.   - `currency` of the payment can be different from the payment currency in the customer account settings.   - The amount will not be summed up into the account balance and key metrics regardless of the payment currency.   - No settlement data will be created.   - Either the applied amount or the unapplied amount of the payment is zero.   - The standalone payment cannot be applied, unapplied, or transferred.  Specify `false` to create an ordinary payment that will be created, processed, and settled in Zuora. The `currency` of an ordinary payment must be the same as the currency in the customer account settings.   # noqa: E501

        :param standalone: The standalone of this CreatePaymentTypeAllOf.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def type(self):
        """Gets the type of this CreatePaymentTypeAllOf.  # noqa: E501

        The type of the payment.   # noqa: E501

        :return: The type of this CreatePaymentTypeAllOf.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this CreatePaymentTypeAllOf.

        The type of the payment.   # noqa: E501

        :param type: The type of this CreatePaymentTypeAllOf.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreatePaymentTypeAllOf):
            return False
