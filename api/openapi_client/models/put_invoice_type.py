...
class PutInvoiceType(object):
    ...
    def __init__(self, auto_pay=None, comments=None, due_date=None, invoice_date=None, invoice_items=None, transferred_to_accounting=None, integration_id__ns=None, integration_status__ns=None, sync_date__ns=None, local_vars_configuration=None):  # noqa: E501
        """PutInvoiceType - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def comments(self):
        """Gets the comments of this PutInvoiceType.  # noqa: E501

        Additional information related to the invoice that a Zuora user added to the invoice.   # noqa: E501

        :return: The comments of this PutInvoiceType.  # noqa: E501
        :rtype: str
        """
    ...
    def comments(self, comments):
        """Sets the comments of this PutInvoiceType.

        Additional information related to the invoice that a Zuora user added to the invoice.   # noqa: E501

        :param comments: The comments of this PutInvoiceType.  # noqa: E501
        :type: str
        """
    ...
    def invoice_date(self):
        """Gets the invoice_date of this PutInvoiceType.  # noqa: E501
        ...
        :return: The invoice_date of this PutInvoiceType.  # noqa: E501
        :rtype: date
        """
    ...
    def invoice_date(self, invoice_date):
        """Sets the invoice_date of this PutInvoiceType.

        The new invoice date of the invoice. The new invoice date cannot fall in a closed accounting period.  You can only specify `invoiceDate` or `dueDate` in one request. Otherwise, an error occurs.   # noqa: E501

        :param invoice_date: The invoice_date of this PutInvoiceType.  # noqa: E501
        :type: date
        """
    ...
    def invoice_items(self):
        """Gets the invoice_items of this PutInvoiceType.  # noqa: E501

        Container for invoice items, The maximum number of items is 1,000. **Note:** Invoice items can only be updated when Unified Invoice is enabled and the invoice is a standalone invoice.   # noqa: E501

        :return: The invoice_items of this PutInvoiceType.  # noqa: E501
    ...
    def invoice_items(self, invoice_items):
        """Sets the invoice_items of this PutInvoiceType.

        Container for invoice items, The maximum number of items is 1,000. **Note:** Invoice items can only be updated when Unified Invoice is enabled and the invoice is a standalone invoice.   # noqa: E501

        :param invoice_items: The invoice_items of this PutInvoiceType.  # noqa: E501
    ...
    def integration_id__ns(self):
        """Gets the integration_id__ns of this PutInvoiceType.  # noqa: E501

        ID of the corresponding object in NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId=265).   # noqa: E501

        :return: The integration_id__ns of this PutInvoiceType.  # noqa: E501
        :rtype: str
        """
    ...
    def integration_id__ns(self, integration_id__ns):
        """Sets the integration_id__ns of this PutInvoiceType.

        ID of the corresponding object in NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId=265).   # noqa: E501

        :param integration_id__ns: The integration_id__ns of this PutInvoiceType.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def integration_status__ns(self):
        """Gets the integration_status__ns of this PutInvoiceType.  # noqa: E501
        ...
        :return: The integration_status__ns of this PutInvoiceType.  # noqa: E501
        :rtype: str
        """
    ...
    def integration_status__ns(self, integration_status__ns):
        """Sets the integration_status__ns of this PutInvoiceType.

        Status of the invoice's synchronization with NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId=265).   # noqa: E501

        :param integration_status__ns: The integration_status__ns of this PutInvoiceType.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def sync_date__ns(self):
        """Gets the sync_date__ns of this PutInvoiceType.  # noqa: E501
        ...
        :return: The sync_date__ns of this PutInvoiceType.  # noqa: E501
        :rtype: str
        """
    ...
    def sync_date__ns(self, sync_date__ns):
        """Sets the sync_date__ns of this PutInvoiceType.

        Date when the invoice was synchronized with NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId=265).   # noqa: E501

        :param sync_date__ns: The sync_date__ns of this PutInvoiceType.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
