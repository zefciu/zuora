...
class GETPublicNotificationDefinitionResponseCallout(object):
    ...
    def __init__(self, active=True, callout_auth=None, callout_baseurl=None, callout_params=None, callout_retry=True, description=None, event_type_name=None, http_method=None, id=None, name=None, required_auth=None, local_vars_configuration=None):  # noqa: E501
        """GETPublicNotificationDefinitionResponseCallout - a model defined in OpenAPI"""  # noqa: E501
