...
class PUTSubscriptionTypeAllOf(object):
    ...
    def __init__(self, add=None, application_order=None, apply_credit=None, apply_credit_balance=None, auto_renew=None, collect=False, current_term=None, current_term_period_type=None, document_date=None, externally_managed_by=None, include_existing_draft_doc_items=None, include_existing_draft_invoice_items=None, invoice=None, invoice_collect=False, invoice_separately=None, invoice_target_date=None, notes=None, preview=None, preview_type=None, remove=None, renewal_setting=None, renewal_term=None, renewal_term_period_type=None, run_billing=False, target_date=None, term_start_date=None, term_type=None, update=None, local_vars_configuration=None):  # noqa: E501
        """PUTSubscriptionTypeAllOf - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def add(self):
        """Gets the add of this PUTSubscriptionTypeAllOf.  # noqa: E501

        Container for adding one or more rate plans.   # noqa: E501

        :return: The add of this PUTSubscriptionTypeAllOf.  # noqa: E501
    ...
    @add.setter
    def add(self, add):
        """Sets the add of this PUTSubscriptionTypeAllOf.

        Container for adding one or more rate plans.   # noqa: E501

        :param add: The add of this PUTSubscriptionTypeAllOf.  # noqa: E501
    ...
    def application_order(self):
        """Gets the application_order of this PUTSubscriptionTypeAllOf.  # noqa: E501
        ...
        :return: The application_order of this PUTSubscriptionTypeAllOf.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def application_order(self, application_order):
        """Sets the application_order of this PUTSubscriptionTypeAllOf.

        The priority order to apply credit memos and/or unapplied payments to an invoice. Possible item values are: `CreditMemo`, `UnappliedPayment`.  **Note:**   - This field is valid only if the `applyCredit` field is set to `true`.   - If no value is specified for this field, the default priority order is used, [\"CreditMemo\", \"UnappliedPayment\"], to apply credit memos first and then apply unapplied payments.   - If only one item is specified, only the items of the spedified type are applied to invoices. For example, if the value is `[\"CreditMemo\"]`, only credit memos are used to apply to invoices.   # noqa: E501

        :param application_order: The application_order of this PUTSubscriptionTypeAllOf.  # noqa: E501
        :type: list[str]
        """
    ...
    def apply_credit(self):
        """Gets the apply_credit of this PUTSubscriptionTypeAllOf.  # noqa: E501
        ...
        :return: The apply_credit of this PUTSubscriptionTypeAllOf.  # noqa: E501
        :rtype: bool
        """
    ...
    def apply_credit(self, apply_credit):
        """Sets the apply_credit of this PUTSubscriptionTypeAllOf.

        Whether to automatically apply credit memos or unapplied payments, or both to an invoice.  If the value is `true`, the credit memo or unapplied payment, or both will be automatically applied to the invoice. If no value is specified or the value is `false`, no action is taken.  **Note:** This field is only available if you have [Invoice Settlement](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement) enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you want to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information.   # noqa: E501

        :param apply_credit: The apply_credit of this PUTSubscriptionTypeAllOf.  # noqa: E501
        :type: bool
        """
    ...
    def apply_credit_balance(self):
        """Gets the apply_credit_balance of this PUTSubscriptionTypeAllOf.  # noqa: E501
        ...
        :return: The apply_credit_balance of this PUTSubscriptionTypeAllOf.  # noqa: E501
        :rtype: bool
        """
    ...
    def apply_credit_balance(self, apply_credit_balance):
        """Sets the apply_credit_balance of this PUTSubscriptionTypeAllOf.

        Whether to automatically apply a credit balance to an invoice.  If the value is `true`, the credit balance is applied to the invoice. If the value is `false`, no action is taken.   To view the credit balance adjustment, retrieve the details of the invoice using the Get Invoices method.  Prerequisite: `invoice` must be `true`.   **Note:**    - If you are using the field `invoiceCollect` rather than the field `invoice`, the `invoiceCollect` value must be `true`.   - This field is deprecated if you have the Invoice Settlement feature enabled.   # noqa: E501

        :param apply_credit_balance: The apply_credit_balance of this PUTSubscriptionTypeAllOf.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def auto_renew(self):
        """Gets the auto_renew of this PUTSubscriptionTypeAllOf.  # noqa: E501

        If `true`, this subscription automatically renews at the end of the subscription term. Default is `false`.   # noqa: E501

        :return: The auto_renew of this PUTSubscriptionTypeAllOf.  # noqa: E501
        :rtype: bool
        """
    ...
    def auto_renew(self, auto_renew):
        """Sets the auto_renew of this PUTSubscriptionTypeAllOf.

        If `true`, this subscription automatically renews at the end of the subscription term. Default is `false`.   # noqa: E501

        :param auto_renew: The auto_renew of this PUTSubscriptionTypeAllOf.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def collect(self):
        """Gets the collect of this PUTSubscriptionTypeAllOf.  # noqa: E501
        ...
        :return: The collect of this PUTSubscriptionTypeAllOf.  # noqa: E501
        :rtype: bool
        """
    ...
    def collect(self, collect):
        """Sets the collect of this PUTSubscriptionTypeAllOf.

        Collects an automatic payment for a subscription. The collection generated in this operation is only for this subscription, not for the entire customer account.  If the value is `true`, the automatic payment is collected. If the value is `false`, no action is taken.  Prerequisite: The `invoice` or `runBilling` field must be `true`.   **Note**: This field is only available if you set the `zuora-version` request header to `196.0` or later.   # noqa: E501

        :param collect: The collect of this PUTSubscriptionTypeAllOf.  # noqa: E501
        :type: bool
        """
    ...
    def current_term(self):
        """Gets the current_term of this PUTSubscriptionTypeAllOf.  # noqa: E501
        ...
        :return: The current_term of this PUTSubscriptionTypeAllOf.  # noqa: E501
        :rtype: int
        """
    ...
    def current_term(self, current_term):
        """Sets the current_term of this PUTSubscriptionTypeAllOf.

        The length of the period for the current subscription term. If `termType` is `TERMED`, this field is required and must be greater than `0`. If `termType` is `EVERGREEN`, this value is ignored.   # noqa: E501

        :param current_term: The current_term of this PUTSubscriptionTypeAllOf.  # noqa: E501
        :type: int
        """
    ...
    def current_term_period_type(self):
        """Gets the current_term_period_type of this PUTSubscriptionTypeAllOf.  # noqa: E501
        ...
        :return: The current_term_period_type of this PUTSubscriptionTypeAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def current_term_period_type(self, current_term_period_type):
        """Sets the current_term_period_type of this PUTSubscriptionTypeAllOf.

        The period type for the current subscription term.  This field is used with the `CurrentTerm` field to specify the current subscription term.  Values are:  * `Month` (default) * `Year` * `Day` * `Week`   # noqa: E501

        :param current_term_period_type: The current_term_period_type of this PUTSubscriptionTypeAllOf.  # noqa: E501
        :type: str
        """
    ...
    def document_date(self):
        """Gets the document_date of this PUTSubscriptionTypeAllOf.  # noqa: E501
        ...
        :return: The document_date of this PUTSubscriptionTypeAllOf.  # noqa: E501
        :rtype: date
        """
    ...
    def document_date(self, document_date):
        """Sets the document_date of this PUTSubscriptionTypeAllOf.

        The date of the billing document, in `yyyy-mm-dd` format. It represents the invoice date for invoices, credit memo date for credit memos, and debit memo date for debit memos.  - If this field is specified, the specified date is used as the billing document date.  - If this field is not specified, the date specified in the `targetDate` is used as the billing document date.   # noqa: E501

        :param document_date: The document_date of this PUTSubscriptionTypeAllOf.  # noqa: E501
        :type: date
        """
    ...
    def externally_managed_by(self):
        """Gets the externally_managed_by of this PUTSubscriptionTypeAllOf.  # noqa: E501
        ...
        :return: The externally_managed_by of this PUTSubscriptionTypeAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def externally_managed_by(self, externally_managed_by):
        """Sets the externally_managed_by of this PUTSubscriptionTypeAllOf.

        An enum field on the Subscription object to indicate the name of a third-party store. This field is used to represent subscriptions created through third-party stores.   # noqa: E501

        :param externally_managed_by: The externally_managed_by of this PUTSubscriptionTypeAllOf.  # noqa: E501
        :type: str
        """
    ...
    def include_existing_draft_doc_items(self):
        """Gets the include_existing_draft_doc_items of this PUTSubscriptionTypeAllOf.  # noqa: E501
        ...
        :return: The include_existing_draft_doc_items of this PUTSubscriptionTypeAllOf.  # noqa: E501
        :rtype: bool
        """
    ...
    def include_existing_draft_doc_items(self, include_existing_draft_doc_items):
        """Sets the include_existing_draft_doc_items of this PUTSubscriptionTypeAllOf.

        Specifies whether to include draft invoice items in subscription previews. Values are:  * `true` (default). Includes draft invoice items in the preview result. * `false`. Excludes draft invoice items in the preview result.  **Note:** This field is in Zuora REST API version control. Supported minor versions are 207.0 or later. To use this field in the method, you must set the **zuora-version** parameter to the minor version number in the request header. See [Zuora REST API Versions](https://www.zuora.com/developer/api-reference/#section/API-Versions) for more information.   # noqa: E501

        :param include_existing_draft_doc_items: The include_existing_draft_doc_items of this PUTSubscriptionTypeAllOf.  # noqa: E501
        :type: bool
        """
    ...
    def include_existing_draft_invoice_items(self):
        """Gets the include_existing_draft_invoice_items of this PUTSubscriptionTypeAllOf.  # noqa: E501

        Specifies whether to include draft invoice items in subscription previews. Values are:  * `true` (default). Includes draft invoice items in the preview result. * `false`. Excludes draft invoice items in the preview result.  **Note:** This field is in Zuora REST API version control. Supported minor versions are 186.0, 187.0, 188.0, 189.0, and 196.0. See [Zuora REST API Versions](https://www.zuora.com/developer/api-reference/#section/API-Versions) for more information.   # noqa: E501

        :return: The include_existing_draft_invoice_items of this PUTSubscriptionTypeAllOf.  # noqa: E501
        :rtype: bool
        """
    ...
    def include_existing_draft_invoice_items(self, include_existing_draft_invoice_items):
        """Sets the include_existing_draft_invoice_items of this PUTSubscriptionTypeAllOf.

        Specifies whether to include draft invoice items in subscription previews. Values are:  * `true` (default). Includes draft invoice items in the preview result. * `false`. Excludes draft invoice items in the preview result.  **Note:** This field is in Zuora REST API version control. Supported minor versions are 186.0, 187.0, 188.0, 189.0, and 196.0. See [Zuora REST API Versions](https://www.zuora.com/developer/api-reference/#section/API-Versions) for more information.   # noqa: E501

        :param include_existing_draft_invoice_items: The include_existing_draft_invoice_items of this PUTSubscriptionTypeAllOf.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def invoice(self):
        """Gets the invoice of this PUTSubscriptionTypeAllOf.  # noqa: E501
        ...
        **Note:** This field has been replaced by the `runBilling` field. The `invoice` field is only available for backward compatibility.   Creates an invoice for a subscription. The invoice generated in this operation is only for this subscription, not for the entire customer account.   If the value is `true`, an invoice is created. If the value is `false`, no action is taken. The default value is `false`.    This field is in Zuora REST API version control. Supported minor versions are `196.0` and `207.0`. To use this field in the method, you must set the zuora-version parameter to the minor version number in the request header.    # noqa: E501
        ...
        :return: The invoice of this PUTSubscriptionTypeAllOf.  # noqa: E501
        :rtype: bool
        """
    ...
    def invoice(self, invoice):
        """Sets the invoice of this PUTSubscriptionTypeAllOf.

        **Note:** This field has been replaced by the `runBilling` field. The `invoice` field is only available for backward compatibility.   Creates an invoice for a subscription. The invoice generated in this operation is only for this subscription, not for the entire customer account.   If the value is `true`, an invoice is created. If the value is `false`, no action is taken. The default value is `false`.    This field is in Zuora REST API version control. Supported minor versions are `196.0` and `207.0`. To use this field in the method, you must set the zuora-version parameter to the minor version number in the request header.    # noqa: E501

        :param invoice: The invoice of this PUTSubscriptionTypeAllOf.  # noqa: E501
        :type: bool
        """
    ...
    def invoice_collect(self):
        """Gets the invoice_collect of this PUTSubscriptionTypeAllOf.  # noqa: E501
        ...
        **Note:** This field has been replaced by the `invoice` field and the `collect` field. `invoiceCollect` is available only for backward compatibility.   If `true`, an invoice is generated and payment collected automatically during the subscription process. If `false`, no invoicing or payment takes place.  The invoice generated in this operation is only for this subscription, not for the entire customer account.  **Note**: This field is only available if you set the `zuora-version` request header to `186.0`, `187.0`, `188.0`, or `189.0`.   # noqa: E501
        ...
        :return: The invoice_collect of this PUTSubscriptionTypeAllOf.  # noqa: E501
        :rtype: bool
        """
    ...
    def invoice_collect(self, invoice_collect):
        """Sets the invoice_collect of this PUTSubscriptionTypeAllOf.

        **Note:** This field has been replaced by the `invoice` field and the `collect` field. `invoiceCollect` is available only for backward compatibility.   If `true`, an invoice is generated and payment collected automatically during the subscription process. If `false`, no invoicing or payment takes place.  The invoice generated in this operation is only for this subscription, not for the entire customer account.  **Note**: This field is only available if you set the `zuora-version` request header to `186.0`, `187.0`, `188.0`, or `189.0`.   # noqa: E501

        :param invoice_collect: The invoice_collect of this PUTSubscriptionTypeAllOf.  # noqa: E501
        :type: bool
        """
    ...
    def invoice_separately(self):
        """Gets the invoice_separately of this PUTSubscriptionTypeAllOf.  # noqa: E501
        ...
        :return: The invoice_separately of this PUTSubscriptionTypeAllOf.  # noqa: E501
        :rtype: bool
        """
    ...
    def invoice_separately(self, invoice_separately):
        """Sets the invoice_separately of this PUTSubscriptionTypeAllOf.

        Separates a single subscription from other subscriptions and invoices the charge independently.   If the value is `true`, the subscription is billed separately from other subscriptions. If the value is `false`, the subscription is included with other subscriptions in the account invoice.  The default value is `false`. Prerequisite: The default subscription setting Enable Subscriptions to be Invoiced Separately must be set to Yes.   # noqa: E501

        :param invoice_separately: The invoice_separately of this PUTSubscriptionTypeAllOf.  # noqa: E501
        :type: bool
        """
    ...
    def invoice_target_date(self):
        """Gets the invoice_target_date of this PUTSubscriptionTypeAllOf.  # noqa: E501
        ...
        **Note:** This field has been replaced by the `targetDate` field. The `invoiceTargetDate` field is only available for backward compatibility.   Date through which to calculate charges if an invoice is generated, as yyyy-mm-dd. Default is current date.   This field is in Zuora REST API version control. Supported minor versions are `207.0` and earlier.     # noqa: E501
        ...
        :return: The invoice_target_date of this PUTSubscriptionTypeAllOf.  # noqa: E501
        :rtype: date
        """
    ...
    def invoice_target_date(self, invoice_target_date):
        """Sets the invoice_target_date of this PUTSubscriptionTypeAllOf.

        **Note:** This field has been replaced by the `targetDate` field. The `invoiceTargetDate` field is only available for backward compatibility.   Date through which to calculate charges if an invoice is generated, as yyyy-mm-dd. Default is current date.   This field is in Zuora REST API version control. Supported minor versions are `207.0` and earlier.     # noqa: E501

        :param invoice_target_date: The invoice_target_date of this PUTSubscriptionTypeAllOf.  # noqa: E501
        :type: date
        """
    ...
    @property
    def notes(self):
        """Gets the notes of this PUTSubscriptionTypeAllOf.  # noqa: E501

        String of up to 500 characters.   # noqa: E501

        :return: The notes of this PUTSubscriptionTypeAllOf.  # noqa: E501
        :rtype: str
        """
        return self._notes
    ...
    def notes(self, notes):
        """Sets the notes of this PUTSubscriptionTypeAllOf.

        String of up to 500 characters.   # noqa: E501

        :param notes: The notes of this PUTSubscriptionTypeAllOf.  # noqa: E501
        :type: str
        """
    ...
    @property
    def preview(self):
        """Gets the preview of this PUTSubscriptionTypeAllOf.  # noqa: E501

        If `true` the update is made in preview mode. The default setting is `false`.   # noqa: E501

        :return: The preview of this PUTSubscriptionTypeAllOf.  # noqa: E501
        :rtype: bool
        """
    ...
    def preview(self, preview):
        """Sets the preview of this PUTSubscriptionTypeAllOf.

        If `true` the update is made in preview mode. The default setting is `false`.   # noqa: E501

        :param preview: The preview of this PUTSubscriptionTypeAllOf.  # noqa: E501
        :type: bool
        """
    ...
    def preview_type(self):
        """Gets the preview_type of this PUTSubscriptionTypeAllOf.  # noqa: E501
        ...
        :return: The preview_type of this PUTSubscriptionTypeAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def preview_type(self, preview_type):
        """Sets the preview_type of this PUTSubscriptionTypeAllOf.

        The type of preview you will receive.   This field is in Zuora REST API version control. The supported values of this field depend on the REST API minor version you specified in the request header.   * If you do not specify the REST API minor version or specify the minor version number to one of following values in the request header:    * 186.0   * 187.0   * 188.0   * 189.0   * 196.0     The following values are supported in the **previewType** field:    * InvoiceItem   * ChargeMetrics   * InvoiceItemChargeMetrics    The default value is InvoiceItem.  * If you specify the REST API minor version to 207.0 or later in the request header, the following values are supported in the **previewType** field:    - LegalDoc   - ChargeMetrics   - LegalDocChargeMetrics    The default value is LegalDoc.  See [Zuora REST API Versions](https://www.zuora.com/developer/api-reference/#section/API-Versions) for more information.   # noqa: E501

        :param preview_type: The preview_type of this PUTSubscriptionTypeAllOf.  # noqa: E501
        :type: str
        """
    ...
    @property
    def remove(self):
        """Gets the remove of this PUTSubscriptionTypeAllOf.  # noqa: E501

        Container for removing one or more rate plans.   # noqa: E501

        :return: The remove of this PUTSubscriptionTypeAllOf.  # noqa: E501
    ...
    def remove(self, remove):
        """Sets the remove of this PUTSubscriptionTypeAllOf.

        Container for removing one or more rate plans.   # noqa: E501

        :param remove: The remove of this PUTSubscriptionTypeAllOf.  # noqa: E501
    ...
    def renewal_setting(self):
        """Gets the renewal_setting of this PUTSubscriptionTypeAllOf.  # noqa: E501
        ...
        :return: The renewal_setting of this PUTSubscriptionTypeAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def renewal_setting(self, renewal_setting):
        """Sets the renewal_setting of this PUTSubscriptionTypeAllOf.

        Specifies whether a termed subscription will remain `TERMED` or change to `EVERGREEN` when it is renewed.   Values are:  * `RENEW_WITH_SPECIFIC_TERM` (default) * `RENEW_TO_EVERGREEN`   # noqa: E501

        :param renewal_setting: The renewal_setting of this PUTSubscriptionTypeAllOf.  # noqa: E501
        :type: str
        """
    ...
    def renewal_term(self):
        """Gets the renewal_term of this PUTSubscriptionTypeAllOf.  # noqa: E501

        The length of the period for the subscription renewal term. Default is `0`.   # noqa: E501

        :return: The renewal_term of this PUTSubscriptionTypeAllOf.  # noqa: E501
        :rtype: int
        """
    ...
    def renewal_term(self, renewal_term):
        """Sets the renewal_term of this PUTSubscriptionTypeAllOf.

        The length of the period for the subscription renewal term. Default is `0`.   # noqa: E501

        :param renewal_term: The renewal_term of this PUTSubscriptionTypeAllOf.  # noqa: E501
        :type: int
        """
    ...
    def renewal_term_period_type(self):
        """Gets the renewal_term_period_type of this PUTSubscriptionTypeAllOf.  # noqa: E501
        ...
        :return: The renewal_term_period_type of this PUTSubscriptionTypeAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def renewal_term_period_type(self, renewal_term_period_type):
        """Sets the renewal_term_period_type of this PUTSubscriptionTypeAllOf.

         The period type for the subscription renewal term.  This field is used with the `renewalTerm` field to specify the subscription renewal term.  Values are:  * `Month` (default) * `Year` * `Day` * `Week`   # noqa: E501

        :param renewal_term_period_type: The renewal_term_period_type of this PUTSubscriptionTypeAllOf.  # noqa: E501
        :type: str
        """
    ...
    def run_billing(self):
        """Gets the run_billing of this PUTSubscriptionTypeAllOf.  # noqa: E501
        ...
        :return: The run_billing of this PUTSubscriptionTypeAllOf.  # noqa: E501
        :rtype: bool
        """
    ...
    def run_billing(self, run_billing):
        """Sets the run_billing of this PUTSubscriptionTypeAllOf.

        Creates an invoice for a subscription. If you have the Invoice Settlement feature enabled, a credit memo might also be created based on the [invoice and credit memo generation rule](https://knowledgecenter.zuora.com/CB_Billing/Invoice_Settlement/Credit_and_Debit_Memos/Rules_for_Generating_Invoices_and_Credit_Memos).     The billing documents generated in this operation is only for this subscription, not for the entire customer account.   Possible values:  - `true`: An invoice is created. If you have the Invoice Settlement feature enabled, a credit memo might also be created.   - `false`: No invoice is created.   **Note:** This field is in Zuora REST API version control. Supported minor versions are `211.0` or later. To use this field in the method, you must set the `zuora-version` parameter to the minor version number in the request header.   # noqa: E501

        :param run_billing: The run_billing of this PUTSubscriptionTypeAllOf.  # noqa: E501
        :type: bool
        """
    ...
    def target_date(self):
        """Gets the target_date of this PUTSubscriptionTypeAllOf.  # noqa: E501
        ...
        :return: The target_date of this PUTSubscriptionTypeAllOf.  # noqa: E501
        :rtype: date
        """
    ...
    def target_date(self, target_date):
        """Sets the target_date of this PUTSubscriptionTypeAllOf.

        Date through which to calculate charges if an invoice or a credit memo is generated, as yyyy-mm-dd. Default is current date.   **Note:** The credit memo is only available if you have the Invoice Settlement feature enabled.   This field is in Zuora REST API version control. Supported minor versions are `211.0` and later. To use this field in the method, you must set the  `zuora-version` parameter to the minor version number in the request header.   # noqa: E501

        :param target_date: The target_date of this PUTSubscriptionTypeAllOf.  # noqa: E501
        :type: date
        """
    ...
    def term_start_date(self):
        """Gets the term_start_date of this PUTSubscriptionTypeAllOf.  # noqa: E501
        ...
        :return: The term_start_date of this PUTSubscriptionTypeAllOf.  # noqa: E501
        :rtype: date
        """
    ...
    def term_start_date(self, term_start_date):
        """Sets the term_start_date of this PUTSubscriptionTypeAllOf.

        Date the subscription term begins, as yyyy-mm-dd. If this is a renewal subscription, this date is different from the subscription start date.    # noqa: E501

        :param term_start_date: The term_start_date of this PUTSubscriptionTypeAllOf.  # noqa: E501
        :type: date
        """
    ...
    @property
    def term_type(self):
        """Gets the term_type of this PUTSubscriptionTypeAllOf.  # noqa: E501

        Possible values are: `TERMED`, `EVERGREEN`.   # noqa: E501

        :return: The term_type of this PUTSubscriptionTypeAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def term_type(self, term_type):
        """Sets the term_type of this PUTSubscriptionTypeAllOf.

        Possible values are: `TERMED`, `EVERGREEN`.   # noqa: E501

        :param term_type: The term_type of this PUTSubscriptionTypeAllOf.  # noqa: E501
        :type: str
        """
    ...
    @property
    def update(self):
        """Gets the update of this PUTSubscriptionTypeAllOf.  # noqa: E501

        Container for updating one or more rate plans.   # noqa: E501

        :return: The update of this PUTSubscriptionTypeAllOf.  # noqa: E501
    ...
    def update(self, update):
        """Sets the update of this PUTSubscriptionTypeAllOf.

        Container for updating one or more rate plans.   # noqa: E501

        :param update: The update of this PUTSubscriptionTypeAllOf.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PUTSubscriptionTypeAllOf):
            return False
