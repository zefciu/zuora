...
class OrderActionRatePlanAmendment(object):
    ...
    def __init__(self, code=None, contract_effective_date=None, created_by=None, created_date=None, customer_acceptance_date=None, description=None, effective_date=None, id=None, name=None, service_activation_date=None, type=None, updated_by=None, updated_date=None, local_vars_configuration=None):  # noqa: E501
        """OrderActionRatePlanAmendment - a model defined in OpenAPI"""  # noqa: E501
