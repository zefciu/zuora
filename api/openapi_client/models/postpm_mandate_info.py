...
class POSTPMMandateInfo(object):
    ...
    def mit_transaction_id(self, mit_transaction_id):
        ...
        if (self.local_vars_configuration.client_side_validation and
                mit_transaction_id is not None and len(mit_transaction_id) > 128):
            raise ValueError("Invalid value for `mit_transaction_id`, length must be less than or equal to `128`")  # noqa: E501
