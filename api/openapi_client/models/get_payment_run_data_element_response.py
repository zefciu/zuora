...
class GETPaymentRunDataElementResponse(object):
    ...
    openapi_types = {
        ...
        'result': 'str',
        'standalone': 'bool',
        'transactions': 'list[GETPaymentRunDataTransactionElementResponse]'
    }
    ...
    def __init__(self, account_id=None, account_number=None, amount=None, amount_collected=None, amount_to_collect=None, comment=None, currency=None, document_id=None, document_type=None, error_code=None, error_message=None, payment_gateway_id=None, payment_method_id=None, result=None, standalone=None, transactions=None, local_vars_configuration=None):  # noqa: E501
        """GETPaymentRunDataElementResponse - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def account_id(self):
        """Gets the account_id of this GETPaymentRunDataElementResponse.  # noqa: E501

        The customer account ID specified in the `data` field when creating the payment run.   # noqa: E501

        :return: The account_id of this GETPaymentRunDataElementResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def account_id(self, account_id):
        """Sets the account_id of this GETPaymentRunDataElementResponse.

        The customer account ID specified in the `data` field when creating the payment run.   # noqa: E501

        :param account_id: The account_id of this GETPaymentRunDataElementResponse.  # noqa: E501
        :type: str
        """
    ...
    def account_number(self):
        """Gets the account_number of this GETPaymentRunDataElementResponse.  # noqa: E501

        The customer account number specified in the `data` field when creating the payment run.   # noqa: E501

        :return: The account_number of this GETPaymentRunDataElementResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def account_number(self, account_number):
        """Sets the account_number of this GETPaymentRunDataElementResponse.

        The customer account number specified in the `data` field when creating the payment run.   # noqa: E501

        :param account_number: The account_number of this GETPaymentRunDataElementResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def amount(self):
        """Gets the amount of this GETPaymentRunDataElementResponse.  # noqa: E501

        The amount specified in the `data` field when creating the payment run. `null` is returned if it was not specified.   # noqa: E501

        :return: The amount of this GETPaymentRunDataElementResponse.  # noqa: E501
        :rtype: float
        """
        return self._amount
    ...
    def amount(self, amount):
        """Sets the amount of this GETPaymentRunDataElementResponse.

        The amount specified in the `data` field when creating the payment run. `null` is returned if it was not specified.   # noqa: E501

        :param amount: The amount of this GETPaymentRunDataElementResponse.  # noqa: E501
        :type: float
        """
    ...
    def amount_collected(self):
        """Gets the amount_collected of this GETPaymentRunDataElementResponse.  # noqa: E501

        The amount that is collected.   # noqa: E501

        :return: The amount_collected of this GETPaymentRunDataElementResponse.  # noqa: E501
        :rtype: float
        """
    ...
    def amount_collected(self, amount_collected):
        """Sets the amount_collected of this GETPaymentRunDataElementResponse.

        The amount that is collected.   # noqa: E501

        :param amount_collected: The amount_collected of this GETPaymentRunDataElementResponse.  # noqa: E501
        :type: float
        """
    ...
    def amount_to_collect(self):
        """Gets the amount_to_collect of this GETPaymentRunDataElementResponse.  # noqa: E501

        The amount to be collected.   # noqa: E501

        :return: The amount_to_collect of this GETPaymentRunDataElementResponse.  # noqa: E501
        :rtype: float
        """
    ...
    def amount_to_collect(self, amount_to_collect):
        """Sets the amount_to_collect of this GETPaymentRunDataElementResponse.

        The amount to be collected.   # noqa: E501

        :param amount_to_collect: The amount_to_collect of this GETPaymentRunDataElementResponse.  # noqa: E501
        :type: float
        """
    ...
    @property
    def comment(self):
        """Gets the comment of this GETPaymentRunDataElementResponse.  # noqa: E501

        The comment specified in the `data` field when creating the payment run. `null` is returned if it was not specified.   # noqa: E501

        :return: The comment of this GETPaymentRunDataElementResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def comment(self, comment):
        """Sets the comment of this GETPaymentRunDataElementResponse.

        The comment specified in the `data` field when creating the payment run. `null` is returned if it was not specified.   # noqa: E501

        :param comment: The comment of this GETPaymentRunDataElementResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def currency(self):
        """Gets the currency of this GETPaymentRunDataElementResponse.  # noqa: E501

        This field is only available if support for standalone payments is enabled.  The currency of the standalone payment. The currency of the standalone payment can be different from the payment currency defined in the customer account settings.   # noqa: E501

        :return: The currency of this GETPaymentRunDataElementResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def currency(self, currency):
        """Sets the currency of this GETPaymentRunDataElementResponse.

        This field is only available if support for standalone payments is enabled.  The currency of the standalone payment. The currency of the standalone payment can be different from the payment currency defined in the customer account settings.   # noqa: E501

        :param currency: The currency of this GETPaymentRunDataElementResponse.  # noqa: E501
        :type: str
        """
    ...
    def document_id(self):
        """Gets the document_id of this GETPaymentRunDataElementResponse.  # noqa: E501

        The billing document ID specified in the `data` field when creating the payment run. `null` is returned if it was not specified.   # noqa: E501

        :return: The document_id of this GETPaymentRunDataElementResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def document_id(self, document_id):
        """Sets the document_id of this GETPaymentRunDataElementResponse.

        The billing document ID specified in the `data` field when creating the payment run. `null` is returned if it was not specified.   # noqa: E501

        :param document_id: The document_id of this GETPaymentRunDataElementResponse.  # noqa: E501
        :type: str
        """
    ...
    def document_type(self):
        """Gets the document_type of this GETPaymentRunDataElementResponse.  # noqa: E501

        The billing document type specified in the `data` field when creating the payment run. `null` is returned if it was not specified.   # noqa: E501

        :return: The document_type of this GETPaymentRunDataElementResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def document_type(self, document_type):
        """Sets the document_type of this GETPaymentRunDataElementResponse.

        The billing document type specified in the `data` field when creating the payment run. `null` is returned if it was not specified.   # noqa: E501

        :param document_type: The document_type of this GETPaymentRunDataElementResponse.  # noqa: E501
        :type: str
        """
        allowed_values = ["Invoice", "DebitMemo"]  # noqa: E501
    ...
    @property
    def error_code(self):
        """Gets the error_code of this GETPaymentRunDataElementResponse.  # noqa: E501

        The error code of the response.   # noqa: E501

        :return: The error_code of this GETPaymentRunDataElementResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def error_code(self, error_code):
        """Sets the error_code of this GETPaymentRunDataElementResponse.

        The error code of the response.   # noqa: E501

        :param error_code: The error_code of this GETPaymentRunDataElementResponse.  # noqa: E501
        :type: str
        """
    ...
    def error_message(self):
        """Gets the error_message of this GETPaymentRunDataElementResponse.  # noqa: E501

        The detailed information of the error response.   # noqa: E501

        :return: The error_message of this GETPaymentRunDataElementResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def error_message(self, error_message):
        """Sets the error_message of this GETPaymentRunDataElementResponse.

        The detailed information of the error response.   # noqa: E501

        :param error_message: The error_message of this GETPaymentRunDataElementResponse.  # noqa: E501
        :type: str
        """
    ...
    def payment_gateway_id(self):
        """Gets the payment_gateway_id of this GETPaymentRunDataElementResponse.  # noqa: E501

        The payment gateway ID specified in the `data` field when creating the payment run. `null` is returned if it was not specified.   # noqa: E501

        :return: The payment_gateway_id of this GETPaymentRunDataElementResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def payment_gateway_id(self, payment_gateway_id):
        """Sets the payment_gateway_id of this GETPaymentRunDataElementResponse.

        The payment gateway ID specified in the `data` field when creating the payment run. `null` is returned if it was not specified.   # noqa: E501

        :param payment_gateway_id: The payment_gateway_id of this GETPaymentRunDataElementResponse.  # noqa: E501
        :type: str
        """
    ...
    def payment_method_id(self):
        """Gets the payment_method_id of this GETPaymentRunDataElementResponse.  # noqa: E501

        The payment method ID specified in the `data` field when creating the payment run. `null` is returned if it was not specified.   # noqa: E501

        :return: The payment_method_id of this GETPaymentRunDataElementResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def payment_method_id(self, payment_method_id):
        """Sets the payment_method_id of this GETPaymentRunDataElementResponse.

        The payment method ID specified in the `data` field when creating the payment run. `null` is returned if it was not specified.   # noqa: E501

        :param payment_method_id: The payment_method_id of this GETPaymentRunDataElementResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def result(self):
        """Gets the result of this GETPaymentRunDataElementResponse.  # noqa: E501

        Indicates whether the data is processed successfully or not.   # noqa: E501

        :return: The result of this GETPaymentRunDataElementResponse.  # noqa: E501
        :rtype: str
        """
        return self._result
    ...
    def result(self, result):
        """Sets the result of this GETPaymentRunDataElementResponse.

        Indicates whether the data is processed successfully or not.   # noqa: E501

        :param result: The result of this GETPaymentRunDataElementResponse.  # noqa: E501
        :type: str
        """
        allowed_values = ["Processed", "Error"]  # noqa: E501
    ...
    def standalone(self, standalone):
        """Sets the standalone of this GETPaymentRunDataElementResponse.

        This field is only available if the support for standalone payment is enabled.  The value `true` indicates this is a standalone payment that is created and processed in Zuora through Zuora gateway integration but will be settled outside of Zuora. No settlement data will be created. The standalone payment cannot be applied, unapplied, or transferred.   # noqa: E501

        :param standalone: The standalone of this GETPaymentRunDataElementResponse.  # noqa: E501
        :type: bool
        """
    ...
    def transactions(self):
        """Gets the transactions of this GETPaymentRunDataElementResponse.  # noqa: E501

        Container for transactions that apply to the current request. Each element contains an array of the settlement/payment applied to the record.   # noqa: E501

        :return: The transactions of this GETPaymentRunDataElementResponse.  # noqa: E501
        :rtype: list[GETPaymentRunDataTransactionElementResponse]
        """
        return self._transactions

    @transactions.setter
    def transactions(self, transactions):
        """Sets the transactions of this GETPaymentRunDataElementResponse.

        Container for transactions that apply to the current request. Each element contains an array of the settlement/payment applied to the record.   # noqa: E501

        :param transactions: The transactions of this GETPaymentRunDataElementResponse.  # noqa: E501
        :type: list[GETPaymentRunDataTransactionElementResponse]
        """
