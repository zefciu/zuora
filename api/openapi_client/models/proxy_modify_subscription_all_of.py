...
class ProxyModifySubscriptionAllOf(object):
    ...
    def __init__(self, account_id=None, auto_renew=None, cancelled_date=None, contract_acceptance_date=None, contract_effective_date=None, current_term_period_type=None, externally_managed_by=None, initial_term=None, initial_term_period_type=None, invoice_owner_id=None, is_invoice_separate=None, name=None, notes=None, renewal_setting=None, renewal_term=None, renewal_term_period_type=None, service_activation_date=None, status=None, term_start_date=None, term_type=None, version=None, local_vars_configuration=None):  # noqa: E501
        """ProxyModifySubscriptionAllOf - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def account_id(self):
        """Gets the account_id of this ProxyModifySubscriptionAllOf.  # noqa: E501

         This field can be updated when **Status** is `Draft`. The ID of a valid account ID.   # noqa: E501

        :return: The account_id of this ProxyModifySubscriptionAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def account_id(self, account_id):
        """Sets the account_id of this ProxyModifySubscriptionAllOf.

         This field can be updated when **Status** is `Draft`. The ID of a valid account ID.   # noqa: E501

        :param account_id: The account_id of this ProxyModifySubscriptionAllOf.  # noqa: E501
        :type: str
        """
    ...
    @property
    def auto_renew(self):
        """Gets the auto_renew of this ProxyModifySubscriptionAllOf.  # noqa: E501
        ...
        :return: The auto_renew of this ProxyModifySubscriptionAllOf.  # noqa: E501
        :rtype: bool
        """
    ...
    def auto_renew(self, auto_renew):
        """Sets the auto_renew of this ProxyModifySubscriptionAllOf.

         This field can be updated when **Status** is `Draft`. Indicates if the subscription automatically renews at the end of the term. **Values**: `true`, `false`   # noqa: E501

        :param auto_renew: The auto_renew of this ProxyModifySubscriptionAllOf.  # noqa: E501
        :type: bool
        """
    ...
    def cancelled_date(self):
        """Gets the cancelled_date of this ProxyModifySubscriptionAllOf.  # noqa: E501

         The date of the Amendment object. **Values**: inherited from `Amendment.EffectiveDate`   # noqa: E501

        :return: The cancelled_date of this ProxyModifySubscriptionAllOf.  # noqa: E501
        :rtype: date
        """
    ...
    def cancelled_date(self, cancelled_date):
        """Sets the cancelled_date of this ProxyModifySubscriptionAllOf.

         The date of the Amendment object. **Values**: inherited from `Amendment.EffectiveDate`   # noqa: E501

        :param cancelled_date: The cancelled_date of this ProxyModifySubscriptionAllOf.  # noqa: E501
        :type: date
        """
    ...
    def contract_acceptance_date(self, contract_acceptance_date):
        """Sets the contract_acceptance_date of this ProxyModifySubscriptionAllOf.

        The date when the customer accepts the contract.  This field can be updated when **Status** is `Pending Acceptance`.  **Note** : This field is only required in the Subscribe call if the [Require Customer Acceptance of Orders?](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Billing_Settings/Define_Default_Subscription_and_Order_Settings#Require_Customer_Acceptance_of_Orders.3F) setting is set to `Yes`. If this setting is set to `Yes`:   * If the `ServiceActivationDate` field is required, you must set this field, `ServiceActivationDate`, and `ContractEffectiveDate` fields in the Subscribe call to activate a subscription.  * If the `ServiceActivationDate` field is not required, you must set both this field and the `ContractEffectiveDate` field in the Subscribe call to activate a subscription. If you only set a valid date in the `ContractEffectiveDate` field, the Subscribe call still returns success, but the subscription is in `Pending Acceptance` status.  This field can also be updated when the subscription is still on version one (has not been amended before) and the [Allow update Subscription trigger dates?](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Billing_Settings/Define_Default_Subscription_and_Order_Settings#Allow_update_Subscription_trigger_dates.3F) setting in Billing Settings is set to `Yes`.    # noqa: E501

        :param contract_acceptance_date: The contract_acceptance_date of this ProxyModifySubscriptionAllOf.  # noqa: E501
        :type: date
        """
    ...
    def contract_effective_date(self):
        """Gets the contract_effective_date of this ProxyModifySubscriptionAllOf.  # noqa: E501
        ...
        :return: The contract_effective_date of this ProxyModifySubscriptionAllOf.  # noqa: E501
        :rtype: date
        """
    ...
    def contract_effective_date(self, contract_effective_date):
        """Sets the contract_effective_date of this ProxyModifySubscriptionAllOf.

        The date when the contract takes effect.  This field can be updated when **Status** is `Draft`.  **Note**: This field is required in the Subscribe call. If you set the value of this field to null and both the ServiceActivationDate and ContractAcceptanceDate fields are not required, the Subscribe call still returns success, but the new subscription is in `DRAFT` status. To activate the subscription, you must set a valid date to this field.  This field can also be updated when the subscription is still on version one (has not been amended before) and the [Allow update Subscription trigger dates?](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Billing_Settings/Define_Default_Subscription_and_Order_Settings#Allow_update_Subscription_trigger_dates.3F) setting in Billing Settings is set to \"Yes\".   # noqa: E501

        :param contract_effective_date: The contract_effective_date of this ProxyModifySubscriptionAllOf.  # noqa: E501
        :type: date
        """
    ...
    def current_term_period_type(self):
        """Gets the current_term_period_type of this ProxyModifySubscriptionAllOf.  # noqa: E501
        ...
        :return: The current_term_period_type of this ProxyModifySubscriptionAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def current_term_period_type(self, current_term_period_type):
        """Sets the current_term_period_type of this ProxyModifySubscriptionAllOf.

         The period type for the current subscription term. This field is used with the CurrentTerm field to specify the current subscription term. **Values**:  - `Month` (default) - `Year` - `Day` - `Week`   # noqa: E501

        :param current_term_period_type: The current_term_period_type of this ProxyModifySubscriptionAllOf.  # noqa: E501
        :type: str
        """
    ...
    def externally_managed_by(self):
        """Gets the externally_managed_by of this ProxyModifySubscriptionAllOf.  # noqa: E501
        ...
        :return: The externally_managed_by of this ProxyModifySubscriptionAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def externally_managed_by(self, externally_managed_by):
        """Sets the externally_managed_by of this ProxyModifySubscriptionAllOf.

        An enum field on the Subscription object to indicate the name of a third-party store. This field is used to represent subscriptions created through third-party stores.   # noqa: E501

        :param externally_managed_by: The externally_managed_by of this ProxyModifySubscriptionAllOf.  # noqa: E501
        :type: str
        """
    ...
    def initial_term(self):
        """Gets the initial_term of this ProxyModifySubscriptionAllOf.  # noqa: E501

         The length of the period for the first subscription term. This field can be updated when Status is `Draft`. **Required**: If TermType is Termed **Character limit**: 20 **Values**: any valid number.   # noqa: E501

        :return: The initial_term of this ProxyModifySubscriptionAllOf.  # noqa: E501
        :rtype: int
        """
    ...
    def initial_term(self, initial_term):
        """Sets the initial_term of this ProxyModifySubscriptionAllOf.

         The length of the period for the first subscription term. This field can be updated when Status is `Draft`. **Required**: If TermType is Termed **Character limit**: 20 **Values**: any valid number.   # noqa: E501

        :param initial_term: The initial_term of this ProxyModifySubscriptionAllOf.  # noqa: E501
        :type: int
        """
    ...
    def initial_term_period_type(self):
        """Gets the initial_term_period_type of this ProxyModifySubscriptionAllOf.  # noqa: E501
        ...
        :return: The initial_term_period_type of this ProxyModifySubscriptionAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def initial_term_period_type(self, initial_term_period_type):
        """Sets the initial_term_period_type of this ProxyModifySubscriptionAllOf.

         The period type for the first subscription term. **Values**:  - `Month` (default) - `Year` - `Day` - `Week` **Note**:  - This field can be updated when Status is `Draft`. - This field is used with the InitialTerm field to specify the initial subscription term.   # noqa: E501

        :param initial_term_period_type: The initial_term_period_type of this ProxyModifySubscriptionAllOf.  # noqa: E501
        :type: str
        """
    ...
    def invoice_owner_id(self):
        """Gets the invoice_owner_id of this ProxyModifySubscriptionAllOf.  # noqa: E501

         This field can be updated when **Status** is `Draft`. A valid account ID.   # noqa: E501

        :return: The invoice_owner_id of this ProxyModifySubscriptionAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def invoice_owner_id(self, invoice_owner_id):
        """Sets the invoice_owner_id of this ProxyModifySubscriptionAllOf.

         This field can be updated when **Status** is `Draft`. A valid account ID.   # noqa: E501

        :param invoice_owner_id: The invoice_owner_id of this ProxyModifySubscriptionAllOf.  # noqa: E501
        :type: str
        """
    ...
    def is_invoice_separate(self):
        """Gets the is_invoice_separate of this ProxyModifySubscriptionAllOf.  # noqa: E501
        ...
        :return: The is_invoice_separate of this ProxyModifySubscriptionAllOf.  # noqa: E501
        :rtype: bool
        """
    ...
    def is_invoice_separate(self, is_invoice_separate):
        """Sets the is_invoice_separate of this ProxyModifySubscriptionAllOf.

         Determines if the subscription is invoiced separately. If `TRUE`, then all charges for this subscription are collected into the subscription's own invoice. **Values**: `TRUE`, `FALSE `(default)   # noqa: E501

        :param is_invoice_separate: The is_invoice_separate of this ProxyModifySubscriptionAllOf.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def name(self):
        """Gets the name of this ProxyModifySubscriptionAllOf.  # noqa: E501
        ...
        :return: The name of this ProxyModifySubscriptionAllOf.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ProxyModifySubscriptionAllOf.

         The unique identifier of the subscription. If you don't specify a value, then Zuora generates a name automatically. Whether auto-generated or manually specified, the subscription name must be unique. Otherwise an error will occur. **Character limit**: 100 **Values**: one of the following:  - leave null to automatically generate - a string of 100 characters or fewer   # noqa: E501

        :param name: The name of this ProxyModifySubscriptionAllOf.  # noqa: E501
        :type: str
        """
    ...
    @property
    def notes(self):
        """Gets the notes of this ProxyModifySubscriptionAllOf.  # noqa: E501
        ...
        :return: The notes of this ProxyModifySubscriptionAllOf.  # noqa: E501
        :rtype: str
        """
        return self._notes
    ...
    def notes(self, notes):
        """Sets the notes of this ProxyModifySubscriptionAllOf.

         Use this field to record comments about the subscription. **Character limit**: 500 **Values**: a string of 500 characters or fewer   # noqa: E501

        :param notes: The notes of this ProxyModifySubscriptionAllOf.  # noqa: E501
        :type: str
        """
    ...
    def renewal_setting(self):
        """Gets the renewal_setting of this ProxyModifySubscriptionAllOf.  # noqa: E501
        ...
        :return: The renewal_setting of this ProxyModifySubscriptionAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def renewal_setting(self, renewal_setting):
        """Sets the renewal_setting of this ProxyModifySubscriptionAllOf.

         This field can be updated when **Status** is `Draft`. Specifies whether a termed subscription will remain termed or change to evergreen when it is renewed. **Required**: If TermType is Termed **Values**: `RENEW_WITH_SPECIFIC_TERM `(default), `RENEW_TO_EVERGREEN`   # noqa: E501

        :param renewal_setting: The renewal_setting of this ProxyModifySubscriptionAllOf.  # noqa: E501
        :type: str
        """
    ...
    def renewal_term(self):
        """Gets the renewal_term of this ProxyModifySubscriptionAllOf.  # noqa: E501
        ...
        :return: The renewal_term of this ProxyModifySubscriptionAllOf.  # noqa: E501
        :rtype: int
        """
    ...
    def renewal_term(self, renewal_term):
        """Sets the renewal_term of this ProxyModifySubscriptionAllOf.

         The length of the period for the subscription renewal term. This field can be updated when **Status** is `Draft`. **Required**: If TermType is Termed. **Character limit**: 20 **Values**: one of the following:  - leave null to default to `0` - any number   # noqa: E501

        :param renewal_term: The renewal_term of this ProxyModifySubscriptionAllOf.  # noqa: E501
        :type: int
        """
    ...
    def renewal_term_period_type(self):
        """Gets the renewal_term_period_type of this ProxyModifySubscriptionAllOf.  # noqa: E501
        ...
        :return: The renewal_term_period_type of this ProxyModifySubscriptionAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def renewal_term_period_type(self, renewal_term_period_type):
        """Sets the renewal_term_period_type of this ProxyModifySubscriptionAllOf.

         The period type for the subscription renewal term. **Values**:  - `Month` (default) - `Year` - `Day` - `Week` **Note**:  - This field is used with the RenewalTerm field to specify the subscription renewal term. - This field can be updated when Status is `Draft`.   # noqa: E501

        :param renewal_term_period_type: The renewal_term_period_type of this ProxyModifySubscriptionAllOf.  # noqa: E501
        :type: str
        """
    ...
    def service_activation_date(self, service_activation_date):
        """Sets the service_activation_date of this ProxyModifySubscriptionAllOf.

        The date when the subscription is activated.   **Character limit**: 29  This field can be updated when **Status** is `Pending Activation`.  **Note**: This field is only required in the Subscribe call if the [Require Service Activation of Orders?](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Billing_Settings/Define_Default_Subscription_and_Order_Settings#Require_Service_Activation_of_Orders.3F) setting is set to `Yes`. If this setting is set to `Yes`:   * If the `ContractAcceptanceDate` field is required, you must set this field, `ContractAcceptanceDate`, and `ContractEffectiveDate` fields in the Subscribe call to activate a subscription.  * If the `ContractAcceptanceDate` field is not required, you must set both this field and the `ContractEffectiveDate` field in the Subscribe call to activate a subscription. If you only set a valid date in the `ContractEffectiveDate` field, the Subscribe call still returns success, but the subscription is in `Pending Activation` status.  This field can also be updated when the subscription is still on version one (has not been amended before) and the [Allow update Subscription trigger dates?](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Billing_Settings/Define_Default_Subscription_and_Order_Settings#Allow_update_Subscription_trigger_dates.3F) setting in Billing Settings is set to \"Yes\".    # noqa: E501

        :param service_activation_date: The service_activation_date of this ProxyModifySubscriptionAllOf.  # noqa: E501
        :type: date
        """
    ...
    @property
    def status(self):
        """Gets the status of this ProxyModifySubscriptionAllOf.  # noqa: E501
        ...
        :return: The status of this ProxyModifySubscriptionAllOf.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this ProxyModifySubscriptionAllOf.

         The status of the subscription. **Character limit**: 17 **Values**: automatically generated **Possible values**: one of the following:  - `Draft` - `Pending Activation` - `Pending Acceptance` - `Active` - `Cancelled` - `Expired` - `Suspended` (This value is in **Limited Availability**.)   # noqa: E501

        :param status: The status of this ProxyModifySubscriptionAllOf.  # noqa: E501
        :type: str
        """
    ...
    def term_start_date(self):
        """Gets the term_start_date of this ProxyModifySubscriptionAllOf.  # noqa: E501
        ...
        :return: The term_start_date of this ProxyModifySubscriptionAllOf.  # noqa: E501
        :rtype: date
        """
    ...
    def term_start_date(self, term_start_date):
        """Sets the term_start_date of this ProxyModifySubscriptionAllOf.

         This field can be updated when **Status** is `Draft`. The date when the subscription term begins. If this is a renewal subscription, then this date is different from the subscription start date. **Character limit**: 29 **Version notes**: --   # noqa: E501

        :param term_start_date: The term_start_date of this ProxyModifySubscriptionAllOf.  # noqa: E501
        :type: date
        """
    ...
    @property
    def term_type(self):
        """Gets the term_type of this ProxyModifySubscriptionAllOf.  # noqa: E501
        ...
        :return: The term_type of this ProxyModifySubscriptionAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def term_type(self, term_type):
        """Sets the term_type of this ProxyModifySubscriptionAllOf.

         This field can be updated when **Status** is `Draft`. Indicates if a subscription is termed or evergreen. **Character limit**: 9 **Values**: `TERMED`, `EVERGREEN`   # noqa: E501

        :param term_type: The term_type of this ProxyModifySubscriptionAllOf.  # noqa: E501
        :type: str
        """
    ...
    @property
    def version(self):
        """Gets the version of this ProxyModifySubscriptionAllOf.  # noqa: E501

         The version number of the subscription. **Values**: automatically generated   # noqa: E501

        :return: The version of this ProxyModifySubscriptionAllOf.  # noqa: E501
        :rtype: int
        """
    ...
    def version(self, version):
        """Sets the version of this ProxyModifySubscriptionAllOf.

         The version number of the subscription. **Values**: automatically generated   # noqa: E501

        :param version: The version of this ProxyModifySubscriptionAllOf.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProxyModifySubscriptionAllOf):
            return False
