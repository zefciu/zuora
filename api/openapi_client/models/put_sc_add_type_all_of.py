...
class PUTScAddTypeAllOf(object):
    ...
    def apply_discount_to(self):
        """Gets the apply_discount_to of this PUTScAddTypeAllOf.  # noqa: E501
        ...
        :return: The apply_discount_to of this PUTScAddTypeAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def apply_discount_to(self, apply_discount_to):
        """Sets the apply_discount_to of this PUTScAddTypeAllOf.

        Specifies the type of charges that you want a specific discount to apply to.  Values:  * `ONETIME` * `RECURRING` * `USAGE` * `ONETIMERECURRING` * `ONETIMEUSAGE` * `RECURRINGUSAGE` * `ONETIMERECURRINGUSAGE`  Available for the following charge type for the Discount-Fixed Amount and Discount-Percentage charge models:  * Recurring   # noqa: E501

        :param apply_discount_to: The apply_discount_to of this PUTScAddTypeAllOf.  # noqa: E501
        :type: str
        """
    ...
    def bill_cycle_day(self):
        """Gets the bill_cycle_day of this PUTScAddTypeAllOf.  # noqa: E501
        ...
        :return: The bill_cycle_day of this PUTScAddTypeAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def bill_cycle_day(self, bill_cycle_day):
        """Sets the bill_cycle_day of this PUTScAddTypeAllOf.

        Sets the bill cycle day (BCD) for the charge. The BCD determines which day of the month customer is billed.  Values: `1`-`31`  Available for the following charge types:  * Recurring * Usage-based   # noqa: E501

        :param bill_cycle_day: The bill_cycle_day of this PUTScAddTypeAllOf.  # noqa: E501
        :type: str
        """
    ...
    def bill_cycle_type(self):
        """Gets the bill_cycle_type of this PUTScAddTypeAllOf.  # noqa: E501
        ...
        :return: The bill_cycle_type of this PUTScAddTypeAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def bill_cycle_type(self, bill_cycle_type):
        """Sets the bill_cycle_type of this PUTScAddTypeAllOf.

        Specifies how to determine the billing day for the charge. When this field is set to `SpecificDayofMonth`, set the `BillCycleDay` field. When this field is set to `SpecificDayofWeek`, set the `weeklyBillCycleDay` field.  Values:  * `DefaultFromCustomer` * `SpecificDayofMonth` * `SubscriptionStartDay` * `ChargeTriggerDay` * `SpecificDayofWeek`  Available for the following charge types:  * Recurring * Usage-based   # noqa: E501

        :param bill_cycle_type: The bill_cycle_type of this PUTScAddTypeAllOf.  # noqa: E501
        :type: str
        """
    ...
    def billing_period(self):
        """Gets the billing_period of this PUTScAddTypeAllOf.  # noqa: E501
        ...
        :return: The billing_period of this PUTScAddTypeAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def billing_period(self, billing_period):
        """Sets the billing_period of this PUTScAddTypeAllOf.

        Billing period for the charge. The start day of the billing period is also called the bill cycle day (BCD).  Values:  * `Month` * `Quarter` * `Semi_Annual` * `Annual` * `Eighteen_Months` * `Two_Years` * `Three_Years` * `Five_Years` * `Specific_Months` * `Subscription_Term` * `Week` * `Specific_Weeks`  Available for the following charge types:  * Recurring * Usage-based   # noqa: E501

        :param billing_period: The billing_period of this PUTScAddTypeAllOf.  # noqa: E501
        :type: str
        """
    ...
    def billing_period_alignment(self):
        """Gets the billing_period_alignment of this PUTScAddTypeAllOf.  # noqa: E501
        ...
        :return: The billing_period_alignment of this PUTScAddTypeAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def billing_period_alignment(self, billing_period_alignment):
        """Sets the billing_period_alignment of this PUTScAddTypeAllOf.

        Aligns charges within the same subscription if multiple charges begin on different dates.  Values:  * `AlignToCharge` * `AlignToSubscriptionStart` * `AlignToTermStart`  Available for the following charge types:  * Recurring * Usage-based   # noqa: E501

        :param billing_period_alignment: The billing_period_alignment of this PUTScAddTypeAllOf.  # noqa: E501
        :type: str
        """
    ...
    def billing_timing(self):
        """Gets the billing_timing of this PUTScAddTypeAllOf.  # noqa: E501
        ...
        :return: The billing_timing of this PUTScAddTypeAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def billing_timing(self, billing_timing):
        """Sets the billing_timing of this PUTScAddTypeAllOf.

        Billing timing for the charge for recurring charge types. Not avaliable for one time, usage and discount charges.  Values:  * `IN_ADVANCE` (default) * `IN_ARREARS`   # noqa: E501

        :param billing_timing: The billing_timing of this PUTScAddTypeAllOf.  # noqa: E501
        :type: str
        """
    ...
    def charge_model_configuration(self):
        """Gets the charge_model_configuration of this PUTScAddTypeAllOf.  # noqa: E501


        :return: The charge_model_configuration of this PUTScAddTypeAllOf.  # noqa: E501
    ...
    def charge_model_configuration(self, charge_model_configuration):
        """Sets the charge_model_configuration of this PUTScAddTypeAllOf.


        :param charge_model_configuration: The charge_model_configuration of this PUTScAddTypeAllOf.  # noqa: E501
    ...
    def description(self):
        """Gets the description of this PUTScAddTypeAllOf.  # noqa: E501

        Description of the charge.   # noqa: E501

        :return: The description of this PUTScAddTypeAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this PUTScAddTypeAllOf.

        Description of the charge.   # noqa: E501

        :param description: The description of this PUTScAddTypeAllOf.  # noqa: E501
        :type: str
        """
    ...
    def discount_amount(self):
        """Gets the discount_amount of this PUTScAddTypeAllOf.  # noqa: E501
        ...
        :return: The discount_amount of this PUTScAddTypeAllOf.  # noqa: E501
        :rtype: float
        """
    ...
    def discount_amount(self, discount_amount):
        """Sets the discount_amount of this PUTScAddTypeAllOf.

        Specifies the amount of fixed-amount discount.  Available for the following charge type for the Discount-Fixed Amount charge model:  * Recurring   # noqa: E501

        :param discount_amount: The discount_amount of this PUTScAddTypeAllOf.  # noqa: E501
        :type: float
        """
    ...
    def discount_level(self):
        """Gets the discount_level of this PUTScAddTypeAllOf.  # noqa: E501
        ...
        :return: The discount_level of this PUTScAddTypeAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def discount_level(self, discount_level):
        """Sets the discount_level of this PUTScAddTypeAllOf.

        Specifies if the discount applies to the product rate plan only , the entire subscription, or to any activity in the account.  Values:  * `rateplan` * `subscription` * `account`  Available for the following charge type for the Discount-Fixed Amount and Discount-Percentage charge models:  * Recurring   # noqa: E501

        :param discount_level: The discount_level of this PUTScAddTypeAllOf.  # noqa: E501
        :type: str
        """
    ...
    def discount_percentage(self):
        """Gets the discount_percentage of this PUTScAddTypeAllOf.  # noqa: E501
        ...
        :return: The discount_percentage of this PUTScAddTypeAllOf.  # noqa: E501
        :rtype: float
        """
    ...
    def discount_percentage(self, discount_percentage):
        """Sets the discount_percentage of this PUTScAddTypeAllOf.

        Specifies the percentage of a percentage discount.   Available for the following charge type for the Discount-Percentage charge model:  * Recurring   # noqa: E501

        :param discount_percentage: The discount_percentage of this PUTScAddTypeAllOf.  # noqa: E501
        :type: float
        """
    ...
    def end_date_condition(self):
        """Gets the end_date_condition of this PUTScAddTypeAllOf.  # noqa: E501
        ...
        :return: The end_date_condition of this PUTScAddTypeAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def end_date_condition(self, end_date_condition):
        """Sets the end_date_condition of this PUTScAddTypeAllOf.

        Defines when the charge ends after the charge trigger date. If the subscription ends before the charge end date, the charge ends when the subscription ends. But if the subscription end date is subsequently changed through a Renewal, or Terms and Conditions amendment, the charge will end on the charge end date.  Values:  * `Subscription_End` * `Fixed_Period` * `Specific_End_Date` * `One_Time`   # noqa: E501

        :param end_date_condition: The end_date_condition of this PUTScAddTypeAllOf.  # noqa: E501
        :type: str
        """
    ...
    def included_units(self):
        """Gets the included_units of this PUTScAddTypeAllOf.  # noqa: E501
        ...
        :return: The included_units of this PUTScAddTypeAllOf.  # noqa: E501
        :rtype: float
        """
    ...
    def included_units(self, included_units):
        """Sets the included_units of this PUTScAddTypeAllOf.

        Specifies the number of units in the base set of units for this charge. Must be >=`0`.  Available for the following charge types for the Overage charge model:  * Recurring * Usage-based   # noqa: E501

        :param included_units: The included_units of this PUTScAddTypeAllOf.  # noqa: E501
        :type: float
        """
    ...
    def list_price_base(self):
        """Gets the list_price_base of this PUTScAddTypeAllOf.  # noqa: E501

        The list price base for the product rate plan charge.  Values:  * `Per_Billing_Period` * `Per_Month` * `Per_Week`  Available for the following charge type for the Flat Fee, Per Unit, Volume Pricing, and Tiered Pricing charge models:  * Recurring   # noqa: E501

        :return: The list_price_base of this PUTScAddTypeAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def list_price_base(self, list_price_base):
        """Sets the list_price_base of this PUTScAddTypeAllOf.

        The list price base for the product rate plan charge.  Values:  * `Per_Billing_Period` * `Per_Month` * `Per_Week`  Available for the following charge type for the Flat Fee, Per Unit, Volume Pricing, and Tiered Pricing charge models:  * Recurring   # noqa: E501

        :param list_price_base: The list_price_base of this PUTScAddTypeAllOf.  # noqa: E501
        :type: str
        """
    ...
    @property
    def number(self):
        """Gets the number of this PUTScAddTypeAllOf.  # noqa: E501

        Unique number that identifies the charge. System-generated if not provided.   # noqa: E501

        :return: The number of this PUTScAddTypeAllOf.  # noqa: E501
        :rtype: str
        """
        return self._number
    ...
    def number(self, number):
        """Sets the number of this PUTScAddTypeAllOf.

        Unique number that identifies the charge. System-generated if not provided.   # noqa: E501

        :param number: The number of this PUTScAddTypeAllOf.  # noqa: E501
        :type: str
        """
    ...
    def number_of_periods(self):
        """Gets the number_of_periods of this PUTScAddTypeAllOf.  # noqa: E501
        ...
        :return: The number_of_periods of this PUTScAddTypeAllOf.  # noqa: E501
        :rtype: int
        """
    ...
    def number_of_periods(self, number_of_periods):
        """Sets the number_of_periods of this PUTScAddTypeAllOf.

        Specifies the number of periods to use when calculating charges in an overage smoothing charge model.  Available for the following charge type for the Overage and Tiered with Overage charge models:  * Usage-based   # noqa: E501

        :param number_of_periods: The number_of_periods of this PUTScAddTypeAllOf.  # noqa: E501
        :type: int
        """
    ...
    def overage_price(self):
        """Gets the overage_price of this PUTScAddTypeAllOf.  # noqa: E501
        ...
        :return: The overage_price of this PUTScAddTypeAllOf.  # noqa: E501
        :rtype: float
        """
    ...
    def overage_price(self, overage_price):
        """Sets the overage_price of this PUTScAddTypeAllOf.

        Price for units over the allowed amount.   Available for the following charge type for the Overage and Tiered with Overage charge models:  * Usage-based   # noqa: E501

        :param overage_price: The overage_price of this PUTScAddTypeAllOf.  # noqa: E501
        :type: float
        """
    ...
    def overage_unused_units_credit_option(self):
        """Gets the overage_unused_units_credit_option of this PUTScAddTypeAllOf.  # noqa: E501
        ...
        :return: The overage_unused_units_credit_option of this PUTScAddTypeAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def overage_unused_units_credit_option(self, overage_unused_units_credit_option):
        """Sets the overage_unused_units_credit_option of this PUTScAddTypeAllOf.

        Determines whether to credit the customer with unused units of usage.  Values:  * `NoCredit` * `CreditBySpecificRate`  Available for the following charge type for the Overage and Tiered with Overage charge models:  * Usage-based   # noqa: E501

        :param overage_unused_units_credit_option: The overage_unused_units_credit_option of this PUTScAddTypeAllOf.  # noqa: E501
        :type: str
        """
    ...
    @property
    def price(self):
        """Gets the price of this PUTScAddTypeAllOf.  # noqa: E501
        ...
        :return: The price of this PUTScAddTypeAllOf.  # noqa: E501
        :rtype: float
        """
        return self._price
    ...
    def price(self, price):
        """Sets the price of this PUTScAddTypeAllOf.

        Price for units in the subscription rate plan.  Supports all charge types for the Flat Fee and Per Unit charge models   # noqa: E501

        :param price: The price of this PUTScAddTypeAllOf.  # noqa: E501
        :type: float
        """
    ...
    def price_change_option(self):
        """Gets the price_change_option of this PUTScAddTypeAllOf.  # noqa: E501
        ...
        :return: The price_change_option of this PUTScAddTypeAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def price_change_option(self, price_change_option):
        """Sets the price_change_option of this PUTScAddTypeAllOf.

        Applies an automatic price change when a termed subscription is renewed. The Zuora Billing Admin setting Enable Automatic Price Change When Subscriptions are Renewed?  must be set to Yes to use this field.  See Define Default Subscription Settings for more information on setting this option.  Values:  * `NoChange` (default) * `SpecificPercentageValue` * `UseLatestProductCatalogPricing`  Available for the following charge types:  * Recurring * Usage-based * Not available for the Fixed-Amount Discount charge model.   # noqa: E501

        :param price_change_option: The price_change_option of this PUTScAddTypeAllOf.  # noqa: E501
        :type: str
        """
    ...
    def price_increase_percentage(self):
        """Gets the price_increase_percentage of this PUTScAddTypeAllOf.  # noqa: E501
        ...
        :return: The price_increase_percentage of this PUTScAddTypeAllOf.  # noqa: E501
        :rtype: float
        """
    ...
    def price_increase_percentage(self, price_increase_percentage):
        """Sets the price_increase_percentage of this PUTScAddTypeAllOf.

        Specifies the percentage to increase or decrease the price of a termed subscription's renewal. Required if you set the `PriceChangeOption` field to `SpecificPercentageValue`.  Decimal between -100 and 100.  Available for the following charge types:  * Recurring * Usage-based  Not available for the Fixed-Amount Discount charge model.   # noqa: E501

        :param price_increase_percentage: The price_increase_percentage of this PUTScAddTypeAllOf.  # noqa: E501
        :type: float
        """
    ...
    def product_rate_plan_charge_id(self):
        """Gets the product_rate_plan_charge_id of this PUTScAddTypeAllOf.  # noqa: E501

          # noqa: E501

        :return: The product_rate_plan_charge_id of this PUTScAddTypeAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def product_rate_plan_charge_id(self, product_rate_plan_charge_id):
        """Sets the product_rate_plan_charge_id of this PUTScAddTypeAllOf.

          # noqa: E501

        :param product_rate_plan_charge_id: The product_rate_plan_charge_id of this PUTScAddTypeAllOf.  # noqa: E501
        :type: str
        """
    ...
    @property
    def quantity(self):
        """Gets the quantity of this PUTScAddTypeAllOf.  # noqa: E501
        ...
        :return: The quantity of this PUTScAddTypeAllOf.  # noqa: E501
        :rtype: float
        """
    ...
    def quantity(self, quantity):
        """Sets the quantity of this PUTScAddTypeAllOf.

        Number of units. Must be >=`0`.  Available for the following charge types for the Per Unit, Volume Pricing, and Tiered Pricing charge models:  * One-time * Recurring   # noqa: E501

        :param quantity: The quantity of this PUTScAddTypeAllOf.  # noqa: E501
        :type: float
        """
    ...
    def rating_group(self):
        """Gets the rating_group of this PUTScAddTypeAllOf.  # noqa: E501
        ...
        :return: The rating_group of this PUTScAddTypeAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def rating_group(self, rating_group):
        """Sets the rating_group of this PUTScAddTypeAllOf.

        Specifies a rating group based on which usage records are rated.  Possible values:  - `ByBillingPeriod` (default): The rating is based on all the usages in a billing period. - `ByUsageStartDate`: The rating is based on all the usages on the same usage start date.  - `ByUsageRecord`: The rating is based on each usage record. - `ByUsageUpload`: The rating is based on all the  usages in a uploaded usage file (`.xls` or `.csv`). - `ByGroupId`: The rating is based on all the usages in a custom group.  **Note:**  - The `ByBillingPeriod` value can be applied for all charge models.  - The `ByUsageStartDate`, `ByUsageRecord`, and `ByUsageUpload` values can only be applied for per unit, volume pricing, and tiered pricing charge models.  - The `ByGroupId` value is only available if you have the Active Rating feature enabled. - Use this field only for Usage charges. One-Time Charges and Recurring Charges return `NULL`.   # noqa: E501

        :param rating_group: The rating_group of this PUTScAddTypeAllOf.  # noqa: E501
        :type: str
        """
    ...
    def specific_billing_period(self):
        """Gets the specific_billing_period of this PUTScAddTypeAllOf.  # noqa: E501
        ...
        :return: The specific_billing_period of this PUTScAddTypeAllOf.  # noqa: E501
        :rtype: int
        """
    ...
    def specific_billing_period(self, specific_billing_period):
        """Sets the specific_billing_period of this PUTScAddTypeAllOf.

        Specifies the number of month or week for the charges billing period. Required if you set the value of the `billingPeriod` field to `Specific_Months` or `Specific_Weeks`.  Available for the following charge types:  * Recurring * Usage-based   # noqa: E501

        :param specific_billing_period: The specific_billing_period of this PUTScAddTypeAllOf.  # noqa: E501
        :type: int
        """
    ...
    def specific_end_date(self):
        """Gets the specific_end_date of this PUTScAddTypeAllOf.  # noqa: E501
        ...
        :return: The specific_end_date of this PUTScAddTypeAllOf.  # noqa: E501
        :rtype: date
        """
    ...
    def specific_end_date(self, specific_end_date):
        """Sets the specific_end_date of this PUTScAddTypeAllOf.

        Defines when the charge ends after the charge trigger date.  This field is only applicable when the `endDateCondition` field is set to `Specific_End_Date`.  If the subscription ends before the specific end date, the charge ends when the subscription ends. But if the subscription end date is subsequently changed through a Renewal, or Terms and Conditions amendment, the charge will end on the specific end date.   # noqa: E501

        :param specific_end_date: The specific_end_date of this PUTScAddTypeAllOf.  # noqa: E501
        :type: date
        """
    ...
    @property
    def tiers(self):
        """Gets the tiers of this PUTScAddTypeAllOf.  # noqa: E501
        ...
        :return: The tiers of this PUTScAddTypeAllOf.  # noqa: E501
    ...
    def tiers(self, tiers):
        """Sets the tiers of this PUTScAddTypeAllOf.

        Container for Volume, Tiered or Tiered with Overage charge models. Supports the following charge types:  * One-time * Recurring * Usage-based   # noqa: E501

        :param tiers: The tiers of this PUTScAddTypeAllOf.  # noqa: E501
    ...
    def trigger_date(self, trigger_date):
        """Sets the trigger_date of this PUTScAddTypeAllOf.

        Specifies when to start billing the customer for the charge. Required if the `triggerEvent` field is set to `USD`.   # noqa: E501

        :param trigger_date: The trigger_date of this PUTScAddTypeAllOf.  # noqa: E501
        :type: date
        """
    ...
    def trigger_event(self):
        """Gets the trigger_event of this PUTScAddTypeAllOf.  # noqa: E501

        Specifies when to start billing the customer for the charge.  Values:  * `UCE` * `USA` * `UCA` * `USD`   # noqa: E501

        :return: The trigger_event of this PUTScAddTypeAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def trigger_event(self, trigger_event):
        """Sets the trigger_event of this PUTScAddTypeAllOf.

        Specifies when to start billing the customer for the charge.  Values:  * `UCE` * `USA` * `UCA` * `USD`   # noqa: E501

        :param trigger_event: The trigger_event of this PUTScAddTypeAllOf.  # noqa: E501
        :type: str
        """
    ...
    def unused_units_credit_rates(self):
        """Gets the unused_units_credit_rates of this PUTScAddTypeAllOf.  # noqa: E501
        ...
        :return: The unused_units_credit_rates of this PUTScAddTypeAllOf.  # noqa: E501
        :rtype: float
        """
    ...
    def unused_units_credit_rates(self, unused_units_credit_rates):
        """Sets the unused_units_credit_rates of this PUTScAddTypeAllOf.

        Specifies the rate to credit a customer for unused units of usage. This field applies only for overage charge models when the `OverageUnusedUnitsCreditOption` field is set to `CreditBySpecificRate`.  Available for the following charge type for the Overage and Tiered with Overage charge models:  * Usage-based   # noqa: E501

        :param unused_units_credit_rates: The unused_units_credit_rates of this PUTScAddTypeAllOf.  # noqa: E501
        :type: float
        """
    ...
    def up_to_periods(self):
        """Gets the up_to_periods of this PUTScAddTypeAllOf.  # noqa: E501
        ...
        :return: The up_to_periods of this PUTScAddTypeAllOf.  # noqa: E501
        :rtype: int
        """
    ...
    def up_to_periods(self, up_to_periods):
        """Sets the up_to_periods of this PUTScAddTypeAllOf.

        The period type used to define when the charge ends.   Values:  * `Billing_Periods` * `Days` * `Weeks` * `Months` * `Years`  You must use this field together with the `upToPeriods` field to specify the time period.  This field is applicable only when the `endDateCondition` field is set to `Fixed_Period`.    # noqa: E501

        :param up_to_periods: The up_to_periods of this PUTScAddTypeAllOf.  # noqa: E501
        :type: int
        """
    ...
    def up_to_periods_type(self):
        """Gets the up_to_periods_type of this PUTScAddTypeAllOf.  # noqa: E501

        The period type used to define when the charge ends.   Values:  * `Billing_Periods` * `Days` * `Weeks` * `Months` * `Years`  You must use this field together with the `upToPeriods` field to specify the time period.  This field is applicable only when the `endDateCondition` field is set to `Fixed_Period`.    # noqa: E501

        :return: The up_to_periods_type of this PUTScAddTypeAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def up_to_periods_type(self, up_to_periods_type):
        """Sets the up_to_periods_type of this PUTScAddTypeAllOf.

        The period type used to define when the charge ends.   Values:  * `Billing_Periods` * `Days` * `Weeks` * `Months` * `Years`  You must use this field together with the `upToPeriods` field to specify the time period.  This field is applicable only when the `endDateCondition` field is set to `Fixed_Period`.    # noqa: E501

        :param up_to_periods_type: The up_to_periods_type of this PUTScAddTypeAllOf.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PUTScAddTypeAllOf):
            return False
