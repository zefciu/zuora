...
class GETEntitiesResponseTypeWithId(object):
    ...
    def __init__(self, display_name=None, id=None, locale=None, name=None, parent_id=None, status=None, success=None, tenant_id=None, timezone=None, local_vars_configuration=None):  # noqa: E501
        """GETEntitiesResponseTypeWithId - a model defined in OpenAPI"""  # noqa: E501
