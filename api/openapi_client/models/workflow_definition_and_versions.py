...
class WorkflowDefinitionAndVersions(object):
    ...
    def __init__(self, active_version=None, callout_trigger=None, created_at=None, description=None, id=None, interval=None, latest_inactive_verisons=None, name=None, ondemand_trigger=None, scheduled_trigger=None, status=None, timezone=None, updated_at=None, local_vars_configuration=None):  # noqa: E501
        """WorkflowDefinitionAndVersions - a model defined in OpenAPI"""  # noqa: E501
