...
class ProxyModifyProductRatePlan(object):
    ...
    def __init__(self, active_currencies=None, description=None, effective_end_date=None, effective_start_date=None, name=None, product_id=None, billing_period__ns=None, class__ns=None, department__ns=None, include_children__ns=None, integration_id__ns=None, integration_status__ns=None, item_type__ns=None, location__ns=None, multi_currency_price__ns=None, price__ns=None, subsidiary__ns=None, sync_date__ns=None, local_vars_configuration=None):  # noqa: E501
        """ProxyModifyProductRatePlan - a model defined in OpenAPI"""  # noqa: E501
    ...
    def active_currencies(self):
        """Gets the active_currencies of this ProxyModifyProductRatePlan.  # noqa: E501
        ...
        :return: The active_currencies of this ProxyModifyProductRatePlan.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def active_currencies(self, active_currencies):
        """Sets the active_currencies of this ProxyModifyProductRatePlan.

        A list of 3-letter currency codes representing active currencies for the product rate plan. Use a comma to separate each currency code.  If the request body contains this field, the value of this field must contain the desired list of active currencies. The new list can never have more than four differences from the existing list.  This field cannot be used to modify the status of more than four currencies in a single request. For example, in a single request, you can only activate four currencies, or deactivate four currencies, or activate two and deactivate two. Making more than four changes to currencies always requires more than one call.  When specifying this field in the update request, you must provide the full list of active currencies you want, not just incremental changes. For each active currency update, provide the following currencies in the list:  Current active currencies + at most four changes (additions or deletions)   # noqa: E501

        :param active_currencies: The active_currencies of this ProxyModifyProductRatePlan.  # noqa: E501
        :type: list[str]
        """
    ...
    def description(self):
        """Gets the description of this ProxyModifyProductRatePlan.  # noqa: E501

        A description of the product rate plan. **Character limit**: 500 **Values**: a string of 500 characters or fewer   # noqa: E501

        :return: The description of this ProxyModifyProductRatePlan.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this ProxyModifyProductRatePlan.

        A description of the product rate plan. **Character limit**: 500 **Values**: a string of 500 characters or fewer   # noqa: E501

        :param description: The description of this ProxyModifyProductRatePlan.  # noqa: E501
        :type: str
        """
    ...
    def effective_end_date(self):
        """Gets the effective_end_date of this ProxyModifyProductRatePlan.  # noqa: E501

         The date when the product rate plan expires and can't be subscribed to, in `yyyy-mm-dd` format. **Character limit**: 29   # noqa: E501

        :return: The effective_end_date of this ProxyModifyProductRatePlan.  # noqa: E501
        :rtype: date
        """
    ...
    def effective_end_date(self, effective_end_date):
        """Sets the effective_end_date of this ProxyModifyProductRatePlan.

         The date when the product rate plan expires and can't be subscribed to, in `yyyy-mm-dd` format. **Character limit**: 29   # noqa: E501

        :param effective_end_date: The effective_end_date of this ProxyModifyProductRatePlan.  # noqa: E501
        :type: date
        """
    ...
    def effective_start_date(self):
        """Gets the effective_start_date of this ProxyModifyProductRatePlan.  # noqa: E501
        ...
        :return: The effective_start_date of this ProxyModifyProductRatePlan.  # noqa: E501
        :rtype: date
        """
    ...
    def effective_start_date(self, effective_start_date):
        """Sets the effective_start_date of this ProxyModifyProductRatePlan.

         The date when the product rate plan becomes available and can be subscribed to, in `yyyy-mm-dd` format. **Character limit**: 29   # noqa: E501

        :param effective_start_date: The effective_start_date of this ProxyModifyProductRatePlan.  # noqa: E501
        :type: date
        """
    ...
    @property
    def name(self):
        """Gets the name of this ProxyModifyProductRatePlan.  # noqa: E501
        ...
        :return: The name of this ProxyModifyProductRatePlan.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ProxyModifyProductRatePlan.

        The name of the product rate plan. The name doesn't have to be unique in a Product Catalog, but the name has to be unique within a product. **Character limit**: 100 **Values**: a string of 100 characters or fewer   # noqa: E501

        :param name: The name of this ProxyModifyProductRatePlan.  # noqa: E501
        :type: str
        """
    ...
    @property
    def product_id(self):
        """Gets the product_id of this ProxyModifyProductRatePlan.  # noqa: E501
        ...
        :return: The product_id of this ProxyModifyProductRatePlan.  # noqa: E501
        :rtype: str
        """
    ...
    def product_id(self, product_id):
        """Sets the product_id of this ProxyModifyProductRatePlan.

        The ID of the product that contains the product rate plan. **Character limit**: 32 **Values**: a string of 32 characters or fewer   # noqa: E501

        :param product_id: The product_id of this ProxyModifyProductRatePlan.  # noqa: E501
        :type: str
        """
    ...
    def billing_period__ns(self, billing_period__ns):
        ...
        if self.local_vars_configuration.client_side_validation and billing_period__ns not in allowed_values:  # noqa: E501
            raise ValueError(
