...
class PUTPublicNotificationDefinitionRequest(object):
    ...
    def __init__(self, active=True, callout=None, callout_active=False, communication_profile_id=None, description=None, email_active=False, email_template_id=None, filter_rule=None, filter_rule_params=None, name=None, local_vars_configuration=None):  # noqa: E501
        """PUTPublicNotificationDefinitionRequest - a model defined in OpenAPI"""  # noqa: E501
