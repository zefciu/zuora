...
class OrderAction(object):
    ...
    def __init__(self, add_product=None, cancel_subscription=None, create_subscription=None, custom_fields=None, id=None, order_items=None, order_metrics=None, owner_transfer=None, remove_product=None, resume=None, sequence=None, suspend=None, terms_and_conditions=None, trigger_dates=None, type=None, update_product=None, local_vars_configuration=None):  # noqa: E501
