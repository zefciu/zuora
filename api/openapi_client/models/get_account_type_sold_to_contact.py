...
class GETAccountTypeSoldToContact(object):
    ...
    def __init__(self, address1=None, address2=None, city=None, country=None, county=None, fax=None, first_name=None, home_phone=None, id=None, last_name=None, mobile_phone=None, nickname=None, other_phone=None, other_phone_type=None, personal_email=None, state=None, tax_region=None, work_email=None, work_phone=None, zip_code=None, local_vars_configuration=None):  # noqa: E501
        """GETAccountTypeSoldToContact - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def id(self):
        """Gets the id of this GETAccountTypeSoldToContact.  # noqa: E501

        ID of the person who bought the subscription associated with the account, 32 characters or less.  # noqa: E501

        :return: The id of this GETAccountTypeSoldToContact.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this GETAccountTypeSoldToContact.

        ID of the person who bought the subscription associated with the account, 32 characters or less.  # noqa: E501

        :param id: The id of this GETAccountTypeSoldToContact.  # noqa: E501
        :type: str
        """
