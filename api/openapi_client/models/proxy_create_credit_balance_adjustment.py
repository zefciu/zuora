...
class ProxyCreateCreditBalanceAdjustment(object):
    ...
    def __init__(self, accounting_code=None, adjustment_date=None, amount=None, comment=None, reason_code=None, reference_id=None, source_transaction_id=None, source_transaction_number=None, type=None, integration_id__ns=None, integration_status__ns=None, sync_date__ns=None, local_vars_configuration=None):  # noqa: E501
        """ProxyCreateCreditBalanceAdjustment - a model defined in OpenAPI"""  # noqa: E501
    ...
    def accounting_code(self, accounting_code):
        """Sets the accounting_code of this ProxyCreateCreditBalanceAdjustment.

        An active accounting code in your Zuora [Chart of Accounts](https://knowledgecenter.zuora.com/CB_Billing/W_Billing_and_Payments_Settings/V_Configure_Accounting_Codes/D_Set_Up_Chart_of_Accounts).  The [accounting code](https://knowledgecenter.zuora.com/BC_Subscription_Management/Product_Catalog/A_Product_Catalog_Concepts/Accounting_Codes) for the credit balance adjustment. Typically, an accounting code for a credit balance adjustment maps to a bank account in your accounting system.   # noqa: E501

        :param accounting_code: The accounting_code of this ProxyCreateCreditBalanceAdjustment.  # noqa: E501
        :type: str
        """
    ...
    def adjustment_date(self):
        """Gets the adjustment_date of this ProxyCreateCreditBalanceAdjustment.  # noqa: E501
        ...
        :return: The adjustment_date of this ProxyCreateCreditBalanceAdjustment.  # noqa: E501
        :rtype: date
        """
    ...
    def adjustment_date(self, adjustment_date):
        """Sets the adjustment_date of this ProxyCreateCreditBalanceAdjustment.

        The date when the credit balance adjustment is applied.  With the Future Dated Credit Balance Adjustment feature enabled, you can use this field to specify when the credit balance adjustment is applied. If not specified, the value defaults to the latter date of the date when the API operation is called and the invoice date.  With the Future Dated Credit Balance Adjustment feature disabled, if no value is specified for this field, the value defaults to the date when the API operation is called. If you specify a value for this field, the value must be the date when the API operation is called.   # noqa: E501

        :param adjustment_date: The adjustment_date of this ProxyCreateCreditBalanceAdjustment.  # noqa: E501
        :type: date
        """
    ...
    @property
    def amount(self):
        """Gets the amount of this ProxyCreateCreditBalanceAdjustment.  # noqa: E501

        The amount of the adjustment.   # noqa: E501

        :return: The amount of this ProxyCreateCreditBalanceAdjustment.  # noqa: E501
        :rtype: float
        """
        return self._amount
    ...
    def amount(self, amount):
        """Sets the amount of this ProxyCreateCreditBalanceAdjustment.

        The amount of the adjustment.   # noqa: E501

        :param amount: The amount of this ProxyCreateCreditBalanceAdjustment.  # noqa: E501
        :type: float
        """
    ...
    @property
    def comment(self):
        """Gets the comment of this ProxyCreateCreditBalanceAdjustment.  # noqa: E501

        Your comments about the credit balance adjustment.   # noqa: E501

        :return: The comment of this ProxyCreateCreditBalanceAdjustment.  # noqa: E501
        :rtype: str
        """
    ...
    def comment(self, comment):
        """Sets the comment of this ProxyCreateCreditBalanceAdjustment.

        Your comments about the credit balance adjustment.   # noqa: E501

        :param comment: The comment of this ProxyCreateCreditBalanceAdjustment.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def reason_code(self):
        """Gets the reason_code of this ProxyCreateCreditBalanceAdjustment.  # noqa: E501

        A code identifying the reason for the transaction. Must be an existing [reason code](https://knowledgecenter.zuora.com/CB_Billing/K_Payment_Operations/Reason_Codes_for_Payment_Operations) or empty. If you do not specify a value, Zuora uses the default reason code.   # noqa: E501

        :return: The reason_code of this ProxyCreateCreditBalanceAdjustment.  # noqa: E501
        :rtype: str
        """
    ...
    def reason_code(self, reason_code):
        """Sets the reason_code of this ProxyCreateCreditBalanceAdjustment.

        A code identifying the reason for the transaction. Must be an existing [reason code](https://knowledgecenter.zuora.com/CB_Billing/K_Payment_Operations/Reason_Codes_for_Payment_Operations) or empty. If you do not specify a value, Zuora uses the default reason code.   # noqa: E501

        :param reason_code: The reason_code of this ProxyCreateCreditBalanceAdjustment.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                reason_code is not None and len(reason_code) > 32):
            raise ValueError("Invalid value for `reason_code`, length must be less than or equal to `32`")  # noqa: E501

        self._reason_code = reason_code

    @property
    def reference_id(self):
        """Gets the reference_id of this ProxyCreateCreditBalanceAdjustment.  # noqa: E501

        The ID of the payment that the credit balance adjustment is for.   # noqa: E501

        :return: The reference_id of this ProxyCreateCreditBalanceAdjustment.  # noqa: E501
        :rtype: str
        """
    ...
    def reference_id(self, reference_id):
        """Sets the reference_id of this ProxyCreateCreditBalanceAdjustment.

        The ID of the payment that the credit balance adjustment is for.   # noqa: E501

        :param reference_id: The reference_id of this ProxyCreateCreditBalanceAdjustment.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def source_transaction_id(self):
        """Gets the source_transaction_id of this ProxyCreateCreditBalanceAdjustment.  # noqa: E501

        The ID of the object that the credit balance adjustment is applied to. You must specify a value for either the `SourceTransactionId` field or the `SourceTransactionNumber` field.  The value of this field must be an invoice ID.   # noqa: E501

        :return: The source_transaction_id of this ProxyCreateCreditBalanceAdjustment.  # noqa: E501
        :rtype: str
        """
    ...
    def source_transaction_id(self, source_transaction_id):
        """Sets the source_transaction_id of this ProxyCreateCreditBalanceAdjustment.

        The ID of the object that the credit balance adjustment is applied to. You must specify a value for either the `SourceTransactionId` field or the `SourceTransactionNumber` field.  The value of this field must be an invoice ID.   # noqa: E501

        :param source_transaction_id: The source_transaction_id of this ProxyCreateCreditBalanceAdjustment.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                source_transaction_id is not None and len(source_transaction_id) > 32):
            raise ValueError("Invalid value for `source_transaction_id`, length must be less than or equal to `32`")  # noqa: E501

        self._source_transaction_id = source_transaction_id

    @property
    def source_transaction_number(self):
        """Gets the source_transaction_number of this ProxyCreateCreditBalanceAdjustment.  # noqa: E501

        The number of the object that the credit balance adjustment is applied to. You must specify a value for either the `SourceTransactionId` field or the `SourceTransactionNumber` field.  The value of this field must be an invoice number.   # noqa: E501

        :return: The source_transaction_number of this ProxyCreateCreditBalanceAdjustment.  # noqa: E501
        :rtype: str
        """
    ...
    def source_transaction_number(self, source_transaction_number):
        """Sets the source_transaction_number of this ProxyCreateCreditBalanceAdjustment.

        The number of the object that the credit balance adjustment is applied to. You must specify a value for either the `SourceTransactionId` field or the `SourceTransactionNumber` field.  The value of this field must be an invoice number.   # noqa: E501

        :param source_transaction_number: The source_transaction_number of this ProxyCreateCreditBalanceAdjustment.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                source_transaction_number is not None and len(source_transaction_number) > 50):
            raise ValueError("Invalid value for `source_transaction_number`, length must be less than or equal to `50`")  # noqa: E501

        self._source_transaction_number = source_transaction_number

    @property
    def type(self):
        """Gets the type of this ProxyCreateCreditBalanceAdjustment.  # noqa: E501

        Whether the credit balance adjustment increases or decrease the amount of the credit balance.   # noqa: E501

        :return: The type of this ProxyCreateCreditBalanceAdjustment.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this ProxyCreateCreditBalanceAdjustment.

        Whether the credit balance adjustment increases or decrease the amount of the credit balance.   # noqa: E501

        :param type: The type of this ProxyCreateCreditBalanceAdjustment.  # noqa: E501
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and type is None:  # noqa: E501
            raise ValueError("Invalid value for `type`, must not be `None`")  # noqa: E501
        allowed_values = ["Decrease", "Increase"]  # noqa: E501
    ...
    def integration_id__ns(self):
        """Gets the integration_id__ns of this ProxyCreateCreditBalanceAdjustment.  # noqa: E501

        ID of the corresponding object in NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId=265).   # noqa: E501

        :return: The integration_id__ns of this ProxyCreateCreditBalanceAdjustment.  # noqa: E501
        :rtype: str
        """
    ...
    def integration_id__ns(self, integration_id__ns):
        """Sets the integration_id__ns of this ProxyCreateCreditBalanceAdjustment.

        ID of the corresponding object in NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId=265).   # noqa: E501

        :param integration_id__ns: The integration_id__ns of this ProxyCreateCreditBalanceAdjustment.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def integration_status__ns(self):
        """Gets the integration_status__ns of this ProxyCreateCreditBalanceAdjustment.  # noqa: E501
        ...
        :return: The integration_status__ns of this ProxyCreateCreditBalanceAdjustment.  # noqa: E501
        :rtype: str
        """
    ...
    def integration_status__ns(self, integration_status__ns):
        """Sets the integration_status__ns of this ProxyCreateCreditBalanceAdjustment.

        Status of the credit balance adjustment's synchronization with NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId=265).   # noqa: E501

        :param integration_status__ns: The integration_status__ns of this ProxyCreateCreditBalanceAdjustment.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def sync_date__ns(self):
        """Gets the sync_date__ns of this ProxyCreateCreditBalanceAdjustment.  # noqa: E501
        ...
        :return: The sync_date__ns of this ProxyCreateCreditBalanceAdjustment.  # noqa: E501
        :rtype: str
        """
    ...
    def sync_date__ns(self, sync_date__ns):
        """Sets the sync_date__ns of this ProxyCreateCreditBalanceAdjustment.

        Date when the credit balance adjustment was sychronized with NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId=265).   # noqa: E501

        :param sync_date__ns: The sync_date__ns of this ProxyCreateCreditBalanceAdjustment.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProxyCreateCreditBalanceAdjustment):
            return False
