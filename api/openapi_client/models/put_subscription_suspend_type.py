...
class PUTSubscriptionSuspendType(object):
    ...
    def suspend_policy(self, suspend_policy):
        ...
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and suspend_policy is None:  # noqa: E501
