...
class ProxyGetExport(object):
    ...
    def __init__(self, convert_to_currencies=None, created_by_id=None, created_date=None, encrypted=None, file_id=None, format=None, id=None, name=None, query=None, size=None, status=None, status_reason=None, updated_by_id=None, updated_date=None, zip=None, local_vars_configuration=None):  # noqa: E501
        """ProxyGetExport - a model defined in OpenAPI"""  # noqa: E501
