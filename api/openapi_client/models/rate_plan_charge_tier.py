...
class RatePlanChargeTier(object):
    ...
    def __init__(self, created_by_id=None, created_date=None, ending_unit=None, is_overage_price=None, price=None, price_format=None, rate_plan_charge_id=None, starting_unit=None, tier=None, updated_by_id=None, updated_date=None, local_vars_configuration=None):  # noqa: E501
        """RatePlanChargeTier - a model defined in OpenAPI"""  # noqa: E501
    ...
    def price_format(self, price_format):
        ...
        if self.local_vars_configuration.client_side_validation and price_format not in allowed_values:  # noqa: E501
            raise ValueError(
