...
class POSTSubscriptionPreviewType(object):
    ...
    def __init__(self, account_key=None, contract_effective_date=None, customer_acceptance_date=None, include_existing_draft_doc_items=None, include_existing_draft_invoice_items=None, initial_term=None, initial_term_period_type=None, invoice_owner_account_key=None, invoice_target_date=None, notes=None, preview_account_info=None, preview_type=None, service_activation_date=None, subscribe_to_rate_plans=None, target_date=None, term_start_date=None, term_type=None, local_vars_configuration=None):  # noqa: E501
        """POSTSubscriptionPreviewType - a model defined in OpenAPI"""  # noqa: E501
    ...
    def account_key(self):
        """Gets the account_key of this POSTSubscriptionPreviewType.  # noqa: E501
        ...
        :return: The account_key of this POSTSubscriptionPreviewType.  # noqa: E501
        :rtype: str
        """
    ...
    def account_key(self, account_key):
        """Sets the account_key of this POSTSubscriptionPreviewType.

         Customer account number or ID.  You must specify the account information either in this field or in the `previewAccountInfo` field with the following conditions:           * If you already have a customer account, specify the account number or ID in this field. * If you do not have a customer account, provide account information in the `previewAccountInfo` field.   # noqa: E501

        :param account_key: The account_key of this POSTSubscriptionPreviewType.  # noqa: E501
        :type: str
        """
    ...
    def contract_effective_date(self):
        """Gets the contract_effective_date of this POSTSubscriptionPreviewType.  # noqa: E501

        Effective contract date for this subscription, as yyyy-mm-dd.   # noqa: E501

        :return: The contract_effective_date of this POSTSubscriptionPreviewType.  # noqa: E501
        :rtype: date
        """
    ...
    def contract_effective_date(self, contract_effective_date):
        """Sets the contract_effective_date of this POSTSubscriptionPreviewType.

        Effective contract date for this subscription, as yyyy-mm-dd.   # noqa: E501

        :param contract_effective_date: The contract_effective_date of this POSTSubscriptionPreviewType.  # noqa: E501
        :type: date
        """
    ...
    def customer_acceptance_date(self):
        """Gets the customer_acceptance_date of this POSTSubscriptionPreviewType.  # noqa: E501
        ...
        :return: The customer_acceptance_date of this POSTSubscriptionPreviewType.  # noqa: E501
        :rtype: date
        """
    ...
    def customer_acceptance_date(self, customer_acceptance_date):
        """Sets the customer_acceptance_date of this POSTSubscriptionPreviewType.

        The date on which the services or products within a subscription have been accepted by the customer, as yyyy-mm-dd.  Default value is dependent on the value of other fields. See **Notes** section for more details.   # noqa: E501

        :param customer_acceptance_date: The customer_acceptance_date of this POSTSubscriptionPreviewType.  # noqa: E501
        :type: date
        """
    ...
    def include_existing_draft_doc_items(self):
        """Gets the include_existing_draft_doc_items of this POSTSubscriptionPreviewType.  # noqa: E501
        ...
        :return: The include_existing_draft_doc_items of this POSTSubscriptionPreviewType.  # noqa: E501
        :rtype: bool
        """
    ...
    def include_existing_draft_doc_items(self, include_existing_draft_doc_items):
        """Sets the include_existing_draft_doc_items of this POSTSubscriptionPreviewType.

        Specifies whether to include draft invoice items in subscription previews. Values are:  * `true` (default). Includes draft invoice items in the preview result. * `false`. Excludes draft invoice items in the preview result.  **Note:** This field is in Zuora REST API version control. Supported minor versions are 207.0 or later. To use this field in the method, you must set the **zuora-version** parameter to the minor version number in the request header. See [Zuora REST API Versions](https://www.zuora.com/developer/api-reference/#section/API-Versions) for more information.   # noqa: E501

        :param include_existing_draft_doc_items: The include_existing_draft_doc_items of this POSTSubscriptionPreviewType.  # noqa: E501
        :type: bool
        """
    ...
    def include_existing_draft_invoice_items(self):
        """Gets the include_existing_draft_invoice_items of this POSTSubscriptionPreviewType.  # noqa: E501

        Specifies whether to include draft invoice items in previews. Values are:  * `true` (default). Includes draft invoice items in the preview result. * `false`. Excludes draft invoice items in the preview result.  **Note:** This field is in Zuora REST API version control. Supported minor versions are 186.0, 187.0, 188.0, 189.0, and 196.0. See [Zuora REST API Versions](https://www.zuora.com/developer/api-reference/#section/API-Versions) for more information.   # noqa: E501

        :return: The include_existing_draft_invoice_items of this POSTSubscriptionPreviewType.  # noqa: E501
        :rtype: bool
        """
    ...
    def include_existing_draft_invoice_items(self, include_existing_draft_invoice_items):
        """Sets the include_existing_draft_invoice_items of this POSTSubscriptionPreviewType.

        Specifies whether to include draft invoice items in previews. Values are:  * `true` (default). Includes draft invoice items in the preview result. * `false`. Excludes draft invoice items in the preview result.  **Note:** This field is in Zuora REST API version control. Supported minor versions are 186.0, 187.0, 188.0, 189.0, and 196.0. See [Zuora REST API Versions](https://www.zuora.com/developer/api-reference/#section/API-Versions) for more information.   # noqa: E501

        :param include_existing_draft_invoice_items: The include_existing_draft_invoice_items of this POSTSubscriptionPreviewType.  # noqa: E501
        :type: bool
        """
    ...
    def initial_term(self):
        """Gets the initial_term of this POSTSubscriptionPreviewType.  # noqa: E501
        ...
        :return: The initial_term of this POSTSubscriptionPreviewType.  # noqa: E501
        :rtype: int
        """
    ...
    def initial_term(self, initial_term):
        """Sets the initial_term of this POSTSubscriptionPreviewType.

        Duration of the first term of the subscription, in whole months. If `termType` is `TERMED`, then this field is required, and the value must be greater than `0`. If `termType` is `EVERGREEN`, this field is ignored.       # noqa: E501

        :param initial_term: The initial_term of this POSTSubscriptionPreviewType.  # noqa: E501
        :type: int
        """
    ...
    def initial_term_period_type(self):
        """Gets the initial_term_period_type of this POSTSubscriptionPreviewType.  # noqa: E501

        The period type of the initial term.   Supported values are:  * `Month` * `Year` * `Day` * `Week`   The default period type is `Month`.    # noqa: E501

        :return: The initial_term_period_type of this POSTSubscriptionPreviewType.  # noqa: E501
        :rtype: str
        """
    ...
    def initial_term_period_type(self, initial_term_period_type):
        """Sets the initial_term_period_type of this POSTSubscriptionPreviewType.

        The period type of the initial term.   Supported values are:  * `Month` * `Year` * `Day` * `Week`   The default period type is `Month`.    # noqa: E501

        :param initial_term_period_type: The initial_term_period_type of this POSTSubscriptionPreviewType.  # noqa: E501
        :type: str
        """
    ...
    def invoice_owner_account_key(self):
        """Gets the invoice_owner_account_key of this POSTSubscriptionPreviewType.  # noqa: E501
        ...
        :return: The invoice_owner_account_key of this POSTSubscriptionPreviewType.  # noqa: E501
        :rtype: str
        """
    ...
    def invoice_owner_account_key(self, invoice_owner_account_key):
        """Sets the invoice_owner_account_key of this POSTSubscriptionPreviewType.

        Invoice owner account number or ID.  **Note:** This feature is in **Limited Availability**. If you wish to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/).   # noqa: E501

        :param invoice_owner_account_key: The invoice_owner_account_key of this POSTSubscriptionPreviewType.  # noqa: E501
        :type: str
        """
    ...
    def invoice_target_date(self):
        """Gets the invoice_target_date of this POSTSubscriptionPreviewType.  # noqa: E501

        Date through which to calculate charges if an invoice is generated, as yyyy-mm-dd. Default is current date.  **Note:** This field is in Zuora REST API version control. Supported minor versions are 186.0, 187.0, 188.0, 189.0, and 196.0. See [Zuora REST API Versions](https://www.zuora.com/developer/api-reference/#section/API-Versions) for more information.   # noqa: E501

        :return: The invoice_target_date of this POSTSubscriptionPreviewType.  # noqa: E501
        :rtype: date
        """
    ...
    def invoice_target_date(self, invoice_target_date):
        """Sets the invoice_target_date of this POSTSubscriptionPreviewType.

        Date through which to calculate charges if an invoice is generated, as yyyy-mm-dd. Default is current date.  **Note:** This field is in Zuora REST API version control. Supported minor versions are 186.0, 187.0, 188.0, 189.0, and 196.0. See [Zuora REST API Versions](https://www.zuora.com/developer/api-reference/#section/API-Versions) for more information.   # noqa: E501

        :param invoice_target_date: The invoice_target_date of this POSTSubscriptionPreviewType.  # noqa: E501
        :type: date
        """
    ...
    @property
    def notes(self):
        """Gets the notes of this POSTSubscriptionPreviewType.  # noqa: E501

        String of up to 500 characters.  # noqa: E501

        :return: The notes of this POSTSubscriptionPreviewType.  # noqa: E501
        :rtype: str
        """
        return self._notes
    ...
    def notes(self, notes):
        """Sets the notes of this POSTSubscriptionPreviewType.

        String of up to 500 characters.  # noqa: E501

        :param notes: The notes of this POSTSubscriptionPreviewType.  # noqa: E501
        :type: str
        """
    ...
    def preview_account_info(self):
        """Gets the preview_account_info of this POSTSubscriptionPreviewType.  # noqa: E501


        :return: The preview_account_info of this POSTSubscriptionPreviewType.  # noqa: E501
    ...
    def preview_account_info(self, preview_account_info):
        """Sets the preview_account_info of this POSTSubscriptionPreviewType.


        :param preview_account_info: The preview_account_info of this POSTSubscriptionPreviewType.  # noqa: E501
    ...
    def preview_type(self):
        """Gets the preview_type of this POSTSubscriptionPreviewType.  # noqa: E501
        ...
        :return: The preview_type of this POSTSubscriptionPreviewType.  # noqa: E501
        :rtype: str
        """
    ...
    def preview_type(self, preview_type):
        """Sets the preview_type of this POSTSubscriptionPreviewType.

        The type of preview you will receive.   This field is in Zuora REST API version control. The supported values of this field depend on the REST API minor version you specified in the request header.   * If you do not specify the REST API minor version or specify the minor version number to one of following values in the request header:     * 186.0   * 187.0   * 188.0   * 189.0   * 196.0       The following values are supported in the **previewType** field:    * InvoiceItem   * ChargeMetrics   * InvoiceItemChargeMetrics      The default value is InvoiceItem.  * If you specify the REST API minor version to 207.0 or later in the request header, the following values are supported in the **previewType** field:    - LegalDoc   - ChargeMetrics   - LegalDocChargeMetrics    The default value is LegalDoc.  See [Zuora REST API Versions](https://www.zuora.com/developer/api-reference/#section/API-Versions) for more information.   # noqa: E501

        :param preview_type: The preview_type of this POSTSubscriptionPreviewType.  # noqa: E501
        :type: str
        """
    ...
    def service_activation_date(self):
        """Gets the service_activation_date of this POSTSubscriptionPreviewType.  # noqa: E501
        ...
        :return: The service_activation_date of this POSTSubscriptionPreviewType.  # noqa: E501
        :rtype: date
        """
    ...
    def service_activation_date(self, service_activation_date):
        """Sets the service_activation_date of this POSTSubscriptionPreviewType.

        The date on which the services or products within a subscription have been activated and access has been provided to the customer, as yyyy-mm-dd.  Default value is dependent on the value of other fields. See **Notes** section for more details.   # noqa: E501

        :param service_activation_date: The service_activation_date of this POSTSubscriptionPreviewType.  # noqa: E501
        :type: date
        """
    ...
    def subscribe_to_rate_plans(self):
        """Gets the subscribe_to_rate_plans of this POSTSubscriptionPreviewType.  # noqa: E501

        Container for one or more rate plans for this subscription.   # noqa: E501

        :return: The subscribe_to_rate_plans of this POSTSubscriptionPreviewType.  # noqa: E501
    ...
    def subscribe_to_rate_plans(self, subscribe_to_rate_plans):
        """Sets the subscribe_to_rate_plans of this POSTSubscriptionPreviewType.

        Container for one or more rate plans for this subscription.   # noqa: E501

        :param subscribe_to_rate_plans: The subscribe_to_rate_plans of this POSTSubscriptionPreviewType.  # noqa: E501
    ...
    def target_date(self):
        """Gets the target_date of this POSTSubscriptionPreviewType.  # noqa: E501

        Date through which to calculate charges if an invoice is generated, as yyyy-mm-dd. Default is current date.  **Note:** This field is in Zuora REST API version control. Supported minor versions are 207.0 or later. To use this field in the method, you must set the **zuora-version** parameter to the minor version number in the request header. See [Zuora REST API Versions](https://www.zuora.com/developer/api-reference/#section/API-Versions) for more information.   # noqa: E501

        :return: The target_date of this POSTSubscriptionPreviewType.  # noqa: E501
        :rtype: date
        """
    ...
    def target_date(self, target_date):
        """Sets the target_date of this POSTSubscriptionPreviewType.

        Date through which to calculate charges if an invoice is generated, as yyyy-mm-dd. Default is current date.  **Note:** This field is in Zuora REST API version control. Supported minor versions are 207.0 or later. To use this field in the method, you must set the **zuora-version** parameter to the minor version number in the request header. See [Zuora REST API Versions](https://www.zuora.com/developer/api-reference/#section/API-Versions) for more information.   # noqa: E501

        :param target_date: The target_date of this POSTSubscriptionPreviewType.  # noqa: E501
        :type: date
        """
    ...
    def term_start_date(self):
        """Gets the term_start_date of this POSTSubscriptionPreviewType.  # noqa: E501
        ...
        :return: The term_start_date of this POSTSubscriptionPreviewType.  # noqa: E501
        :rtype: date
        """
    ...
    def term_start_date(self, term_start_date):
        """Sets the term_start_date of this POSTSubscriptionPreviewType.

        The date on which the subscription term begins, as yyyy-mm-dd. If this is a renewal subscription, this date is different from the subscription start date.   # noqa: E501

        :param term_start_date: The term_start_date of this POSTSubscriptionPreviewType.  # noqa: E501
        :type: date
        """
    ...
    @property
    def term_type(self):
        """Gets the term_type of this POSTSubscriptionPreviewType.  # noqa: E501

        Possible values are: `TERMED`, `EVERGREEN`.   # noqa: E501

        :return: The term_type of this POSTSubscriptionPreviewType.  # noqa: E501
        :rtype: str
        """
    ...
    def term_type(self, term_type):
        """Sets the term_type of this POSTSubscriptionPreviewType.

        Possible values are: `TERMED`, `EVERGREEN`.   # noqa: E501

        :param term_type: The term_type of this POSTSubscriptionPreviewType.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, POSTSubscriptionPreviewType):
            return False
