...
class POSTCreateOrUpdateEmailTemplateRequestFormat(object):
    ...
    def cc_email_type(self, cc_email_type):
        ...
        if self.local_vars_configuration.client_side_validation and cc_email_type not in allowed_values:  # noqa: E501
            raise ValueError(
    ...
    def encoding_type(self, encoding_type):
        ...
        if self.local_vars_configuration.client_side_validation and encoding_type not in allowed_values:  # noqa: E501
            raise ValueError(
    ...
    def event_type_name(self):
        ...
        The name of the custom event type. If you specify this field, the email template is created based on the corresponding custom event.   # noqa: E501
    ...
    def from_email_type(self, from_email_type):
        ...
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and from_email_type is None:  # noqa: E501
        ...
        if self.local_vars_configuration.client_side_validation and from_email_type not in allowed_values:  # noqa: E501
            raise ValueError(
    ...
    def reply_to_email_type(self, reply_to_email_type):
        ...
        """
        allowed_values = ["TenantEmail", "SpecificEmail"]  # noqa: E501
        if self.local_vars_configuration.client_side_validation and reply_to_email_type not in allowed_values:  # noqa: E501
            raise ValueError(
    ...
    def to_email_type(self, to_email_type):
        ...
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and to_email_type is None:  # noqa: E501
            raise ValueError("Invalid value for `to_email_type`, must not be `None`")  # noqa: E501
        allowed_values = ["BillToContact", "SoldToContact", "SpecificEmails", "TenantAdmin", "BillToAndSoldToContacts", "RunOwner", "AllContacts", "InvoiceOwnerBillToContact", "InvoiceOwnerSoldToContact", "InvoiceOwnerBillToAndSoldToContacts", "InvoiceOwnerAllContacts"]  # noqa: E501
        if self.local_vars_configuration.client_side_validation and to_email_type not in allowed_values:  # noqa: E501
            raise ValueError(
