...
class CreditMemoItemFromInvoiceItemType(object):
    ...
    def __init__(self, amount=None, comment=None, description=None, finance_information=None, invoice_item_id=None, quantity=None, service_end_date=None, service_start_date=None, sku_name=None, tax_items=None, tax_mode='TaxExclusive', unit_of_measure=None, local_vars_configuration=None):  # noqa: E501
        """CreditMemoItemFromInvoiceItemType - a model defined in OpenAPI"""  # noqa: E501
    ...
    def description(self):
        """Gets the description of this CreditMemoItemFromInvoiceItemType.  # noqa: E501
        ...
        :return: The description of this CreditMemoItemFromInvoiceItemType.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this CreditMemoItemFromInvoiceItemType.

        The description of the credit memo item.  **Note**: This field is only available if you set the `zuora-version` request header to `257.0` or later.   # noqa: E501

        :param description: The description of this CreditMemoItemFromInvoiceItemType.  # noqa: E501
        :type: str
        """
    ...
    @property
    def quantity(self):
        """Gets the quantity of this CreditMemoItemFromInvoiceItemType.  # noqa: E501

        The number of units for the credit memo item.   # noqa: E501

        :return: The quantity of this CreditMemoItemFromInvoiceItemType.  # noqa: E501
        :rtype: float
        """
    ...
    def quantity(self, quantity):
        """Sets the quantity of this CreditMemoItemFromInvoiceItemType.

        The number of units for the credit memo item.   # noqa: E501

        :param quantity: The quantity of this CreditMemoItemFromInvoiceItemType.  # noqa: E501
        :type: float
        """
    ...
    @property
    def tax_mode(self):
        """Gets the tax_mode of this CreditMemoItemFromInvoiceItemType.  # noqa: E501
        ...
        :return: The tax_mode of this CreditMemoItemFromInvoiceItemType.  # noqa: E501
        :rtype: str
        """
    ...
    def tax_mode(self, tax_mode):
        """Sets the tax_mode of this CreditMemoItemFromInvoiceItemType.

        The tax mode of the credit memo item, indicating whether the amount of the credit memo item includes tax.  **Note**: You can set this field to `TaxInclusive` only if the `taxAutoCalculation` field is set to `true`.  If you set `taxMode` to `TaxInclusive`, you cannot input tax amounts for credit memo items. The corresponding invoice item must use the same tax engine as the credit memo item to calculate tax amounts.   # noqa: E501

        :param tax_mode: The tax_mode of this CreditMemoItemFromInvoiceItemType.  # noqa: E501
        :type: str
        """
