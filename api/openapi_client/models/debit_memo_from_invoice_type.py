...
class DebitMemoFromInvoiceType(object):
    ...
    def __init__(self, auto_pay=None, auto_post=False, comment=None, effective_date=None, invoice_id=None, items=None, reason_code=None, tax_auto_calculation=True, integration_id__ns=None, integration_status__ns=None, sync_date__ns=None, local_vars_configuration=None):  # noqa: E501
        """DebitMemoFromInvoiceType - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def auto_post(self):
        """Gets the auto_post of this DebitMemoFromInvoiceType.  # noqa: E501

        Whether to automatically post the debit memo after it is created.   Setting this field to `true`, you do not need to separately call the [Post debit memo](https://www.zuora.com/developer/api-reference/#operation/PUT_PostDebitMemo) operation to post the debit memo.   # noqa: E501

        :return: The auto_post of this DebitMemoFromInvoiceType.  # noqa: E501
        :rtype: bool
        """
    ...
    def auto_post(self, auto_post):
        """Sets the auto_post of this DebitMemoFromInvoiceType.

        Whether to automatically post the debit memo after it is created.   Setting this field to `true`, you do not need to separately call the [Post debit memo](https://www.zuora.com/developer/api-reference/#operation/PUT_PostDebitMemo) operation to post the debit memo.   # noqa: E501

        :param auto_post: The auto_post of this DebitMemoFromInvoiceType.  # noqa: E501
        :type: bool
        """
