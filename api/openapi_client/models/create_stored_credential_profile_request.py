...
class CreateStoredCredentialProfileRequest(object):
    ...
    def __init__(self, action=None, agreed_on=None, auth_gateway=None, card_security_code=None, consent_agreement_ref=None, consent_agreement_src=None, network_transaction_id=None, status=None, type=None, local_vars_configuration=None):  # noqa: E501
        """CreateStoredCredentialProfileRequest - a model defined in OpenAPI"""  # noqa: E501
    ...
    def consent_agreement_ref(self, consent_agreement_ref):
        ...
        if (self.local_vars_configuration.client_side_validation and
                consent_agreement_ref is not None and len(consent_agreement_ref) > 128):
    ...
    def consent_agreement_src(self, consent_agreement_src):
        ...
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and consent_agreement_src is None:  # noqa: E501
            raise ValueError("Invalid value for `consent_agreement_src`, must not be `None`")  # noqa: E501
        allowed_values = ["External"]  # noqa: E501
        if self.local_vars_configuration.client_side_validation and consent_agreement_src not in allowed_values:  # noqa: E501
            raise ValueError(
    ...
    def network_transaction_id(self, network_transaction_id):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                network_transaction_id is not None and len(network_transaction_id) > 128):
            raise ValueError("Invalid value for `network_transaction_id`, length must be less than or equal to `128`")  # noqa: E501
