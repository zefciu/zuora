...
class TimeSlicedTcbNetMetrics(object):
    ...
    def __init__(self, amount=None, discount_charge_number=None, end_date=None, generated_reason=None, invoice_owner=None, order_item_id=None, start_date=None, subscription_owner=None, tax=None, term_number=None, type=None, local_vars_configuration=None):  # noqa: E501
        """TimeSlicedTcbNetMetrics - a model defined in OpenAPI"""  # noqa: E501
    ...
    def generated_reason(self, generated_reason):
        ...
        if self.local_vars_configuration.client_side_validation and generated_reason not in allowed_values:  # noqa: E501
            raise ValueError(
