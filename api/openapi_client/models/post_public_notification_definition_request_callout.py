...
class POSTPublicNotificationDefinitionRequestCallout(object):
    ...
    def __init__(self, active=True, callout_auth=None, callout_baseurl=None, callout_params=None, callout_retry=True, description=None, event_type_name=None, http_method=None, name=None, required_auth=None, local_vars_configuration=None):  # noqa: E501
        """POSTPublicNotificationDefinitionRequestCallout - a model defined in OpenAPI"""  # noqa: E501
    ...
    def callout_baseurl(self, callout_baseurl):
        ...
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and callout_baseurl is None:  # noqa: E501
            raise ValueError("Invalid value for `callout_baseurl`, must not be `None`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                callout_baseurl is not None and len(callout_baseurl) < 10):
    ...
    def event_type_name(self, event_type_name):
        ...
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and event_type_name is None:  # noqa: E501
    ...
    def required_auth(self, required_auth):
        ...
        :type: bool
        """
        if self.local_vars_configuration.client_side_validation and required_auth is None:  # noqa: E501
