...
class DataQueryJob(object):
    ...
    def __init__(self, created_by=None, id=None, query=None, remaining_retries=None, updated_on=None, data_file=None, output_rows=None, processing_time=None, query_status=None, local_vars_configuration=None):  # noqa: E501
        """DataQueryJob - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def created_by(self):
        """Gets the created_by of this DataQueryJob.  # noqa: E501

        The query job creator's Id.   # noqa: E501

        :return: The created_by of this DataQueryJob.  # noqa: E501
        :rtype: str
        """
    ...
    def created_by(self, created_by):
        """Sets the created_by of this DataQueryJob.

        The query job creator's Id.   # noqa: E501

        :param created_by: The created_by of this DataQueryJob.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                created_by is not None and len(created_by) > 64):
            raise ValueError("Invalid value for `created_by`, length must be less than or equal to `64`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                created_by is not None and len(created_by) < 64):
            raise ValueError("Invalid value for `created_by`, length must be greater than or equal to `64`")  # noqa: E501

        self._created_by = created_by

    @property
    def id(self):
        """Gets the id of this DataQueryJob.  # noqa: E501

        Internal identifier of the query job.   # noqa: E501

        :return: The id of this DataQueryJob.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this DataQueryJob.

        Internal identifier of the query job.   # noqa: E501

        :param id: The id of this DataQueryJob.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
        ...
        if (self.local_vars_configuration.client_side_validation and
                id is not None and len(id) < 64):
            raise ValueError("Invalid value for `id`, length must be greater than or equal to `64`")  # noqa: E501

        self._id = id

    @property
    def query(self):
        """Gets the query of this DataQueryJob.  # noqa: E501

        The query that was submitted.   # noqa: E501

        :return: The query of this DataQueryJob.  # noqa: E501
        :rtype: str
        """
        return self._query
    ...
    def query(self, query):
        """Sets the query of this DataQueryJob.

        The query that was submitted.   # noqa: E501

        :param query: The query of this DataQueryJob.  # noqa: E501
        :type: str
        """
    ...
    def remaining_retries(self):
        """Gets the remaining_retries of this DataQueryJob.  # noqa: E501

        The number of times that Zuora will retry the query if Zuora is unable to perform the query.   # noqa: E501

        :return: The remaining_retries of this DataQueryJob.  # noqa: E501
        :rtype: int
        """
    ...
    def remaining_retries(self, remaining_retries):
        """Sets the remaining_retries of this DataQueryJob.

        The number of times that Zuora will retry the query if Zuora is unable to perform the query.   # noqa: E501

        :param remaining_retries: The remaining_retries of this DataQueryJob.  # noqa: E501
        :type: int
        """
    ...
    @property
    def updated_on(self):
        """Gets the updated_on of this DataQueryJob.  # noqa: E501

        Date and time when the query job was last updated, in ISO 8601 format.   # noqa: E501

        :return: The updated_on of this DataQueryJob.  # noqa: E501
        :rtype: datetime
        """
    ...
    def updated_on(self, updated_on):
        """Sets the updated_on of this DataQueryJob.

        Date and time when the query job was last updated, in ISO 8601 format.   # noqa: E501

        :param updated_on: The updated_on of this DataQueryJob.  # noqa: E501
        :type: datetime
        """
    ...
    def query_status(self, query_status):
        ...
        if self.local_vars_configuration.client_side_validation and query_status not in allowed_values:  # noqa: E501
            raise ValueError(
