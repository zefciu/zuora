...
class PostOrderLineItemUpdateType(object):
    ...
    def __init__(self, id=None, uom=None, accounting_code=None, adjustment_liability_accounting_code=None, adjustment_revenue_accounting_code=None, amount_per_unit=None, bill_target_date=None, contract_asset_accounting_code=None, contract_liability_accounting_code=None, contract_recognized_revenue_accounting_code=None, custom_fields=None, deferred_revenue_accounting_code=None, description=None, item_name=None, item_number=None, item_state=None, item_type=None, list_price_per_unit=None, product_code=None, purchase_order_number=None, quantity=None, recognized_revenue_accounting_code=None, related_subscription_number=None, revenue_recognition_rule=None, tax_code=None, tax_mode=None, transaction_end_date=None, transaction_start_date=None, unbilled_receivables_accounting_code=None, local_vars_configuration=None):  # noqa: E501
        """PostOrderLineItemUpdateType - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def id(self):
        """Gets the id of this PostOrderLineItemUpdateType.  # noqa: E501

        The sytem generated Id for the Order Line Item(OLI). Use this field to specify which OLI to update.   # noqa: E501

        :return: The id of this PostOrderLineItemUpdateType.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this PostOrderLineItemUpdateType.

        The sytem generated Id for the Order Line Item(OLI). Use this field to specify which OLI to update.   # noqa: E501

        :param id: The id of this PostOrderLineItemUpdateType.  # noqa: E501
        :type: str
        """
