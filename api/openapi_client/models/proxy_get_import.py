...
class ProxyGetImport(object):
    ...
    def __init__(self, created_by_id=None, created_date=None, id=None, import_type=None, imported_count=None, md5=None, name=None, original_resource_url=None, result_resource_url=None, status=None, status_reason=None, total_count=None, updated_by_id=None, updated_date=None, local_vars_configuration=None):  # noqa: E501
        """ProxyGetImport - a model defined in OpenAPI"""  # noqa: E501
