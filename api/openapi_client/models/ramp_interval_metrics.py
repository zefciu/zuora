...
class RampIntervalMetrics(object):
    ...
    def __init__(self, description=None, discount_tcb=None, discount_tcv=None, end_date=None, gross_tcb=None, gross_tcv=None, interval_metrics=None, name=None, net_tcb=None, net_tcv=None, start_date=None, local_vars_configuration=None):  # noqa: E501
        """RampIntervalMetrics - a model defined in OpenAPI"""  # noqa: E501
