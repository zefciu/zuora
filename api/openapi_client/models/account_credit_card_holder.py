...
class AccountCreditCardHolder(object):
    ...
    def __init__(self, address_line1=None, address_line2=None, card_holder_name=None, city=None, country=None, email=None, phone=None, state=None, zip_code=None, local_vars_configuration=None):  # noqa: E501
        """AccountCreditCardHolder - a model defined in OpenAPI"""  # noqa: E501
    ...
    def card_holder_name(self, card_holder_name):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                card_holder_name is not None and len(card_holder_name) > 50):
            raise ValueError("Invalid value for `card_holder_name`, length must be less than or equal to `50`")  # noqa: E501
    ...
    def city(self):
        ...
        City of the cardholder's address.   # noqa: E501
    ...
    def country(self):
        ...
        Country of the cardholder's address. The value of this field must be a valid country name or abbreviation.   # noqa: E501
    ...
    def phone(self, phone):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                phone is not None and len(phone) > 40):
    ...
    def zip_code(self, zip_code):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                zip_code is not None and len(zip_code) > 20):
            raise ValueError("Invalid value for `zip_code`, length must be less than or equal to `20`")  # noqa: E501
