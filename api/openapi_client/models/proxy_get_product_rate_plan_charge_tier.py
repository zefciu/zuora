...
class ProxyGetProductRatePlanChargeTier(object):
    ...
    def __init__(self, created_by_id=None, created_date=None, currency=None, ending_unit=None, id=None, price=None, price_format=None, starting_unit=None, tier=None, updated_by_id=None, updated_date=None, local_vars_configuration=None):  # noqa: E501
        """ProxyGetProductRatePlanChargeTier - a model defined in OpenAPI"""  # noqa: E501
