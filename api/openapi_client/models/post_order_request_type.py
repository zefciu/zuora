...
class POSTOrderRequestType(object):
    ...
    def __init__(self, custom_fields=None, description=None, existing_account_number=None, externally_managed_by=None, new_account=None, order_date=None, order_line_items=None, order_number=None, processing_options=None, subscriptions=None, local_vars_configuration=None):  # noqa: E501
        """POSTOrderRequestType - a model defined in OpenAPI"""  # noqa: E501
    ...
    def description(self):
        """Gets the description of this POSTOrderRequestType.  # noqa: E501

        A description of the order.  # noqa: E501

        :return: The description of this POSTOrderRequestType.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this POSTOrderRequestType.

        A description of the order.  # noqa: E501

        :param description: The description of this POSTOrderRequestType.  # noqa: E501
        :type: str
        """
    ...
    def existing_account_number(self, existing_account_number):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                existing_account_number is not None and len(existing_account_number) > 70):
    ...
    def externally_managed_by(self):
        """Gets the externally_managed_by of this POSTOrderRequestType.  # noqa: E501
        ...
        :return: The externally_managed_by of this POSTOrderRequestType.  # noqa: E501
        :rtype: str
        """
    ...
    def externally_managed_by(self, externally_managed_by):
        """Sets the externally_managed_by of this POSTOrderRequestType.

        An enum field on the Subscription object to indicate the name of a third-party store. This field is used to represent subscriptions created through third-party stores.   # noqa: E501

        :param externally_managed_by: The externally_managed_by of this POSTOrderRequestType.  # noqa: E501
        :type: str
        """
    ...
    def order_line_items(self):
        """Gets the order_line_items of this POSTOrderRequestType.  # noqa: E501
        ...
        :return: The order_line_items of this POSTOrderRequestType.  # noqa: E501
    ...
    def order_line_items(self, order_line_items):
        """Sets the order_line_items of this POSTOrderRequestType.

        [Order Line Items](https://knowledgecenter.zuora.com/Billing/Subscriptions/Orders/Order_Line_Items/AA_Overview_of_Order_Line_Items) are non subscription based items created by an Order, representing transactional charges such as one-time fees, physical goods, or professional service charges that are not sold as subscription services.   With the Order Line Items feature enabled, you can now launch non-subscription and unified monetization business models in Zuora, in addition to subscription business models.  **Note:** The [Order Line Items](https://knowledgecenter.zuora.com/Billing/Subscriptions/Orders/Order_Line_Items/AA_Overview_of_Order_Line_Items) feature is now generally available to all Zuora customers. You need to enable the [Orders](https://knowledgecenter.zuora.com/BC_Subscription_Management/Orders/AA_Overview_of_Orders#Orders) feature to access the [Order Line Items](https://knowledgecenter.zuora.com/Billing/Subscriptions/Orders/Order_Line_Items/AA_Overview_of_Order_Line_Items) feature. As of Zuora Billing Release 313 (November 2021), new customers who onboard on [Orders](https://knowledgecenter.zuora.com/Billing/Subscriptions/Orders/AA_Overview_of_Orders) will have the [Order Line Items](https://knowledgecenter.zuora.com/Billing/Subscriptions/Orders/Order_Line_Items) feature enabled by default. If you are a new customer who onboard on [Orders Harmonization](https://knowledgecenter.zuora.com/Billing/Subscriptions/Orders/Orders_Harmonization/Orders_Harmonization) and want to enable the [Order Line Items](https://knowledgecenter.zuora.com/Billing/Subscriptions/Orders/Order_Line_Items) feature, submit a request at [Zuora Global Support](https://support.zuora.com/). If you are an existing [Orders](https://knowledgecenter.zuora.com/Billing/Subscriptions/Orders/AA_Overview_of_Orders) or [Orders Harmonization](https://knowledgecenter.zuora.com/Billing/Subscriptions/Orders/Orders_Harmonization/Orders_Harmonization) customer and want to enable the [Order Line Items](https://knowledgecenter.zuora.com/Billing/Subscriptions/Orders/Order_Line_Items) feature, submit a request at [Zuora Global Support](https://support.zuora.com/).           # noqa: E501

        :param order_line_items: The order_line_items of this POSTOrderRequestType.  # noqa: E501
    ...
    def order_number(self, order_number):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                order_number is not None and len(order_number) > 100):
