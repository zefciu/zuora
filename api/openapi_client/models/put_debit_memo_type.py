...
class PUTDebitMemoType(object):
    ...
    def __init__(self, auto_pay=None, comment=None, due_date=None, effective_date=None, items=None, reason_code=None, transferred_to_accounting=None, integration_id__ns=None, integration_status__ns=None, sync_date__ns=None, local_vars_configuration=None):  # noqa: E501
        """PUTDebitMemoType - a model defined in OpenAPI"""  # noqa: E501
