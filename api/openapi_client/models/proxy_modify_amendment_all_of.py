...
class ProxyModifyAmendmentAllOf(object):
    ...
    @property
    def auto_renew(self):
        """Gets the auto_renew of this ProxyModifyAmendmentAllOf.  # noqa: E501

         Determines whether the subscription is automatically renewed, or whether it expires at the end of the term and needs to be manually renewed. This field can be updated when Status is `Draft`. **Required:** For amendment of type TermsAndConditions when changing the automatic renewal status of a subscription. **Values**: true, false   # noqa: E501

        :return: The auto_renew of this ProxyModifyAmendmentAllOf.  # noqa: E501
        :rtype: bool
        """
    ...
    def auto_renew(self, auto_renew):
        """Sets the auto_renew of this ProxyModifyAmendmentAllOf.

         Determines whether the subscription is automatically renewed, or whether it expires at the end of the term and needs to be manually renewed. This field can be updated when Status is `Draft`. **Required:** For amendment of type TermsAndConditions when changing the automatic renewal status of a subscription. **Values**: true, false   # noqa: E501

        :param auto_renew: The auto_renew of this ProxyModifyAmendmentAllOf.  # noqa: E501
        :type: bool
        """
    ...
    def contract_effective_date(self):
        """Gets the contract_effective_date of this ProxyModifyAmendmentAllOf.  # noqa: E501

         The date when the amendment's changes become effective for billing purposes. **Version notes**: --   # noqa: E501

        :return: The contract_effective_date of this ProxyModifyAmendmentAllOf.  # noqa: E501
        :rtype: date
        """
    ...
    def contract_effective_date(self, contract_effective_date):
        """Sets the contract_effective_date of this ProxyModifyAmendmentAllOf.

         The date when the amendment's changes become effective for billing purposes. **Version notes**: --   # noqa: E501

        :param contract_effective_date: The contract_effective_date of this ProxyModifyAmendmentAllOf.  # noqa: E501
        :type: date
        """
    ...
    def current_term(self):
        """Gets the current_term of this ProxyModifyAmendmentAllOf.  # noqa: E501
        ...
        :return: The current_term of this ProxyModifyAmendmentAllOf.  # noqa: E501
        :rtype: int
        """
    ...
    def current_term(self, current_term):
        """Sets the current_term of this ProxyModifyAmendmentAllOf.

         The length of the period for the current subscription term. This field can be updated when Status is `Draft`. **Required**: Only if the value of the Type field is set to `TermsAndConditions` and TermType is set to `TERMED`. This field is not required if TermType is set to `EVERGREEN`. **Character limit**: **Values**: a valid number   # noqa: E501

        :param current_term: The current_term of this ProxyModifyAmendmentAllOf.  # noqa: E501
        :type: int
        """
    ...
    def current_term_period_type(self):
        """Gets the current_term_period_type of this ProxyModifyAmendmentAllOf.  # noqa: E501

         The period type for the current subscription term. This field can be updated when Status is `Draft`. **Values**:  - `Month` (default) - `Year` - `Day` - `Week` **Note**:  - This field can be updated when Status is `Draft`. - This field is used with the CurrentTerm field to specify the current subscription term.   # noqa: E501

        :return: The current_term_period_type of this ProxyModifyAmendmentAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def current_term_period_type(self, current_term_period_type):
        """Sets the current_term_period_type of this ProxyModifyAmendmentAllOf.

         The period type for the current subscription term. This field can be updated when Status is `Draft`. **Values**:  - `Month` (default) - `Year` - `Day` - `Week` **Note**:  - This field can be updated when Status is `Draft`. - This field is used with the CurrentTerm field to specify the current subscription term.   # noqa: E501

        :param current_term_period_type: The current_term_period_type of this ProxyModifyAmendmentAllOf.  # noqa: E501
        :type: str
        """
    ...
    def customer_acceptance_date(self):
        """Gets the customer_acceptance_date of this ProxyModifyAmendmentAllOf.  # noqa: E501
        ...
        :return: The customer_acceptance_date of this ProxyModifyAmendmentAllOf.  # noqa: E501
        :rtype: date
        """
    ...
    def customer_acceptance_date(self, customer_acceptance_date):
        """Sets the customer_acceptance_date of this ProxyModifyAmendmentAllOf.

        The date when the customer accepts the amendment's changes to the subscription.  This field is only required if [Zuora is configured to require customer acceptance in Z-Billing](https://knowledgecenter.zuora.com/CB_Billing/W_Billing_and_Payments_Settings/Define_Default_Subscription_Settings) and the subscription is currently in the Pending Acceptance status (the value of the `Status` field is currently `PendingAcceptance`).  Use this field together with the `Status` field. When you set a date in this field as a customer acceptance date, you should also set the `Status` field as `Completed`.   # noqa: E501

        :param customer_acceptance_date: The customer_acceptance_date of this ProxyModifyAmendmentAllOf.  # noqa: E501
        :type: date
        """
    ...
    def description(self):
        """Gets the description of this ProxyModifyAmendmentAllOf.  # noqa: E501

         A description of the amendment. This field can be updated when Status is `Draft`. **Character limit**: 500 **Values**: maximum 500 characters   # noqa: E501

        :return: The description of this ProxyModifyAmendmentAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this ProxyModifyAmendmentAllOf.

         A description of the amendment. This field can be updated when Status is `Draft`. **Character limit**: 500 **Values**: maximum 500 characters   # noqa: E501

        :param description: The description of this ProxyModifyAmendmentAllOf.  # noqa: E501
        :type: str
        """
    ...
    def effective_date(self):
        """Gets the effective_date of this ProxyModifyAmendmentAllOf.  # noqa: E501
        ...
        :return: The effective_date of this ProxyModifyAmendmentAllOf.  # noqa: E501
        :rtype: date
        """
    ...
    def effective_date(self, effective_date):
        """Sets the effective_date of this ProxyModifyAmendmentAllOf.

         The date when the amendment's changes take effective. This field validates that the amendment's changes are within valid ranges of products and product rate plans. **Required**: For the cancellation amendments. Optional for other types of amendments. **Version notes**: --   # noqa: E501

        :param effective_date: The effective_date of this ProxyModifyAmendmentAllOf.  # noqa: E501
        :type: date
        """
    ...
    @property
    def name(self):
        """Gets the name of this ProxyModifyAmendmentAllOf.  # noqa: E501

         The name of the amendment. This field can be updated when Status is `Draft`. **Character limit**: 100 **Values**: a string of 100 characters or fewer   # noqa: E501

        :return: The name of this ProxyModifyAmendmentAllOf.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ProxyModifyAmendmentAllOf.

         The name of the amendment. This field can be updated when Status is `Draft`. **Character limit**: 100 **Values**: a string of 100 characters or fewer   # noqa: E501

        :param name: The name of this ProxyModifyAmendmentAllOf.  # noqa: E501
        :type: str
        """
    ...
    def renewal_setting(self):
        """Gets the renewal_setting of this ProxyModifyAmendmentAllOf.  # noqa: E501
        ...
        :return: The renewal_setting of this ProxyModifyAmendmentAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def renewal_setting(self, renewal_setting):
        """Sets the renewal_setting of this ProxyModifyAmendmentAllOf.

         Specifies whether a termed subscription will remain termed or change to evergreen when it is renewed. **Required**: If TermType is Termed **Values**: RENEW_WITH_SPECIFIC_TERM (default), RENEW_TO_EVERGREEN   # noqa: E501

        :param renewal_setting: The renewal_setting of this ProxyModifyAmendmentAllOf.  # noqa: E501
        :type: str
        """
    ...
    def renewal_term(self):
        """Gets the renewal_term of this ProxyModifyAmendmentAllOf.  # noqa: E501
        ...
        :return: The renewal_term of this ProxyModifyAmendmentAllOf.  # noqa: E501
        :rtype: int
        """
    ...
    def renewal_term(self, renewal_term):
        """Sets the renewal_term of this ProxyModifyAmendmentAllOf.

         The term of renewal for the amended subscription. This field can be updated when Status is `Draft`. **Required**: Only if the value of the Type field is set to `TermsAndConditions`. **Character limit**: **Values:** a valid number   # noqa: E501

        :param renewal_term: The renewal_term of this ProxyModifyAmendmentAllOf.  # noqa: E501
        :type: int
        """
    ...
    def renewal_term_period_type(self):
        """Gets the renewal_term_period_type of this ProxyModifyAmendmentAllOf.  # noqa: E501
        ...
        :return: The renewal_term_period_type of this ProxyModifyAmendmentAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def renewal_term_period_type(self, renewal_term_period_type):
        """Sets the renewal_term_period_type of this ProxyModifyAmendmentAllOf.

         The period type for the subscription renewal term. This field can be updated when Status is `Draft`. **Required**: Only if the value of the Type field is set to `TermsAndConditions`. This field is used with the RenewalTerm field to specify the subscription renewal term. **Values**:  - `Month` (default) - `Year` - `Day` - `Week`   # noqa: E501

        :param renewal_term_period_type: The renewal_term_period_type of this ProxyModifyAmendmentAllOf.  # noqa: E501
        :type: str
        """
    ...
    def service_activation_date(self):
        """Gets the service_activation_date of this ProxyModifyAmendmentAllOf.  # noqa: E501
        ...
        :return: The service_activation_date of this ProxyModifyAmendmentAllOf.  # noqa: E501
        :rtype: date
        """
    ...
    def service_activation_date(self, service_activation_date):
        """Sets the service_activation_date of this ProxyModifyAmendmentAllOf.

        The date when service is activated.  This field is only required if [Zuora is configured to require service activation in Z-Billing](https://knowledgecenter.zuora.com/CB_Billing/W_Billing_and_Payments_Settings/Define_Default_Subscription_Settings) and the subscription is currently in the Pending Activation status (the value of the `Status` field is currently `PendingActivation`).  Use this field together with the `Status` field. When you set a date in this field as a service activation date, you should also set the `Status` field as the expected next phase status: `Completed` or `PendingAcceptance`.   # noqa: E501

        :param service_activation_date: The service_activation_date of this ProxyModifyAmendmentAllOf.  # noqa: E501
        :type: date
        """
    ...
    def specific_update_date(self):
        """Gets the specific_update_date of this ProxyModifyAmendmentAllOf.  # noqa: E501
        ...
        :return: The specific_update_date of this ProxyModifyAmendmentAllOf.  # noqa: E501
        :rtype: date
        """
    ...
    def specific_update_date(self, specific_update_date):
        """Sets the specific_update_date of this ProxyModifyAmendmentAllOf.

         The date when the UpdateProduct amendment takes effect. This field is only applicable if there is already a future-dated UpdateProduct amendment on the subscription. **Required**: Only for the UpdateProduct amendments if there is already a future-dated UpdateProduct amendment on the subscription.   # noqa: E501

        :param specific_update_date: The specific_update_date of this ProxyModifyAmendmentAllOf.  # noqa: E501
        :type: date
        """
    ...
    @property
    def status(self):
        """Gets the status of this ProxyModifyAmendmentAllOf.  # noqa: E501
        ...
        :return: The status of this ProxyModifyAmendmentAllOf.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this ProxyModifyAmendmentAllOf.

         The status of the amendment. Type: string (enum) **Character limit**: 17 **Values**: one of the following:  - Draft (default, if left null) - Pending Activation - Pending Acceptance - Completed   # noqa: E501

        :param status: The status of this ProxyModifyAmendmentAllOf.  # noqa: E501
        :type: str
        """
    ...
    def subscription_id(self):
        """Gets the subscription_id of this ProxyModifyAmendmentAllOf.  # noqa: E501

         The ID of the subscription that the amendment changes. This field can be updated when Status is `Draft`. **Character limit**: 32 **Values**: a valid subscription ID   # noqa: E501

        :return: The subscription_id of this ProxyModifyAmendmentAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def subscription_id(self, subscription_id):
        """Sets the subscription_id of this ProxyModifyAmendmentAllOf.

         The ID of the subscription that the amendment changes. This field can be updated when Status is `Draft`. **Character limit**: 32 **Values**: a valid subscription ID   # noqa: E501

        :param subscription_id: The subscription_id of this ProxyModifyAmendmentAllOf.  # noqa: E501
        :type: str
        """
    ...
    def term_start_date(self):
        """Gets the term_start_date of this ProxyModifyAmendmentAllOf.  # noqa: E501
        ...
        :return: The term_start_date of this ProxyModifyAmendmentAllOf.  # noqa: E501
        :rtype: date
        """
    ...
    def term_start_date(self, term_start_date):
        """Sets the term_start_date of this ProxyModifyAmendmentAllOf.

         The date when the new terms and conditions take effect. **Required**: Only if the value of the Type field is set to TermsAndConditions. **Version notes**: --   # noqa: E501

        :param term_start_date: The term_start_date of this ProxyModifyAmendmentAllOf.  # noqa: E501
        :type: date
        """
    ...
    def term_type(self, term_type):
        """Sets the term_type of this ProxyModifyAmendmentAllOf.

         Indicates if the subscription is TERMED or EVERGREEN. This field can be updated when Status is `Draft`.  - A TERMED subscription has an expiration date, and must be manually renewed. - An EVERGREEN subscription doesn't have an expiration date, and must be manually ended.  **Required**: Only when as part of an amendment of type TermsAndConditions &#65279;to change the term type of a subscription. Type: string **Character limit**: 9 **Values**: TERMED, EVERGREEN   # noqa: E501

        :param term_type: The term_type of this ProxyModifyAmendmentAllOf.  # noqa: E501
        :type: str
        """
    ...
    @property
    def type(self):
        """Gets the type of this ProxyModifyAmendmentAllOf.  # noqa: E501

         The type of amendment. This field can be updated when Status is `Draft`. **Character limit**: 18 **Values**: one of the following:  - Cancellation - NewProduct - OwnerTransfer - RemoveProduct - Renewal - UpdateProduct - TermsAndConditions - SuspendSubscription - ResumeSubscription   # noqa: E501

        :return: The type of this ProxyModifyAmendmentAllOf.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this ProxyModifyAmendmentAllOf.

         The type of amendment. This field can be updated when Status is `Draft`. **Character limit**: 18 **Values**: one of the following:  - Cancellation - NewProduct - OwnerTransfer - RemoveProduct - Renewal - UpdateProduct - TermsAndConditions - SuspendSubscription - ResumeSubscription   # noqa: E501

        :param type: The type of this ProxyModifyAmendmentAllOf.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProxyModifyAmendmentAllOf):
            return False
