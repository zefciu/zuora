...
class ProxyGetProductRatePlanCharge(object):
    ...
    def accounting_code(self):
        """Gets the accounting_code of this ProxyGetProductRatePlanCharge.  # noqa: E501
        ...
        :return: The accounting_code of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :rtype: str
        """
    ...
    def accounting_code(self, accounting_code):
        """Sets the accounting_code of this ProxyGetProductRatePlanCharge.

        The accounting code for the charge. Accounting codes group transactions that contain similar accounting attributes. **Character limit**: 100 **Values**: an active accounting code in your Zuora Chart of Accounts   # noqa: E501

        :param accounting_code: The accounting_code of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :type: str
        """
    ...
    def apply_discount_to(self):
        """Gets the apply_discount_to of this ProxyGetProductRatePlanCharge.  # noqa: E501
        ...
        :return: The apply_discount_to of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :rtype: str
        """
    ...
    def apply_discount_to(self, apply_discount_to):
        """Sets the apply_discount_to of this ProxyGetProductRatePlanCharge.

        Specifies the type of charges that you want a specific discount to apply to. All field values are case sensitive: note that these values are in all-caps. **Character limit**: 21 **Values**: one of the following:  - `ONETIME (1)` - `RECURRING (2)` - `USAGE (4)` - `ONETIMERECURRING (3)` - `ONETIMEUSAGE (5)` - `RECURRINGUSAGE (6)` - `ONETIMERECURRINGUSAGE (7)`   # noqa: E501

        :param apply_discount_to: The apply_discount_to of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :type: str
        """
    ...
    def bill_cycle_day(self):
        """Gets the bill_cycle_day of this ProxyGetProductRatePlanCharge.  # noqa: E501
        ...
        :return: The bill_cycle_day of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :rtype: int
        """
    ...
    def bill_cycle_day(self, bill_cycle_day):
        """Sets the bill_cycle_day of this ProxyGetProductRatePlanCharge.

         Sets the bill cycle day (BCD) for the charge. The BCD determines which day of the month customer is billed. The BCD value in the account can override the BCD in this object. **Character limit**: 2 **Values**: a valid BCD integer, 1 - 31   # noqa: E501

        :param bill_cycle_day: The bill_cycle_day of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :type: int
        """
    ...
    def bill_cycle_type(self):
        """Gets the bill_cycle_type of this ProxyGetProductRatePlanCharge.  # noqa: E501
        ...
        :return: The bill_cycle_type of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :rtype: str
        """
    ...
    def bill_cycle_type(self, bill_cycle_type):
        """Sets the bill_cycle_type of this ProxyGetProductRatePlanCharge.

         Specifies how to determine the billing day for the charge. **Character limit**: 20 **Values**: one of the following:  - `DefaultFromCustomer` - `SpecificDayofMonth:` - `SubscriptionStartDay` - `ChargeTriggerDay` - `SpecificDayofWeek` **Note**:  - If you set this field to `SpecificDayofMonth`, you must specify which day of the month as the billing day for the charge in the BillCycleDay field. - If you set this field to `SpecificDayofWeek`, you must specify which day of the week as the billing day for the charge in the WeeklyBillCycleDay field.   # noqa: E501

        :param bill_cycle_type: The bill_cycle_type of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :type: str
        """
    ...
    def billing_period(self):
        """Gets the billing_period of this ProxyGetProductRatePlanCharge.  # noqa: E501
        ...
        :return: The billing_period of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :rtype: str
        """
    ...
    def billing_period(self, billing_period):
        """Sets the billing_period of this ProxyGetProductRatePlanCharge.

         The billing period for the charge. The start day of the billing period is also called the bill cycle day (BCD). **Character limit**: 15 **Values**: one of the following  - `Month` - `Quarter` - `Annual` - `Semi-Annual` - `Specific Months` - `Subscription Term` (This value is in **Limited Availability**.) - `Week` - `Specific Weeks` **Note**: Specify the number of months or weeks in the SpecificBillingPeriod field if you set this field to `Specific Months` or `Specific Weeks`.   # noqa: E501

        :param billing_period: The billing_period of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :type: str
        """
    ...
    def billing_period_alignment(self):
        """Gets the billing_period_alignment of this ProxyGetProductRatePlanCharge.  # noqa: E501
        ...
        :return: The billing_period_alignment of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :rtype: str
        """
    ...
    def billing_period_alignment(self, billing_period_alignment):
        """Sets the billing_period_alignment of this ProxyGetProductRatePlanCharge.

         Aligns charges within the same subscription if multiple charges begin on different dates. **Character limit**: 24 **Values**: one of the following:  - `AlignToCharge` - `AlignToSubscriptionStart` - `AlignToTermStart`   # noqa: E501

        :param billing_period_alignment: The billing_period_alignment of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :type: str
        """
    ...
    def billing_timing(self):
        """Gets the billing_timing of this ProxyGetProductRatePlanCharge.  # noqa: E501
        ...
        :return: The billing_timing of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :rtype: str
        """
    ...
    def billing_timing(self, billing_timing):
        """Sets the billing_timing of this ProxyGetProductRatePlanCharge.

         The billing timing for the charge. You can choose to bill in advance or in arrears for recurring charge types. This field is not used in one-time or usage based charge types. **Character limit**: **Values**: one of the following:  - `In Advance` - `In Arrears`  This feature is in **Limited Availability**. If you wish to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/).    # noqa: E501

        :param billing_timing: The billing_timing of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :type: str
        """
    ...
    def charge_model(self):
        """Gets the charge_model of this ProxyGetProductRatePlanCharge.  # noqa: E501
        ...
        :return: The charge_model of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :rtype: str
        """
    ...
    def charge_model(self, charge_model):
        """Sets the charge_model of this ProxyGetProductRatePlanCharge.

         Determines how to calculate charges. Charge models must be individually activated in Zuora Billing administration. **Character limit**: 27 **Values**: one of the following:  - `Discount-Fixed Amount` - `Discount-Percentage` - `Flat Fee Pricing` - `Per Unit Pricing` - `Overage Pricing` - `Tiered Pricing` - `Tiered with Overage Pricing` - `Volume Pricing`   # noqa: E501

        :param charge_model: The charge_model of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :type: str
        """
    ...
    def charge_type(self):
        """Gets the charge_type of this ProxyGetProductRatePlanCharge.  # noqa: E501

         Specifies the type of charge. **Character limit**: 9 **Values**: one of the following:  - `OneTime` - `Recurring` - `Usage`   # noqa: E501

        :return: The charge_type of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :rtype: str
        """
    ...
    def charge_type(self, charge_type):
        """Sets the charge_type of this ProxyGetProductRatePlanCharge.

         Specifies the type of charge. **Character limit**: 9 **Values**: one of the following:  - `OneTime` - `Recurring` - `Usage`   # noqa: E501

        :param charge_type: The charge_type of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :type: str
        """
    ...
    def created_by_id(self):
        """Gets the created_by_id of this ProxyGetProductRatePlanCharge.  # noqa: E501
        ...
        :return: The created_by_id of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :rtype: str
        """
    ...
    def created_by_id(self, created_by_id):
        """Sets the created_by_id of this ProxyGetProductRatePlanCharge.

        The ID of the Zuora user who created the `ProductRatePlanCharge` object. **Character limit**: 32 **Values**: automatically generated   # noqa: E501

        :param created_by_id: The created_by_id of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :type: str
        """
    ...
    def created_date(self):
        """Gets the created_date of this ProxyGetProductRatePlanCharge.  # noqa: E501

         The date when the  `ProductRatePlanCharge` object was created. **Character limit**: 29 **Values**: automatically generated   # noqa: E501

        :return: The created_date of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :rtype: datetime
        """
    ...
    def created_date(self, created_date):
        """Sets the created_date of this ProxyGetProductRatePlanCharge.

         The date when the  `ProductRatePlanCharge` object was created. **Character limit**: 29 **Values**: automatically generated   # noqa: E501

        :param created_date: The created_date of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :type: datetime
        """
    ...
    def default_quantity(self):
        """Gets the default_quantity of this ProxyGetProductRatePlanCharge.  # noqa: E501
        ...
        :return: The default_quantity of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :rtype: float
        """
    ...
    def default_quantity(self, default_quantity):
        """Sets the default_quantity of this ProxyGetProductRatePlanCharge.

         The default quantity of units, such as the number of authors in a hosted wiki service. This field is required if you use a per-unit pricing model. **Character limit**: 16 **Values**: a valid quantity value   # noqa: E501

        :param default_quantity: The default_quantity of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :type: float
        """
    ...
    def deferred_revenue_account(self):
        """Gets the deferred_revenue_account of this ProxyGetProductRatePlanCharge.  # noqa: E501
        ...
        :return: The deferred_revenue_account of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :rtype: str
        """
    ...
    def deferred_revenue_account(self, deferred_revenue_account):
        """Sets the deferred_revenue_account of this ProxyGetProductRatePlanCharge.

         The name of the deferred revenue account for this charge. **Character limit**: 100 **Values**: an active accounting code in your Zuora Chart of Accounts This feature is in **Limited Availability**. If you wish to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/).    # noqa: E501

        :param deferred_revenue_account: The deferred_revenue_account of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :type: str
        """
    ...
    def description(self):
        """Gets the description of this ProxyGetProductRatePlanCharge.  # noqa: E501

        A description of the charge. **Character limit**: 500 **Values**: a string of 500 characters or fewer   # noqa: E501

        :return: The description of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this ProxyGetProductRatePlanCharge.

        A description of the charge. **Character limit**: 500 **Values**: a string of 500 characters or fewer   # noqa: E501

        :param description: The description of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :type: str
        """
    ...
    def discount_level(self):
        """Gets the discount_level of this ProxyGetProductRatePlanCharge.  # noqa: E501
        ...
        :return: The discount_level of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :rtype: str
        """
    ...
    def discount_level(self, discount_level):
        """Sets the discount_level of this ProxyGetProductRatePlanCharge.

         Specifies if the discount applies to just the product rate plan, the entire subscription, or to any activity in the account. **Character limit**: 12 **Values**: one of the following:  - `rateplan` - `subscription`, `account`   # noqa: E501

        :param discount_level: The discount_level of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :type: str
        """
    ...
    def end_date_condition(self):
        """Gets the end_date_condition of this ProxyGetProductRatePlanCharge.  # noqa: E501
        ...
        :return: The end_date_condition of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :rtype: str
        """
    ...
    def end_date_condition(self, end_date_condition):
        """Sets the end_date_condition of this ProxyGetProductRatePlanCharge.

         Defines when the charge ends after the charge trigger date. **Values**: one of the following:  - `SubscriptionEnd`: The charge ends on the subscription end date after a specified period based on the trigger date of the charge. This is the default value. - `FixedPeriod`: The charge ends after a specified period based on the trigger date of the charge. If you set this field to `FixedPeriod`, you must specify the length of the period and a period type by defining the `UpToPeriods` and `UpToPeriodsType` fields. **Note**: If the subscription ends before the charge end date, the charge ends when the subscription ends. But if the subscription end date is subsequently changed through a Renewal, or Terms and Conditions amendment, the charge will end on the charge end date.   # noqa: E501

        :param end_date_condition: The end_date_condition of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :type: str
        """
    ...
    @property
    def id(self):
        """Gets the id of this ProxyGetProductRatePlanCharge.  # noqa: E501

        Object identifier.  # noqa: E501

        :return: The id of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this ProxyGetProductRatePlanCharge.

        Object identifier.  # noqa: E501

        :param id: The id of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :type: str
        """
    ...
    def included_units(self):
        """Gets the included_units of this ProxyGetProductRatePlanCharge.  # noqa: E501

        Specifies the number of units in the base set of units. **Character limit**: 16 **Values**: a positive decimal value   # noqa: E501

        :return: The included_units of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :rtype: float
        """
    ...
    def included_units(self, included_units):
        """Sets the included_units of this ProxyGetProductRatePlanCharge.

        Specifies the number of units in the base set of units. **Character limit**: 16 **Values**: a positive decimal value   # noqa: E501

        :param included_units: The included_units of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :type: float
        """
    ...
    def legacy_revenue_reporting(self):
        """Gets the legacy_revenue_reporting of this ProxyGetProductRatePlanCharge.  # noqa: E501

          # noqa: E501

        :return: The legacy_revenue_reporting of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :rtype: bool
        """
    ...
    def legacy_revenue_reporting(self, legacy_revenue_reporting):
        """Sets the legacy_revenue_reporting of this ProxyGetProductRatePlanCharge.

          # noqa: E501

        :param legacy_revenue_reporting: The legacy_revenue_reporting of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :type: bool
        """
    ...
    def list_price_base(self):
        """Gets the list_price_base of this ProxyGetProductRatePlanCharge.  # noqa: E501
        ...
        :return: The list_price_base of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :rtype: str
        """
    ...
    def list_price_base(self, list_price_base):
        """Sets the list_price_base of this ProxyGetProductRatePlanCharge.

        The list price base for the product rate plan charge. **Values**: one of the following:  - `Per Month` - `Per Billing Period` - `Per Week`   # noqa: E501

        :param list_price_base: The list_price_base of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :type: str
        """
    ...
    def max_quantity(self):
        """Gets the max_quantity of this ProxyGetProductRatePlanCharge.  # noqa: E501
        ...
        :return: The max_quantity of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :rtype: float
        """
    ...
    def max_quantity(self, max_quantity):
        """Sets the max_quantity of this ProxyGetProductRatePlanCharge.

         Specifies the maximum number of units for this charge. Use this field and the `MinQuantity` field to create a range of units allowed in a product rate plan charge. **Character limit**: 16 **Values**: a positive decimal value   # noqa: E501

        :param max_quantity: The max_quantity of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :type: float
        """
    ...
    def min_quantity(self):
        """Gets the min_quantity of this ProxyGetProductRatePlanCharge.  # noqa: E501
        ...
        :return: The min_quantity of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :rtype: float
        """
    ...
    def min_quantity(self, min_quantity):
        """Sets the min_quantity of this ProxyGetProductRatePlanCharge.

        Specifies the minimum number of units for this charge. Use this field and the `MaxQuantity` field to create a range of units allowed in a product rate plan charge. **Character limit**: 16 **Values**: a positive decimal value   # noqa: E501

        :param min_quantity: The min_quantity of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :type: float
        """
    ...
    @property
    def name(self):
        """Gets the name of this ProxyGetProductRatePlanCharge.  # noqa: E501

        The name of the product rate plan charge. **Character limit**: 100 **Values**: a string of 100 characters or fewer   # noqa: E501

        :return: The name of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ProxyGetProductRatePlanCharge.

        The name of the product rate plan charge. **Character limit**: 100 **Values**: a string of 100 characters or fewer   # noqa: E501

        :param name: The name of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :type: str
        """
    ...
    def number_of_period(self):
        """Gets the number_of_period of this ProxyGetProductRatePlanCharge.  # noqa: E501
        ...
        :return: The number_of_period of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :rtype: int
        """
    ...
    def number_of_period(self, number_of_period):
        """Sets the number_of_period of this ProxyGetProductRatePlanCharge.

        Specifies the number of periods to use when calculating charges in an overage smoothing charge model. **Character limit**: **Values**: a positive whole number   # noqa: E501

        :param number_of_period: The number_of_period of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :type: int
        """
    ...
    def overage_calculation_option(self):
        """Gets the overage_calculation_option of this ProxyGetProductRatePlanCharge.  # noqa: E501
        ...
        :return: The overage_calculation_option of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :rtype: str
        """
    ...
    def overage_calculation_option(self, overage_calculation_option):
        """Sets the overage_calculation_option of this ProxyGetProductRatePlanCharge.

        Determines when to calculate overage charges. If the value of the SmoothingMode field is not specified, the value of this field is ignored. **Character limit**: 20 **Values**: one of the following:  - `EndOfSmoothingPeriod`: This option is used by default. The overage is charged at the end of the smoothing period. - `PerBillingPeriod`: The overage is charged on-demand rather than waiting until the end of the smoothing period.   # noqa: E501

        :param overage_calculation_option: The overage_calculation_option of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :type: str
        """
    ...
    def overage_unused_units_credit_option(self):
        """Gets the overage_unused_units_credit_option of this ProxyGetProductRatePlanCharge.  # noqa: E501
        ...
        :return: The overage_unused_units_credit_option of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :rtype: str
        """
    ...
    def overage_unused_units_credit_option(self, overage_unused_units_credit_option):
        """Sets the overage_unused_units_credit_option of this ProxyGetProductRatePlanCharge.

         Determines whether to credit the customer with unused units of usage. **Character limit**: 20 **Values**: one of the following:  - `NoCredit` - `CreditBySpecificRate`   # noqa: E501

        :param overage_unused_units_credit_option: The overage_unused_units_credit_option of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :type: str
        """
    ...
    def price_change_option(self):
        """Gets the price_change_option of this ProxyGetProductRatePlanCharge.  # noqa: E501
        ...
        :return: The price_change_option of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :rtype: str
        """
    ...
    def price_change_option(self, price_change_option):
        """Sets the price_change_option of this ProxyGetProductRatePlanCharge.

         Applies an automatic price change when a termed subscription is renewed. **Character limit**: **Values**: one of the following:  - `NoChange` (default) - `SpecificPercentageValue` - `UseLatestProductCatalogPricing`   # noqa: E501

        :param price_change_option: The price_change_option of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :type: str
        """
    ...
    def price_increase_percentage(self):
        """Gets the price_increase_percentage of this ProxyGetProductRatePlanCharge.  # noqa: E501
        ...
        :return: The price_increase_percentage of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :rtype: float
        """
    ...
    def price_increase_percentage(self, price_increase_percentage):
        """Sets the price_increase_percentage of this ProxyGetProductRatePlanCharge.

         Specifies the percentage to increase or decrease the price of a termed subscription's renewal. Use this field if you set the value to `SpecificPercentageValue`. **Character limit**: 16 **Values**: a decimal value between -100 and 100   # noqa: E501

        :param price_increase_percentage: The price_increase_percentage of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :type: float
        """
    ...
    def product_rate_plan_id(self):
        """Gets the product_rate_plan_id of this ProxyGetProductRatePlanCharge.  # noqa: E501
        ...
        :return: The product_rate_plan_id of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :rtype: str
        """
    ...
    def product_rate_plan_id(self, product_rate_plan_id):
        """Sets the product_rate_plan_id of this ProxyGetProductRatePlanCharge.

         The ID of the product rate plan associated with this product rate plan charge. **Character limit**: 32 **Values**: a valid product rate plan ID   # noqa: E501

        :param product_rate_plan_id: The product_rate_plan_id of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :type: str
        """
    ...
    def rating_group(self):
        """Gets the rating_group of this ProxyGetProductRatePlanCharge.  # noqa: E501
        ...
        :return: The rating_group of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :rtype: str
        """
    ...
    def rating_group(self, rating_group):
        """Sets the rating_group of this ProxyGetProductRatePlanCharge.

        A rating group based on which usage records are rated. Only applicable to Usage charges.  Possible values:  - `ByBillingPeriod`: The rating is based on all the usages in a billing period. - `ByUsageStartDate`: The rating is based on all the usages on the same usage start date.  - `ByUsageRecord`: The rating is based on each usage record. - `ByUsageUpload`: The rating is based on all the  usages in a uploaded usage file (`.xls` or `.csv`). - `ByGroupId`: The rating is based on all the usages in a custom group.  For more information, see [Usage rating by group](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/J_Billing_Operations/Usage/Usage_Rating_by_Group).   # noqa: E501

        :param rating_group: The rating_group of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :type: str
        """
    ...
    def recognized_revenue_account(self):
        """Gets the recognized_revenue_account of this ProxyGetProductRatePlanCharge.  # noqa: E501
        ...
        :return: The recognized_revenue_account of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :rtype: str
        """
    ...
    def recognized_revenue_account(self, recognized_revenue_account):
        """Sets the recognized_revenue_account of this ProxyGetProductRatePlanCharge.

         The name of the recognized revenue account for this charge.  - Required when the Allow Blank Accounting Code setting is No. - Optional when the Allow Blank Accounting Code setting is Yes.  **Character limit**: 100 **Values**: an active accounting code in your Zuora Chart of Accounts This feature is in **Limited Availability**. If you wish to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/).    # noqa: E501

        :param recognized_revenue_account: The recognized_revenue_account of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :type: str
        """
    ...
    def rev_rec_code(self):
        """Gets the rev_rec_code of this ProxyGetProductRatePlanCharge.  # noqa: E501
        ...
        :return: The rev_rec_code of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :rtype: str
        """
    ...
    def rev_rec_code(self, rev_rec_code):
        """Sets the rev_rec_code of this ProxyGetProductRatePlanCharge.

        Associates this product rate plan charge with a specific revenue recognition code. **Character limit**: 70 **Values**: a valid revenue recognition code   # noqa: E501

        :param rev_rec_code: The rev_rec_code of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :type: str
        """
    ...
    def rev_rec_trigger_condition(self):
        """Gets the rev_rec_trigger_condition of this ProxyGetProductRatePlanCharge.  # noqa: E501
        ...
        :return: The rev_rec_trigger_condition of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :rtype: str
        """
    ...
    def rev_rec_trigger_condition(self, rev_rec_trigger_condition):
        """Sets the rev_rec_trigger_condition of this ProxyGetProductRatePlanCharge.

         Specifies when revenue recognition begins. **Character limit**: 22 **Values**: one of the following:  - `ContractEffectiveDate` - `ServiceActivationDate` - `CustomerAcceptanceDate`   # noqa: E501

        :param rev_rec_trigger_condition: The rev_rec_trigger_condition of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :type: str
        """
    ...
    def revenue_recognition_rule_name(self):
        """Gets the revenue_recognition_rule_name of this ProxyGetProductRatePlanCharge.  # noqa: E501
        ...
        :return: The revenue_recognition_rule_name of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :rtype: str
        """
    ...
    def revenue_recognition_rule_name(self, revenue_recognition_rule_name):
        """Sets the revenue_recognition_rule_name of this ProxyGetProductRatePlanCharge.

        Determines when to recognize the revenue for this charge. **Character limit**: 25 **Values**: one of the following:  - `Recognize upon invoicing` - `Recognize daily over time`   # noqa: E501

        :param revenue_recognition_rule_name: The revenue_recognition_rule_name of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :type: str
        """
    ...
    def smoothing_model(self):
        """Gets the smoothing_model of this ProxyGetProductRatePlanCharge.  # noqa: E501
        ...
        :return: The smoothing_model of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :rtype: str
        """
    ...
    def smoothing_model(self, smoothing_model):
        """Sets the smoothing_model of this ProxyGetProductRatePlanCharge.

         Specifies the smoothing model for an overage smoothing charge model. **Character limit**: 22 **Values**: one of the following:  - `RollingWindow` - `Rollover`   # noqa: E501

        :param smoothing_model: The smoothing_model of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :type: str
        """
    ...
    def specific_billing_period(self):
        """Gets the specific_billing_period of this ProxyGetProductRatePlanCharge.  # noqa: E501
        ...
        :return: The specific_billing_period of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :rtype: int
        """
    ...
    def specific_billing_period(self, specific_billing_period):
        """Sets the specific_billing_period of this ProxyGetProductRatePlanCharge.

         Customizes the number of months or weeks for the charges billing period. This field is required if you set the value of the BillingPeriod field to `Specific Months` or `Specific Weeks`. **Values**: a positive integer   # noqa: E501

        :param specific_billing_period: The specific_billing_period of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :type: int
        """
    ...
    @property
    def tax_code(self):
        """Gets the tax_code of this ProxyGetProductRatePlanCharge.  # noqa: E501
        ...
        :return: The tax_code of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :rtype: str
        """
    ...
    def tax_code(self, tax_code):
        """Sets the tax_code of this ProxyGetProductRatePlanCharge.

         Specifies the tax code for taxation rules. Required when the Taxable field is set to `True`.  **Character limit**: 64  **Values**: a valid tax code  **Note**: This value affects the tax calculation of rate plan charges that come from the `ProductRatePlanCharge`.   # noqa: E501

        :param tax_code: The tax_code of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :type: str
        """
    ...
    @property
    def tax_mode(self):
        """Gets the tax_mode of this ProxyGetProductRatePlanCharge.  # noqa: E501
        ...
        :return: The tax_mode of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :rtype: str
        """
    ...
    def tax_mode(self, tax_mode):
        """Sets the tax_mode of this ProxyGetProductRatePlanCharge.

         Determines how to define taxation for the charge. Required when the Taxable field is set to `True`.  **Character limit**: 12  **Values**: one of the following:  - `TaxExclusive` - `TaxInclusive`  **Note**: This value affects the tax calculation of rate plan charges that come from the `ProductRatePlanCharge`.   # noqa: E501

        :param tax_mode: The tax_mode of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :type: str
        """
    ...
    @property
    def taxable(self):
        """Gets the taxable of this ProxyGetProductRatePlanCharge.  # noqa: E501
        ...
        :return: The taxable of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :rtype: bool
        """
    ...
    def taxable(self, taxable):
        """Sets the taxable of this ProxyGetProductRatePlanCharge.

         Determines whether the charge is taxable. When set to `True`, the TaxMode and TaxCode fields are required when creating or updating th ProductRatePlanCharge object.  **Character limit**: 5  **Values**: `True`, `False`  **Note**: This value affects the tax calculation of rate plan charges that come from the `ProductRatePlanCharge`.   # noqa: E501

        :param taxable: The taxable of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :type: bool
        """
    ...
    def trigger_event(self):
        """Gets the trigger_event of this ProxyGetProductRatePlanCharge.  # noqa: E501
        ...
        :return: The trigger_event of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :rtype: str
        """
    ...
    def trigger_event(self, trigger_event):
        """Sets the trigger_event of this ProxyGetProductRatePlanCharge.

         Specifies when to start billing the customer for the charge. **Character limit**: 18 **Values**: one of the following:  - `ContractEffective` is the date when the subscription's contract goes into effect and the charge is ready to be billed. - `ServiceActivation` is the date when the services or products for a subscription have been activated and the customers have access. - `CustomerAcceptance` is when the customer accepts the services or products for a subscription.   # noqa: E501

        :param trigger_event: The trigger_event of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :type: str
        """
    ...
    @property
    def uom(self):
        """Gets the uom of this ProxyGetProductRatePlanCharge.  # noqa: E501
        ...
        :return: The uom of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :rtype: str
        """
        return self._uom
    ...
    @uom.setter
    def uom(self, uom):
        """Sets the uom of this ProxyGetProductRatePlanCharge.

         Specifies the units to measure usage. **Character limit**: 25 **Values**: a configured unit of measure **Note**: You must specify this field when creating the following charge models:  - Per Unit Pricing - Volume Pricing - Overage Pricing - Tiered Pricing - Tiered with Overage Pricing   # noqa: E501

        :param uom: The uom of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :type: str
        """
    ...
    def up_to_periods(self):
        """Gets the up_to_periods of this ProxyGetProductRatePlanCharge.  # noqa: E501
        ...
        :return: The up_to_periods of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :rtype: int
        """
    ...
    def up_to_periods(self, up_to_periods):
        """Sets the up_to_periods of this ProxyGetProductRatePlanCharge.

         Specifies the length of the period during which the charge is active. If this period ends before the subscription ends, the charge ends when this period ends. **Character limit**: 5 **Values**: a whole number between 0 and 65535, exclusive **Note**:  - You must use this field together with the `UpToPeriodsType` field to specify the time period. This field is applicable only when the `EndDateCondition` field is set to `FixedPeriod`. - If the subscription end date is subsequently changed through a Renewal, or Terms and Conditions amendment, the charge end date will change accordingly up to the original period end.   # noqa: E501

        :param up_to_periods: The up_to_periods of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :type: int
        """
    ...
    def up_to_periods_type(self):
        """Gets the up_to_periods_type of this ProxyGetProductRatePlanCharge.  # noqa: E501
        ...
        :return: The up_to_periods_type of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :rtype: str
        """
    ...
    def up_to_periods_type(self, up_to_periods_type):
        """Sets the up_to_periods_type of this ProxyGetProductRatePlanCharge.

         The period type used to define when the charge ends. **Character limit**: -- **Values**: one of the following:  - `Billing Periods` (default) - `Days` - `Weeks` - `Months` - `Years`  **Note**:  - You must use this field together with the `UpToPeriods` field to specify the time period. - This field is applicable only when the `EndDateCondition` field is set to `FixedPeriod`.   # noqa: E501

        :param up_to_periods_type: The up_to_periods_type of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :type: str
        """
    ...
    def updated_by_id(self):
        """Gets the updated_by_id of this ProxyGetProductRatePlanCharge.  # noqa: E501

        The ID of the last user to update the object. **Character limit**: 32 **Values**: automatically generated   # noqa: E501

        :return: The updated_by_id of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :rtype: str
        """
    ...
    def updated_by_id(self, updated_by_id):
        """Sets the updated_by_id of this ProxyGetProductRatePlanCharge.

        The ID of the last user to update the object. **Character limit**: 32 **Values**: automatically generated   # noqa: E501

        :param updated_by_id: The updated_by_id of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :type: str
        """
    ...
    def updated_date(self):
        """Gets the updated_date of this ProxyGetProductRatePlanCharge.  # noqa: E501

        The date when the object was last updated. **Character limit**: 29 **Values**: automatically generated   # noqa: E501

        :return: The updated_date of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :rtype: datetime
        """
    ...
    def updated_date(self, updated_date):
        """Sets the updated_date of this ProxyGetProductRatePlanCharge.

        The date when the object was last updated. **Character limit**: 29 **Values**: automatically generated   # noqa: E501

        :param updated_date: The updated_date of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :type: datetime
        """
    ...
    def use_discount_specific_accounting_code(self):
        """Gets the use_discount_specific_accounting_code of this ProxyGetProductRatePlanCharge.  # noqa: E501
        ...
        :return: The use_discount_specific_accounting_code of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :rtype: bool
        """
    ...
    def use_discount_specific_accounting_code(self, use_discount_specific_accounting_code):
        """Sets the use_discount_specific_accounting_code of this ProxyGetProductRatePlanCharge.

        Determines whether to define a new accounting code for the new discount charge. **Character limit**: 5 **Values**: `True`, `False`   # noqa: E501

        :param use_discount_specific_accounting_code: The use_discount_specific_accounting_code of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :type: bool
        """
    ...
    def use_tenant_default_for_price_change(self):
        """Gets the use_tenant_default_for_price_change of this ProxyGetProductRatePlanCharge.  # noqa: E501
        ...
        :return: The use_tenant_default_for_price_change of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :rtype: bool
        """
    ...
    def use_tenant_default_for_price_change(self, use_tenant_default_for_price_change):
        """Sets the use_tenant_default_for_price_change of this ProxyGetProductRatePlanCharge.

         Applies the tenant-level percentage uplift value for an automatic price change to a termed subscription's renewal. **Character limit**: 5 **Values**: `true`, `false`   # noqa: E501

        :param use_tenant_default_for_price_change: The use_tenant_default_for_price_change of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :type: bool
        """
    ...
    def weekly_bill_cycle_day(self):
        """Gets the weekly_bill_cycle_day of this ProxyGetProductRatePlanCharge.  # noqa: E501
        ...
        :return: The weekly_bill_cycle_day of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :rtype: str
        """
    ...
    def weekly_bill_cycle_day(self, weekly_bill_cycle_day):
        """Sets the weekly_bill_cycle_day of this ProxyGetProductRatePlanCharge.

         Specifies which day of the week as the bill cycle day (BCD) for the charge. This feature is in **Limited Availability**. If you wish to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/).  **Values**: one of the following:  - `Sunday` - `Monday` - `Tuesday` - `Wednesday` - `Thursday` - `Friday` - `Saturday`   # noqa: E501

        :param weekly_bill_cycle_day: The weekly_bill_cycle_day of this ProxyGetProductRatePlanCharge.  # noqa: E501
        :type: str
        """
    ...
    def include_children__ns(self, include_children__ns):
        ...
        if self.local_vars_configuration.client_side_validation and include_children__ns not in allowed_values:  # noqa: E501
            raise ValueError(
    ...
    def item_type__ns(self, item_type__ns):
        ...
        if self.local_vars_configuration.client_side_validation and item_type__ns not in allowed_values:  # noqa: E501
            raise ValueError(
    ...
    def rev_rec_end__ns(self, rev_rec_end__ns):
        ...
        if self.local_vars_configuration.client_side_validation and rev_rec_end__ns not in allowed_values:  # noqa: E501
            raise ValueError(
    ...
    def rev_rec_start__ns(self, rev_rec_start__ns):
        ...
        """
        allowed_values = ["Charge Period Start", "Rev Rec Trigger Date", "Use NetSuite Rev Rec Template"]  # noqa: E501
        if self.local_vars_configuration.client_side_validation and rev_rec_start__ns not in allowed_values:  # noqa: E501
            raise ValueError(
