...
class ProxyCreatePaymentAllOf(object):
    ...
    @property
    def account_id(self):
        """Gets the account_id of this ProxyCreatePaymentAllOf.  # noqa: E501

        The unique account ID for the customer that the payment is for.   # noqa: E501

        :return: The account_id of this ProxyCreatePaymentAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def account_id(self, account_id):
        """Sets the account_id of this ProxyCreatePaymentAllOf.

        The unique account ID for the customer that the payment is for.   # noqa: E501

        :param account_id: The account_id of this ProxyCreatePaymentAllOf.  # noqa: E501
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and account_id is None:  # noqa: E501
            raise ValueError("Invalid value for `account_id`, must not be `None`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                account_id is not None and len(account_id) > 32):
            raise ValueError("Invalid value for `account_id`, length must be less than or equal to `32`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                account_id is not None and len(account_id) < 0):
    ...
    def accounting_code(self):
        """Gets the accounting_code of this ProxyCreatePaymentAllOf.  # noqa: E501
        ...
        :return: The accounting_code of this ProxyCreatePaymentAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def accounting_code(self, accounting_code):
        """Sets the accounting_code of this ProxyCreatePaymentAllOf.

        The accounting code for the payment. Accounting codes group transactions that contain similar accounting attributes.   # noqa: E501

        :param accounting_code: The accounting_code of this ProxyCreatePaymentAllOf.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                accounting_code is not None and len(accounting_code) > 100):
            raise ValueError("Invalid value for `accounting_code`, length must be less than or equal to `100`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                accounting_code is not None and len(accounting_code) < 0):
    ...
    @property
    def amount(self):
        """Gets the amount of this ProxyCreatePaymentAllOf.  # noqa: E501

        The amount of the payment.  If Invoice Settlement is enabled, this field is required.   # noqa: E501

        :return: The amount of this ProxyCreatePaymentAllOf.  # noqa: E501
        :rtype: float
        """
        return self._amount
    ...
    def amount(self, amount):
        """Sets the amount of this ProxyCreatePaymentAllOf.

        The amount of the payment.  If Invoice Settlement is enabled, this field is required.   # noqa: E501

        :param amount: The amount of this ProxyCreatePaymentAllOf.  # noqa: E501
        :type: float
        """
    ...
    def applied_credit_balance_amount(self):
        """Gets the applied_credit_balance_amount of this ProxyCreatePaymentAllOf.  # noqa: E501

        If you have the Invoice Settlement feature disabled, the value of this field is the amount of the payment to apply to a credit balance. This field is only required if the `AppliedInvoiceAmount` field value is null.  If you have the Invoice Settlement feature enabled, the value of this field is created as the unapplied amount.   # noqa: E501

        :return: The applied_credit_balance_amount of this ProxyCreatePaymentAllOf.  # noqa: E501
        :rtype: float
        """
    ...
    def applied_credit_balance_amount(self, applied_credit_balance_amount):
        """Sets the applied_credit_balance_amount of this ProxyCreatePaymentAllOf.

        If you have the Invoice Settlement feature disabled, the value of this field is the amount of the payment to apply to a credit balance. This field is only required if the `AppliedInvoiceAmount` field value is null.  If you have the Invoice Settlement feature enabled, the value of this field is created as the unapplied amount.   # noqa: E501

        :param applied_credit_balance_amount: The applied_credit_balance_amount of this ProxyCreatePaymentAllOf.  # noqa: E501
        :type: float
        """
    ...
    def applied_invoice_amount(self):
        """Gets the applied_invoice_amount of this ProxyCreatePaymentAllOf.  # noqa: E501
        ...
        :return: The applied_invoice_amount of this ProxyCreatePaymentAllOf.  # noqa: E501
        :rtype: float
        """
    ...
    def applied_invoice_amount(self, applied_invoice_amount):
        """Sets the applied_invoice_amount of this ProxyCreatePaymentAllOf.

        The amount of the payment to apply to an invoice. This field is only required if either the `InvoiceId` or `InvoiceNumber` field is not null.   # noqa: E501

        :param applied_invoice_amount: The applied_invoice_amount of this ProxyCreatePaymentAllOf.  # noqa: E501
        :type: float
        """
    ...
    def auth_transaction_id(self):
        """Gets the auth_transaction_id of this ProxyCreatePaymentAllOf.  # noqa: E501

        The authorization transaction ID from the payment gateway. Use this field for electronic payments, such as credit cards.  The following payment gateways support this field:   - Adyen Integration v2.0   - CyberSource 1.28   - CyberSource 1.97   - CyberSource 2.0   - Chase Paymentech Orbital   - Ingenico ePayments   - SlimPay   - Verifi Global Payment Gateway   - WePay Payment Gateway Integration   # noqa: E501

        :return: The auth_transaction_id of this ProxyCreatePaymentAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def auth_transaction_id(self, auth_transaction_id):
        """Sets the auth_transaction_id of this ProxyCreatePaymentAllOf.

        The authorization transaction ID from the payment gateway. Use this field for electronic payments, such as credit cards.  The following payment gateways support this field:   - Adyen Integration v2.0   - CyberSource 1.28   - CyberSource 1.97   - CyberSource 2.0   - Chase Paymentech Orbital   - Ingenico ePayments   - SlimPay   - Verifi Global Payment Gateway   - WePay Payment Gateway Integration   # noqa: E501

        :param auth_transaction_id: The auth_transaction_id of this ProxyCreatePaymentAllOf.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                auth_transaction_id is not None and len(auth_transaction_id) > 50):
            raise ValueError("Invalid value for `auth_transaction_id`, length must be less than or equal to `50`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                auth_transaction_id is not None and len(auth_transaction_id) < 0):
    ...
    @property
    def comment(self):
        """Gets the comment of this ProxyCreatePaymentAllOf.  # noqa: E501

        Additional information related to the payment.   # noqa: E501

        :return: The comment of this ProxyCreatePaymentAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def comment(self, comment):
        """Sets the comment of this ProxyCreatePaymentAllOf.

        Additional information related to the payment.   # noqa: E501

        :param comment: The comment of this ProxyCreatePaymentAllOf.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def effective_date(self):
        """Gets the effective_date of this ProxyCreatePaymentAllOf.  # noqa: E501

        The date when the payment takes effect.   # noqa: E501

        :return: The effective_date of this ProxyCreatePaymentAllOf.  # noqa: E501
        :rtype: date
        """
    ...
    def effective_date(self, effective_date):
        """Sets the effective_date of this ProxyCreatePaymentAllOf.

        The date when the payment takes effect.   # noqa: E501

        :param effective_date: The effective_date of this ProxyCreatePaymentAllOf.  # noqa: E501
        :type: date
        """
    ...
    @property
    def gateway(self):
        """Gets the gateway of this ProxyCreatePaymentAllOf.  # noqa: E501
        ...
        :return: The gateway of this ProxyCreatePaymentAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def gateway(self, gateway):
        """Sets the gateway of this ProxyCreatePaymentAllOf.

        The name of the gateway instance that processes the payment. When creating a payment, the value of this field must be a valid gateway instance name, and this gateway must support the specific payment method. If no value is specified, the default gateway on the Account will be used.   # noqa: E501

        :param gateway: The gateway of this ProxyCreatePaymentAllOf.  # noqa: E501
        :type: str
        """
    ...
    def gateway_option_data(self):
        """Gets the gateway_option_data of this ProxyCreatePaymentAllOf.  # noqa: E501


        :return: The gateway_option_data of this ProxyCreatePaymentAllOf.  # noqa: E501
    ...
    def gateway_option_data(self, gateway_option_data):
        """Sets the gateway_option_data of this ProxyCreatePaymentAllOf.


        :param gateway_option_data: The gateway_option_data of this ProxyCreatePaymentAllOf.  # noqa: E501
    ...
    def gateway_order_id(self):
        """Gets the gateway_order_id of this ProxyCreatePaymentAllOf.  # noqa: E501
        ...
        :return: The gateway_order_id of this ProxyCreatePaymentAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def gateway_order_id(self, gateway_order_id):
        """Sets the gateway_order_id of this ProxyCreatePaymentAllOf.

        A merchant-specified natural key value that can be passed to the electronic payment gateway when a payment is created. If not specified, the payment number will be passed in instead.  Gateways check duplicates on the gateway order ID to ensure that the merchant do not accidentally enter the same transaction twice. This ID can also be used to do reconciliation and tie the payment to a natural key in external systems. The source of this ID varies by merchant. Some merchants use their shopping cart order IDs, and others use something different. Merchants use this ID to track transactions in their eCommerce systems.   # noqa: E501

        :param gateway_order_id: The gateway_order_id of this ProxyCreatePaymentAllOf.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                gateway_order_id is not None and len(gateway_order_id) > 70):
            raise ValueError("Invalid value for `gateway_order_id`, length must be less than or equal to `70`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                gateway_order_id is not None and len(gateway_order_id) < 0):
    ...
    def gateway_response(self):
        """Gets the gateway_response of this ProxyCreatePaymentAllOf.  # noqa: E501

        The message returned from the payment gateway for the payment. This message is gateway-dependent.   # noqa: E501

        :return: The gateway_response of this ProxyCreatePaymentAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def gateway_response(self, gateway_response):
        """Sets the gateway_response of this ProxyCreatePaymentAllOf.

        The message returned from the payment gateway for the payment. This message is gateway-dependent.   # noqa: E501

        :param gateway_response: The gateway_response of this ProxyCreatePaymentAllOf.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                gateway_response is not None and len(gateway_response) > 500):
            raise ValueError("Invalid value for `gateway_response`, length must be less than or equal to `500`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                gateway_response is not None and len(gateway_response) < 0):
    ...
    def gateway_response_code(self):
        """Gets the gateway_response_code of this ProxyCreatePaymentAllOf.  # noqa: E501

        The code returned from the payment gateway for the payment. This code is gateway-dependent.   # noqa: E501

        :return: The gateway_response_code of this ProxyCreatePaymentAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def gateway_response_code(self, gateway_response_code):
        """Sets the gateway_response_code of this ProxyCreatePaymentAllOf.

        The code returned from the payment gateway for the payment. This code is gateway-dependent.   # noqa: E501

        :param gateway_response_code: The gateway_response_code of this ProxyCreatePaymentAllOf.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                gateway_response_code is not None and len(gateway_response_code) > 20):
            raise ValueError("Invalid value for `gateway_response_code`, length must be less than or equal to `20`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                gateway_response_code is not None and len(gateway_response_code) < 0):
    ...
    def gateway_state(self):
        """Gets the gateway_state of this ProxyCreatePaymentAllOf.  # noqa: E501

        The status of the payment in the gateway; use for reconciliation.   # noqa: E501

        :return: The gateway_state of this ProxyCreatePaymentAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def gateway_state(self, gateway_state):
        """Sets the gateway_state of this ProxyCreatePaymentAllOf.

        The status of the payment in the gateway; use for reconciliation.   # noqa: E501

        :param gateway_state: The gateway_state of this ProxyCreatePaymentAllOf.  # noqa: E501
        :type: str
        """
    ...
    @property
    def invoice_id(self):
        """Gets the invoice_id of this ProxyCreatePaymentAllOf.  # noqa: E501
        ...
        :return: The invoice_id of this ProxyCreatePaymentAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def invoice_id(self, invoice_id):
        """Sets the invoice_id of this ProxyCreatePaymentAllOf.

        The ID of the invoice that the payment is applied to. When applying a payment to a single invoice, this field is only required if the `InvoiceNumber` field is null.   # noqa: E501

        :param invoice_id: The invoice_id of this ProxyCreatePaymentAllOf.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                invoice_id is not None and len(invoice_id) > 32):
            raise ValueError("Invalid value for `invoice_id`, length must be less than or equal to `32`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                invoice_id is not None and len(invoice_id) < 0):
    ...
    def invoice_number(self):
        """Gets the invoice_number of this ProxyCreatePaymentAllOf.  # noqa: E501
        ...
        :return: The invoice_number of this ProxyCreatePaymentAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def invoice_number(self, invoice_number):
        """Sets the invoice_number of this ProxyCreatePaymentAllOf.

        The unique identification number for the invoice that the payment is applied to. When applying a payment to a single invoice, this field is only required if the `InvoiceId` field is null.   # noqa: E501

        :param invoice_number: The invoice_number of this ProxyCreatePaymentAllOf.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                invoice_number is not None and len(invoice_number) > 32):
    ...
    def invoice_payment_data(self):
        """Gets the invoice_payment_data of this ProxyCreatePaymentAllOf.  # noqa: E501


        :return: The invoice_payment_data of this ProxyCreatePaymentAllOf.  # noqa: E501
    ...
    def invoice_payment_data(self, invoice_payment_data):
        """Sets the invoice_payment_data of this ProxyCreatePaymentAllOf.


        :param invoice_payment_data: The invoice_payment_data of this ProxyCreatePaymentAllOf.  # noqa: E501
    ...
    def payment_method_id(self):
        """Gets the payment_method_id of this ProxyCreatePaymentAllOf.  # noqa: E501

        The ID of the payment method used for the payment.    # noqa: E501

        :return: The payment_method_id of this ProxyCreatePaymentAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def payment_method_id(self, payment_method_id):
        """Sets the payment_method_id of this ProxyCreatePaymentAllOf.

        The ID of the payment method used for the payment.    # noqa: E501

        :param payment_method_id: The payment_method_id of this ProxyCreatePaymentAllOf.  # noqa: E501
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and payment_method_id is None:  # noqa: E501
            raise ValueError("Invalid value for `payment_method_id`, must not be `None`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                payment_method_id is not None and len(payment_method_id) > 32):
            raise ValueError("Invalid value for `payment_method_id`, length must be less than or equal to `32`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                payment_method_id is not None and len(payment_method_id) < 0):
    ...
    def payment_number(self):
        """Gets the payment_number of this ProxyCreatePaymentAllOf.  # noqa: E501

        The unique identification number of the payment. For example, P-00000028.   # noqa: E501

        :return: The payment_number of this ProxyCreatePaymentAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def payment_number(self, payment_number):
        """Sets the payment_number of this ProxyCreatePaymentAllOf.

        The unique identification number of the payment. For example, P-00000028.   # noqa: E501

        :param payment_number: The payment_number of this ProxyCreatePaymentAllOf.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                payment_number is not None and len(payment_number) > 32):
            raise ValueError("Invalid value for `payment_number`, length must be less than or equal to `32`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                payment_number is not None and len(payment_number) < 0):
    ...
    def reference_id(self):
        """Gets the reference_id of this ProxyCreatePaymentAllOf.  # noqa: E501
        ...
        :return: The reference_id of this ProxyCreatePaymentAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def reference_id(self, reference_id):
        """Sets the reference_id of this ProxyCreatePaymentAllOf.

        The transaction ID returned by the payment gateway. Use this field to reconcile payments between your gateway and Zuora Payments.   # noqa: E501

        :param reference_id: The reference_id of this ProxyCreatePaymentAllOf.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                reference_id is not None and len(reference_id) > 100):
            raise ValueError("Invalid value for `reference_id`, length must be less than or equal to `100`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                reference_id is not None and len(reference_id) < 0):
    ...
    def soft_descriptor(self):
        """Gets the soft_descriptor of this ProxyCreatePaymentAllOf.  # noqa: E501
        ...
        :return: The soft_descriptor of this ProxyCreatePaymentAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def soft_descriptor(self, soft_descriptor):
        """Sets the soft_descriptor of this ProxyCreatePaymentAllOf.

        A payment gateway-specific field that maps to Zuora for the gateways, Orbital, Vantiv and Verifi.   Zuora passes this field to Verifi directly without verification. In general, this field will be defaulted by the gateway. For Orbital, this field contains two fields separated by an asterisk, `SDMerchantName` and `SDProductionInfo`. For more information, contact your payment gateway.   # noqa: E501

        :param soft_descriptor: The soft_descriptor of this ProxyCreatePaymentAllOf.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                soft_descriptor is not None and len(soft_descriptor) > 35):
            raise ValueError("Invalid value for `soft_descriptor`, length must be less than or equal to `35`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                soft_descriptor is not None and len(soft_descriptor) < 0):
    ...
    def soft_descriptor_phone(self):
        """Gets the soft_descriptor_phone of this ProxyCreatePaymentAllOf.  # noqa: E501
        ...
        :return: The soft_descriptor_phone of this ProxyCreatePaymentAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def soft_descriptor_phone(self, soft_descriptor_phone):
        """Sets the soft_descriptor_phone of this ProxyCreatePaymentAllOf.

        A payment gateway-specific field that maps to Zuora for the gateways, Orbital, Vantiv and Verifi.  Verifi and Orbital determine how to format this string. For more information, contact your payment gateway.   # noqa: E501

        :param soft_descriptor_phone: The soft_descriptor_phone of this ProxyCreatePaymentAllOf.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                soft_descriptor_phone is not None and len(soft_descriptor_phone) > 20):
            raise ValueError("Invalid value for `soft_descriptor_phone`, length must be less than or equal to `20`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                soft_descriptor_phone is not None and len(soft_descriptor_phone) < 0):
    ...
    @property
    def status(self):
        """Gets the status of this ProxyCreatePaymentAllOf.  # noqa: E501

        The status of the payment in Zuora. The only available value is `Processed`.   # noqa: E501

        :return: The status of this ProxyCreatePaymentAllOf.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this ProxyCreatePaymentAllOf.

        The status of the payment in Zuora. The only available value is `Processed`.   # noqa: E501

        :param status: The status of this ProxyCreatePaymentAllOf.  # noqa: E501
        :type: str
        """
    ...
    @property
    def type(self):
        """Gets the type of this ProxyCreatePaymentAllOf.  # noqa: E501

        The type of the payment, whether the payment is external or electronic.   # noqa: E501

        :return: The type of this ProxyCreatePaymentAllOf.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this ProxyCreatePaymentAllOf.

        The type of the payment, whether the payment is external or electronic.   # noqa: E501

        :param type: The type of this ProxyCreatePaymentAllOf.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProxyCreatePaymentAllOf):
            return False
