...
class ProxyModifyProduct(object):
    ...
    def __init__(self, allow_feature_changes=None, category=None, description=None, effective_end_date=None, effective_start_date=None, name=None, sku=None, integration_id__ns=None, integration_status__ns=None, item_type__ns=None, sync_date__ns=None, local_vars_configuration=None):  # noqa: E501
        """ProxyModifyProduct - a model defined in OpenAPI"""  # noqa: E501
    ...
    def allow_feature_changes(self):
        """Gets the allow_feature_changes of this ProxyModifyProduct.  # noqa: E501
        ...
        :return: The allow_feature_changes of this ProxyModifyProduct.  # noqa: E501
        :rtype: bool
        """
    ...
    def allow_feature_changes(self, allow_feature_changes):
        """Sets the allow_feature_changes of this ProxyModifyProduct.

         Controls whether to allow your users to add or remove features while creating or amending a subscription. **Character** **limit**: n/a **Values**: true, false (default)   # noqa: E501

        :param allow_feature_changes: The allow_feature_changes of this ProxyModifyProduct.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def category(self):
        """Gets the category of this ProxyModifyProduct.  # noqa: E501
        ...
        :return: The category of this ProxyModifyProduct.  # noqa: E501
        :rtype: str
        """
    ...
    def category(self, category):
        """Sets the category of this ProxyModifyProduct.

         Category of the product. Used by Zuora Quotes Guided Product Selector. **Character** **limit**: 100 **Values**: One of the following:  - Base Products - Add On Services - Miscellaneous Products   # noqa: E501

        :param category: The category of this ProxyModifyProduct.  # noqa: E501
        :type: str
        """
    ...
    def description(self):
        """Gets the description of this ProxyModifyProduct.  # noqa: E501

         A descriptionof the product. **Character limit**: 500 **Values**: a string of 500 characters or fewer   # noqa: E501

        :return: The description of this ProxyModifyProduct.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this ProxyModifyProduct.

         A descriptionof the product. **Character limit**: 500 **Values**: a string of 500 characters or fewer   # noqa: E501

        :param description: The description of this ProxyModifyProduct.  # noqa: E501
        :type: str
        """
    ...
    def effective_end_date(self):
        """Gets the effective_end_date of this ProxyModifyProduct.  # noqa: E501

        The date when the product expires and can't be subscribed to anymore, in `yyyy-mm-dd` format.   # noqa: E501

        :return: The effective_end_date of this ProxyModifyProduct.  # noqa: E501
        :rtype: date
        """
    ...
    def effective_end_date(self, effective_end_date):
        """Sets the effective_end_date of this ProxyModifyProduct.

        The date when the product expires and can't be subscribed to anymore, in `yyyy-mm-dd` format.   # noqa: E501

        :param effective_end_date: The effective_end_date of this ProxyModifyProduct.  # noqa: E501
        :type: date
        """
    ...
    def effective_start_date(self):
        """Gets the effective_start_date of this ProxyModifyProduct.  # noqa: E501

        The date when the product becomes available and can be subscribed to, in `yyyy-mm-dd` format.   # noqa: E501

        :return: The effective_start_date of this ProxyModifyProduct.  # noqa: E501
        :rtype: date
        """
    ...
    def effective_start_date(self, effective_start_date):
        """Sets the effective_start_date of this ProxyModifyProduct.

        The date when the product becomes available and can be subscribed to, in `yyyy-mm-dd` format.   # noqa: E501

        :param effective_start_date: The effective_start_date of this ProxyModifyProduct.  # noqa: E501
        :type: date
        """
    ...
    @property
    def name(self):
        """Gets the name of this ProxyModifyProduct.  # noqa: E501
        ...
        :return: The name of this ProxyModifyProduct.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ProxyModifyProduct.

        The name of the product. This information is displayed in the product catalog pages in the web-based UI. **Character limit**: 100 **Values**: a string of 100 characters or fewer   # noqa: E501

        :param name: The name of this ProxyModifyProduct.  # noqa: E501
        :type: str
        """
    ...
    @property
    def sku(self):
        """Gets the sku of this ProxyModifyProduct.  # noqa: E501
        ...
        :return: The sku of this ProxyModifyProduct.  # noqa: E501
        :rtype: str
        """
        return self._sku
    ...
    @sku.setter
    def sku(self, sku):
        """Sets the sku of this ProxyModifyProduct.

        The unique SKU for the product. **Character limit**: 50 **Values**: one of the following:  - leave null for automatic generated - an alphanumeric string of 50 characters or fewer   # noqa: E501

        :param sku: The sku of this ProxyModifyProduct.  # noqa: E501
        :type: str
        """
    ...
    def integration_id__ns(self):
        """Gets the integration_id__ns of this ProxyModifyProduct.  # noqa: E501

        ID of the corresponding object in NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId=265).   # noqa: E501

        :return: The integration_id__ns of this ProxyModifyProduct.  # noqa: E501
        :rtype: str
        """
    ...
    def integration_id__ns(self, integration_id__ns):
        """Sets the integration_id__ns of this ProxyModifyProduct.

        ID of the corresponding object in NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId=265).   # noqa: E501

        :param integration_id__ns: The integration_id__ns of this ProxyModifyProduct.  # noqa: E501
        :type: str
        """
    ...
    def integration_status__ns(self):
        """Gets the integration_status__ns of this ProxyModifyProduct.  # noqa: E501
        ...
        :return: The integration_status__ns of this ProxyModifyProduct.  # noqa: E501
        :rtype: str
        """
    ...
    def integration_status__ns(self, integration_status__ns):
        """Sets the integration_status__ns of this ProxyModifyProduct.

        Status of the product's synchronization with NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId=265).   # noqa: E501

        :param integration_status__ns: The integration_status__ns of this ProxyModifyProduct.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def item_type__ns(self):
        """Gets the item_type__ns of this ProxyModifyProduct.  # noqa: E501
        ...
        :return: The item_type__ns of this ProxyModifyProduct.  # noqa: E501
        :rtype: str
        """
    ...
    def item_type__ns(self, item_type__ns):
        """Sets the item_type__ns of this ProxyModifyProduct.

        Type of item that is created in NetSuite for the product. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId=265).   # noqa: E501

        :param item_type__ns: The item_type__ns of this ProxyModifyProduct.  # noqa: E501
        :type: str
        """
    ...
    def sync_date__ns(self):
        """Gets the sync_date__ns of this ProxyModifyProduct.  # noqa: E501
        ...
        :return: The sync_date__ns of this ProxyModifyProduct.  # noqa: E501
        :rtype: str
        """
    ...
    def sync_date__ns(self, sync_date__ns):
        """Sets the sync_date__ns of this ProxyModifyProduct.

        Date when the product was synchronized with NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId=265).   # noqa: E501

        :param sync_date__ns: The sync_date__ns of this ProxyModifyProduct.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProxyModifyProduct):
            return False
