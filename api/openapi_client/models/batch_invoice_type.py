...
class BatchInvoiceType(object):
    ...
    openapi_types = {
        ...
        'id': 'str',
        'invoice_date': 'date',
        'invoice_items': 'list[PutInvoiceItemType]',
    ...
    def __init__(self, auto_pay=None, comments=None, due_date=None, id=None, invoice_date=None, invoice_items=None, transferred_to_accounting=None, integration_id__ns=None, integration_status__ns=None, sync_date__ns=None, local_vars_configuration=None):  # noqa: E501
        """BatchInvoiceType - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def auto_pay(self):
        """Gets the auto_pay of this BatchInvoiceType.  # noqa: E501
        ...
        :return: The auto_pay of this BatchInvoiceType.  # noqa: E501
        :rtype: bool
        """
    ...
    def auto_pay(self, auto_pay):
        """Sets the auto_pay of this BatchInvoiceType.

        Whether invoices are automatically picked up for processing in the corresponding payment run.  By default, invoices are automatically picked up for processing in the corresponding payment run.   # noqa: E501

        :param auto_pay: The auto_pay of this BatchInvoiceType.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def comments(self):
        """Gets the comments of this BatchInvoiceType.  # noqa: E501

        Additional information related to the invoice that a Zuora user added to the invoice.   # noqa: E501

        :return: The comments of this BatchInvoiceType.  # noqa: E501
        :rtype: str
        """
    ...
    def comments(self, comments):
        """Sets the comments of this BatchInvoiceType.

        Additional information related to the invoice that a Zuora user added to the invoice.   # noqa: E501

        :param comments: The comments of this BatchInvoiceType.  # noqa: E501
        :type: str
        """
    ...
    @property
    def due_date(self):
        """Gets the due_date of this BatchInvoiceType.  # noqa: E501

        The date by which the payment for this invoice is due.   # noqa: E501

        :return: The due_date of this BatchInvoiceType.  # noqa: E501
        :rtype: date
        """
    ...
    def due_date(self, due_date):
        """Sets the due_date of this BatchInvoiceType.

        The date by which the payment for this invoice is due.   # noqa: E501

        :param due_date: The due_date of this BatchInvoiceType.  # noqa: E501
        :type: date
        """
    ...
    @property
    def id(self):
        """Gets the id of this BatchInvoiceType.  # noqa: E501

        The ID of the invoice to be updated.   # noqa: E501

        :return: The id of this BatchInvoiceType.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this BatchInvoiceType.

        The ID of the invoice to be updated.   # noqa: E501

        :param id: The id of this BatchInvoiceType.  # noqa: E501
        :type: str
        """
    ...
    def invoice_date(self):
        """Gets the invoice_date of this BatchInvoiceType.  # noqa: E501
        ...
        :return: The invoice_date of this BatchInvoiceType.  # noqa: E501
        :rtype: date
        """
    ...
    def invoice_date(self, invoice_date):
        """Sets the invoice_date of this BatchInvoiceType.

        The new invoice date of the invoice. The new invoice date cannot fall in a closed accounting period.  You can only specify `invoiceDate` or `dueDate` in one request. Otherwise, an error occurs.   # noqa: E501

        :param invoice_date: The invoice_date of this BatchInvoiceType.  # noqa: E501
        :type: date
        """
    ...
    def invoice_items(self):
        """Gets the invoice_items of this BatchInvoiceType.  # noqa: E501

        Container for invoice items. The maximum number of items is 1,000.  **Note:** Invoice items can only be updated if you have Unified Invoicing is enabled and the invoice is a standalone invoice.   # noqa: E501

        :return: The invoice_items of this BatchInvoiceType.  # noqa: E501
        :rtype: list[PutInvoiceItemType]
        """
        return self._invoice_items

    @invoice_items.setter
    def invoice_items(self, invoice_items):
        """Sets the invoice_items of this BatchInvoiceType.

        Container for invoice items. The maximum number of items is 1,000.  **Note:** Invoice items can only be updated if you have Unified Invoicing is enabled and the invoice is a standalone invoice.   # noqa: E501

        :param invoice_items: The invoice_items of this BatchInvoiceType.  # noqa: E501
        :type: list[PutInvoiceItemType]
        """
    ...
    def transferred_to_accounting(self):
        """Gets the transferred_to_accounting of this BatchInvoiceType.  # noqa: E501

        Whether the invoice was transferred to an external accounting system.   # noqa: E501

        :return: The transferred_to_accounting of this BatchInvoiceType.  # noqa: E501
        :rtype: str
        """
    ...
    def transferred_to_accounting(self, transferred_to_accounting):
        """Sets the transferred_to_accounting of this BatchInvoiceType.

        Whether the invoice was transferred to an external accounting system.   # noqa: E501

        :param transferred_to_accounting: The transferred_to_accounting of this BatchInvoiceType.  # noqa: E501
        :type: str
        """
    ...
    def integration_id__ns(self):
        """Gets the integration_id__ns of this BatchInvoiceType.  # noqa: E501

        ID of the corresponding object in NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId=265).   # noqa: E501

        :return: The integration_id__ns of this BatchInvoiceType.  # noqa: E501
        :rtype: str
        """
    ...
    def integration_id__ns(self, integration_id__ns):
        """Sets the integration_id__ns of this BatchInvoiceType.

        ID of the corresponding object in NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId=265).   # noqa: E501

        :param integration_id__ns: The integration_id__ns of this BatchInvoiceType.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def integration_status__ns(self):
        """Gets the integration_status__ns of this BatchInvoiceType.  # noqa: E501
        ...
        :return: The integration_status__ns of this BatchInvoiceType.  # noqa: E501
        :rtype: str
        """
    ...
    def integration_status__ns(self, integration_status__ns):
        """Sets the integration_status__ns of this BatchInvoiceType.

        Status of the invoice's synchronization with NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId=265).   # noqa: E501

        :param integration_status__ns: The integration_status__ns of this BatchInvoiceType.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def sync_date__ns(self):
        """Gets the sync_date__ns of this BatchInvoiceType.  # noqa: E501
        ...
        :return: The sync_date__ns of this BatchInvoiceType.  # noqa: E501
        :rtype: str
        """
    ...
    def sync_date__ns(self, sync_date__ns):
        """Sets the sync_date__ns of this BatchInvoiceType.

        Date when the invoice was synchronized with NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId=265).   # noqa: E501

        :param sync_date__ns: The sync_date__ns of this BatchInvoiceType.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchInvoiceType):
            return False
