...
class GETOpenPaymentMethodTypeRevisionResponse(object):
    ...
    def __init__(self, entity_id=None, fields=None, internal_name=None, label=None, method_reference_id_field=None, revision=None, status=None, sub_type_field=None, tenant_id=None, user_reference_id_field=None, version=None, local_vars_configuration=None):  # noqa: E501
        """GETOpenPaymentMethodTypeRevisionResponse - a model defined in OpenAPI"""  # noqa: E501
    ...
    def method_reference_id_field(self):
        ...
        A field available in the Payment Method data source export and Data Query for filtering data.   # noqa: E501
