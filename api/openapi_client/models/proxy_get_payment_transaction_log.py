...
class ProxyGetPaymentTransactionLog(object):
    ...
    def __init__(self, avs_response_code=None, batch_id=None, cvv_response_code=None, gateway=None, gateway_reason_code=None, gateway_reason_code_description=None, gateway_state=None, gateway_transaction_type=None, id=None, payment_id=None, request_string=None, response_string=None, transaction_date=None, transaction_id=None, local_vars_configuration=None):  # noqa: E501
        """ProxyGetPaymentTransactionLog - a model defined in OpenAPI"""  # noqa: E501
    ...
    def gateway_transaction_type(self, gateway_transaction_type):
        ...
        if self.local_vars_configuration.client_side_validation and gateway_transaction_type not in allowed_values:  # noqa: E501
            raise ValueError(
