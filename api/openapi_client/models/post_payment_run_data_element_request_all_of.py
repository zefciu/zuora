...
class POSTPaymentRunDataElementRequestAllOf(object):
    ...
    def __init__(self, account_id=None, account_number=None, amount=None, comment=None, currency=None, document_id=None, document_type=None, payment_gateway_id=None, payment_method_id=None, standalone=False, local_vars_configuration=None):  # noqa: E501
        """POSTPaymentRunDataElementRequestAllOf - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def account_id(self):
        """Gets the account_id of this POSTPaymentRunDataElementRequestAllOf.  # noqa: E501

        A valid account ID associated with the payment run.  If `consolidatedPayment` is set to `true`, this field is used in processing a single payment for invoices/debit memos due on an account.   # noqa: E501

        :return: The account_id of this POSTPaymentRunDataElementRequestAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def account_id(self, account_id):
        """Sets the account_id of this POSTPaymentRunDataElementRequestAllOf.

        A valid account ID associated with the payment run.  If `consolidatedPayment` is set to `true`, this field is used in processing a single payment for invoices/debit memos due on an account.   # noqa: E501

        :param account_id: The account_id of this POSTPaymentRunDataElementRequestAllOf.  # noqa: E501
        :type: str
        """
    ...
    def account_number(self):
        """Gets the account_number of this POSTPaymentRunDataElementRequestAllOf.  # noqa: E501

        The number of the customer account associated with the payment run, such as `A00000001`.  You can specify either `accountNumber` or `accountId` for a customer account, but not both of them.  If `consolidatedPayment` is set to `true`, this field is used in processing a single payment for invoices, debit memos, and standalone payments due on an account.   # noqa: E501

        :return: The account_number of this POSTPaymentRunDataElementRequestAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def account_number(self, account_number):
        """Sets the account_number of this POSTPaymentRunDataElementRequestAllOf.

        The number of the customer account associated with the payment run, such as `A00000001`.  You can specify either `accountNumber` or `accountId` for a customer account, but not both of them.  If `consolidatedPayment` is set to `true`, this field is used in processing a single payment for invoices, debit memos, and standalone payments due on an account.   # noqa: E501

        :param account_number: The account_number of this POSTPaymentRunDataElementRequestAllOf.  # noqa: E501
        :type: str
        """
    ...
    @property
    def amount(self):
        """Gets the amount of this POSTPaymentRunDataElementRequestAllOf.  # noqa: E501

        The amount to be collected for the specified invoice/debit memo. `amount` must be a positive numeric value no more than the balance of the specified invoice/debit memo.  This field is only available when `documentId` is specified. If `amount` is not specified, whole balance of the invoice/debit memo is collected.   # noqa: E501

        :return: The amount of this POSTPaymentRunDataElementRequestAllOf.  # noqa: E501
        :rtype: float
        """
        return self._amount
    ...
    def amount(self, amount):
        """Sets the amount of this POSTPaymentRunDataElementRequestAllOf.

        The amount to be collected for the specified invoice/debit memo. `amount` must be a positive numeric value no more than the balance of the specified invoice/debit memo.  This field is only available when `documentId` is specified. If `amount` is not specified, whole balance of the invoice/debit memo is collected.   # noqa: E501

        :param amount: The amount of this POSTPaymentRunDataElementRequestAllOf.  # noqa: E501
        :type: float
        """
    ...
    @property
    def comment(self):
        """Gets the comment of this POSTPaymentRunDataElementRequestAllOf.  # noqa: E501

        Additional comments.   # noqa: E501

        :return: The comment of this POSTPaymentRunDataElementRequestAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def comment(self, comment):
        """Sets the comment of this POSTPaymentRunDataElementRequestAllOf.

        Additional comments.   # noqa: E501

        :param comment: The comment of this POSTPaymentRunDataElementRequestAllOf.  # noqa: E501
        :type: str
        """
    ...
    @property
    def currency(self):
        """Gets the currency of this POSTPaymentRunDataElementRequestAllOf.  # noqa: E501

        Note: This field is only available if support for standalone payments is enabled.  The currency of the standalone payment. Specify this field only if the `standalone` field is `true`. The currency of the standalone payment can be different from the payment currency defined in the customer account settings.   # noqa: E501

        :return: The currency of this POSTPaymentRunDataElementRequestAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def currency(self, currency):
        """Sets the currency of this POSTPaymentRunDataElementRequestAllOf.

        Note: This field is only available if support for standalone payments is enabled.  The currency of the standalone payment. Specify this field only if the `standalone` field is `true`. The currency of the standalone payment can be different from the payment currency defined in the customer account settings.   # noqa: E501

        :param currency: The currency of this POSTPaymentRunDataElementRequestAllOf.  # noqa: E501
        :type: str
        """
    ...
    def document_id(self):
        """Gets the document_id of this POSTPaymentRunDataElementRequestAllOf.  # noqa: E501

        The ID of a billing document associated with the payment run. `documentId` must be valid and match with `documentType`.  You must either specify both `documentId` and `documentType`, or specify neither of them.  If neither of `documentType` and `documentId` is specified, all invoices/debit memos with open balance of the account are collected.   # noqa: E501

        :return: The document_id of this POSTPaymentRunDataElementRequestAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def document_id(self, document_id):
        """Sets the document_id of this POSTPaymentRunDataElementRequestAllOf.

        The ID of a billing document associated with the payment run. `documentId` must be valid and match with `documentType`.  You must either specify both `documentId` and `documentType`, or specify neither of them.  If neither of `documentType` and `documentId` is specified, all invoices/debit memos with open balance of the account are collected.   # noqa: E501

        :param document_id: The document_id of this POSTPaymentRunDataElementRequestAllOf.  # noqa: E501
        :type: str
        """
    ...
    def document_type(self):
        """Gets the document_type of this POSTPaymentRunDataElementRequestAllOf.  # noqa: E501

        The type of a billing document associated with the payment run. The value can be `Invoice` or `DebitMemo`, but `DebitMemo` is only supported if the Invoice Settlement feature is enabled.  You must either specify both `documentType` and `documentId`, or specify neither of them.  If neither of `documentType` and `documentId` is specified, all invoices/debit memos with open balance of the account are collected.   # noqa: E501

        :return: The document_type of this POSTPaymentRunDataElementRequestAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def document_type(self, document_type):
        """Sets the document_type of this POSTPaymentRunDataElementRequestAllOf.

        The type of a billing document associated with the payment run. The value can be `Invoice` or `DebitMemo`, but `DebitMemo` is only supported if the Invoice Settlement feature is enabled.  You must either specify both `documentType` and `documentId`, or specify neither of them.  If neither of `documentType` and `documentId` is specified, all invoices/debit memos with open balance of the account are collected.   # noqa: E501

        :param document_type: The document_type of this POSTPaymentRunDataElementRequestAllOf.  # noqa: E501
        :type: str
        """
    ...
    def payment_gateway_id(self):
        """Gets the payment_gateway_id of this POSTPaymentRunDataElementRequestAllOf.  # noqa: E501

        The ID of the payment gateway for collecting invoices/debit memos. The specified payment gateway must be valid and active. If it is not specified, the default payment gateway of the account is used. If no payment gateway is configured for the account, the default payment gateway of the tenant is used.  If `consolidatedPayment` is set to `true`, this field is used in processing a single payment for invoices/debit memos due on an account.   # noqa: E501

        :return: The payment_gateway_id of this POSTPaymentRunDataElementRequestAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def payment_gateway_id(self, payment_gateway_id):
        """Sets the payment_gateway_id of this POSTPaymentRunDataElementRequestAllOf.

        The ID of the payment gateway for collecting invoices/debit memos. The specified payment gateway must be valid and active. If it is not specified, the default payment gateway of the account is used. If no payment gateway is configured for the account, the default payment gateway of the tenant is used.  If `consolidatedPayment` is set to `true`, this field is used in processing a single payment for invoices/debit memos due on an account.   # noqa: E501

        :param payment_gateway_id: The payment_gateway_id of this POSTPaymentRunDataElementRequestAllOf.  # noqa: E501
        :type: str
        """
    ...
    def payment_method_id(self, payment_method_id):
        """Sets the payment_method_id of this POSTPaymentRunDataElementRequestAllOf.

        The ID of the payment method for collecting invoices/debit memos. The specified payment method must be a valid non-system payment method. If it is not specified, the default payment method of the account is used regardless of the `autoPay` value of the account.  If `processPaymentWithClosedPM` is set to `false`, the payment method cannot be closed.  If the payment retry rules are enabled, the payment method must meet the rules.  If `consolidatedPayment` is set to `true`, this field is used in processing a single payment for invoices/debit memos due on an account.   # noqa: E501

        :param payment_method_id: The payment_method_id of this POSTPaymentRunDataElementRequestAllOf.  # noqa: E501
        :type: str
        """
    ...
    @property
    def standalone(self):
        """Gets the standalone of this POSTPaymentRunDataElementRequestAllOf.  # noqa: E501
        ...
        :return: The standalone of this POSTPaymentRunDataElementRequestAllOf.  # noqa: E501
        :rtype: bool
        """
    ...
    def standalone(self, standalone):
        """Sets the standalone of this POSTPaymentRunDataElementRequestAllOf.

        Note: This field is only available if support for standalone payments is enabled.  Specify `true` to indicate that this is a standalone payment that will be created and processed in Zuora through Zuora gateway integration but will be settled outside of Zuora. When `standalone` is set to `true`:   - `accountId` or `accountNumber` is required.   - `amount` is required.    - The amount will not be summed up into the account balance and key metrics regardless of the payment currency.   - No settlement data will be created.   - Either the applied amount or the unapplied amount of the payment is zero.   - The standalone payment cannot be applied, unapplied, or transferred.   # noqa: E501

        :param standalone: The standalone of this POSTPaymentRunDataElementRequestAllOf.  # noqa: E501
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, POSTPaymentRunDataElementRequestAllOf):
            return False
