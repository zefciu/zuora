...
class ProxyCreateProductRatePlan(object):
    ...
    def __init__(self, active_currencies=None, description=None, effective_end_date=None, effective_start_date=None, name=None, product_id=None, billing_period__ns=None, class__ns=None, department__ns=None, include_children__ns=None, integration_id__ns=None, integration_status__ns=None, item_type__ns=None, location__ns=None, multi_currency_price__ns=None, price__ns=None, subsidiary__ns=None, sync_date__ns=None, local_vars_configuration=None):  # noqa: E501
        """ProxyCreateProductRatePlan - a model defined in OpenAPI"""  # noqa: E501
    ...
    def active_currencies(self):
        """Gets the active_currencies of this ProxyCreateProductRatePlan.  # noqa: E501

        A list of 3-letter currency codes representing active currencies for the product rate plan. Use a comma to separate each currency code.  When creating a product rate plan, you can use this field to specify at most four active currencies.    # noqa: E501

        :return: The active_currencies of this ProxyCreateProductRatePlan.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def active_currencies(self, active_currencies):
        """Sets the active_currencies of this ProxyCreateProductRatePlan.

        A list of 3-letter currency codes representing active currencies for the product rate plan. Use a comma to separate each currency code.  When creating a product rate plan, you can use this field to specify at most four active currencies.    # noqa: E501

        :param active_currencies: The active_currencies of this ProxyCreateProductRatePlan.  # noqa: E501
        :type: list[str]
        """
