...
class POSTBillingPreviewInvoiceItem(object):
    ...
    def tax_amount(self):
        ...
        Tax applied to the charge. This field returns `0` becasue the BillingPreview operation does not calculate taxes for charges in the subscription.   # noqa: E501
