...
class ProxyCreateExport(object):
    ...
    def __init__(self, convert_to_currencies=None, encrypted=None, file_id=None, format=None, name=None, query=None, size=None, status=None, status_reason=None, zip=None, local_vars_configuration=None):  # noqa: E501
        """ProxyCreateExport - a model defined in OpenAPI"""  # noqa: E501
