...
class GetWorkflowSetupResponse(object):
    ...
    def __init__(self, callout_trigger=None, created_at=None, description=None, id=None, interval=None, name=None, ondemand_trigger=None, priority=None, scheduled_trigger=None, status=None, timezone=None, updated_at=None, local_vars_configuration=None):  # noqa: E501
        """GetWorkflowSetupResponse - a model defined in OpenAPI"""  # noqa: E501
