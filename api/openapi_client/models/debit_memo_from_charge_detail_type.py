...
class DebitMemoFromChargeDetailType(object):
    ...
    def __init__(self, amount=None, charge_id=None, comment=None, description=None, finance_information=None, memo_item_amount=None, product_rate_plan_charge_id=None, quantity=None, service_end_date=None, service_start_date=None, local_vars_configuration=None):  # noqa: E501
        """DebitMemoFromChargeDetailType - a model defined in OpenAPI"""  # noqa: E501
    ...
    def description(self):
        """Gets the description of this DebitMemoFromChargeDetailType.  # noqa: E501
        ...
        :return: The description of this DebitMemoFromChargeDetailType.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this DebitMemoFromChargeDetailType.

        The description of the product rate plan charge.  **Note**: This field is only available if you set the `zuora-version` request header to `257.0` or later.   # noqa: E501

        :param description: The description of this DebitMemoFromChargeDetailType.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def product_rate_plan_charge_id(self):
        """Gets the product_rate_plan_charge_id of this DebitMemoFromChargeDetailType.  # noqa: E501
        ...
        :return: The product_rate_plan_charge_id of this DebitMemoFromChargeDetailType.  # noqa: E501
        :rtype: str
        """
    ...
    def product_rate_plan_charge_id(self, product_rate_plan_charge_id):
        """Sets the product_rate_plan_charge_id of this DebitMemoFromChargeDetailType.

        The ID of the product rate plan charge that the debit memo is created from.  **Note**: This field is only available if you set the `zuora-version` request header to `257.0` or later.   # noqa: E501

        :param product_rate_plan_charge_id: The product_rate_plan_charge_id of this DebitMemoFromChargeDetailType.  # noqa: E501
        :type: str
        """
    ...
    @property
    def quantity(self):
        """Gets the quantity of this DebitMemoFromChargeDetailType.  # noqa: E501

        The number of units for the debit memo item.   # noqa: E501

        :return: The quantity of this DebitMemoFromChargeDetailType.  # noqa: E501
        :rtype: float
        """
    ...
    def quantity(self, quantity):
        """Sets the quantity of this DebitMemoFromChargeDetailType.

        The number of units for the debit memo item.   # noqa: E501

        :param quantity: The quantity of this DebitMemoFromChargeDetailType.  # noqa: E501
        :type: float
        """
