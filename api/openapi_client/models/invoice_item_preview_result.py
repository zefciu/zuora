...
class InvoiceItemPreviewResult(object):
    ...
    def processing_type(self, processing_type):
        ...
        if self.local_vars_configuration.client_side_validation and processing_type not in allowed_values:  # noqa: E501
            raise ValueError(
