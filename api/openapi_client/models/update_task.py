...
class UpdateTask(object):
    ...
    def __init__(self, action_type=None, call_type=None, concurrent_limit=None, id=None, name=None, object=None, object_id=None, status=None, tags=None, workflow_id=None, local_vars_configuration=None):  # noqa: E501
        """UpdateTask - a model defined in OpenAPI"""  # noqa: E501
    ...
    def concurrent_limit(self, concurrent_limit):
        ...
        if (self.local_vars_configuration.client_side_validation and
                concurrent_limit is not None and concurrent_limit > 9999999):  # noqa: E501
            raise ValueError("Invalid value for `concurrent_limit`, must be a value less than or equal to `9999999`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                concurrent_limit is not None and concurrent_limit < 1):  # noqa: E501
            raise ValueError("Invalid value for `concurrent_limit`, must be a value greater than or equal to `1`")  # noqa: E501
