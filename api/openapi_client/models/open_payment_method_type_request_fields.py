...
class OpenPaymentMethodTypeRequestFields(object):
    ...
    def __init__(self, checksum=None, default_value=None, description=None, editable=None, index=None, label=None, max_length=None, min_length=None, name=None, representer=None, required=None, type=None, visible=None, local_vars_configuration=None):  # noqa: E501
        """OpenPaymentMethodTypeRequestFields - a model defined in OpenAPI"""  # noqa: E501
    ...
    def description(self, description):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                description is not None and len(description) > 70):
            raise ValueError("Invalid value for `description`, length must be less than or equal to `70`")  # noqa: E501
    ...
    def label(self, label):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                label is not None and len(label) > 30):
            raise ValueError("Invalid value for `label`, length must be less than or equal to `30`")  # noqa: E501
