...
class TimeSlicedElpNetMetrics(object):
    ...
    def __init__(self, amount=None, end_date=None, generated_reason=None, invoice_owner=None, order_item_id=None, start_date=None, subscription_owner=None, tax=None, term_number=None, type=None, local_vars_configuration=None):  # noqa: E501
        """TimeSlicedElpNetMetrics - a model defined in OpenAPI"""  # noqa: E501
