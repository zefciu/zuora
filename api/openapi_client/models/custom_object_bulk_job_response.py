...
class CustomObjectBulkJobResponse(object):
    ...
    def __init__(self, created_by_id=None, created_date=None, id=None, updated_by_id=None, updated_date=None, error=None, namespace=None, object=None, operation=None, processing_time=None, records_processed=None, status=None, local_vars_configuration=None):  # noqa: E501
        """CustomObjectBulkJobResponse - a model defined in OpenAPI"""  # noqa: E501
    ...
    def namespace(self, namespace):
        ...
        if self.local_vars_configuration.client_side_validation and namespace not in allowed_values:  # noqa: E501
            raise ValueError(
