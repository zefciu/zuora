...
class ProxyGetInvoiceItemAdjustment(object):
    ...
    def deferred_revenue_account(self):
        """Gets the deferred_revenue_account of this ProxyGetInvoiceItemAdjustment.  # noqa: E501
        ...
        :return: The deferred_revenue_account of this ProxyGetInvoiceItemAdjustment.  # noqa: E501
        :rtype: str
        """
    ...
    def deferred_revenue_account(self, deferred_revenue_account):
        """Sets the deferred_revenue_account of this ProxyGetInvoiceItemAdjustment.

         Records the deferred accounting code in the finance system. This field is in Limited Availability. If you want to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/). **Character limit**: 100  **Version notes**: WSDL 63.0+  **Values**: If this field is not passed in, a value from InvoiceItem will be used.  # noqa: E501

        :param deferred_revenue_account: The deferred_revenue_account of this ProxyGetInvoiceItemAdjustment.  # noqa: E501
        :type: str
        """
    ...
    def recognized_revenue_account(self):
        """Gets the recognized_revenue_account of this ProxyGetInvoiceItemAdjustment.  # noqa: E501

         Records the recognized accounting code in the finance system. This field is in Limited Availability. If you want to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/). **Character limit**: 100  **Version notes**: WSDL 63.0+  **Values**: If this field is not passed in, a value from InvoiceItem will be used.  # noqa: E501

        :return: The recognized_revenue_account of this ProxyGetInvoiceItemAdjustment.  # noqa: E501
        :rtype: str
        """
    ...
    def recognized_revenue_account(self, recognized_revenue_account):
        """Sets the recognized_revenue_account of this ProxyGetInvoiceItemAdjustment.

         Records the recognized accounting code in the finance system. This field is in Limited Availability. If you want to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/). **Character limit**: 100  **Version notes**: WSDL 63.0+  **Values**: If this field is not passed in, a value from InvoiceItem will be used.  # noqa: E501

        :param recognized_revenue_account: The recognized_revenue_account of this ProxyGetInvoiceItemAdjustment.  # noqa: E501
        :type: str
        """
    ...
    @property
    def type(self):
        """Gets the type of this ProxyGetInvoiceItemAdjustment.  # noqa: E501

        Indicates whether the adjustment credits or debits the invoice item amount.  # noqa: E501

        :return: The type of this ProxyGetInvoiceItemAdjustment.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this ProxyGetInvoiceItemAdjustment.

        Indicates whether the adjustment credits or debits the invoice item amount.  # noqa: E501

        :param type: The type of this ProxyGetInvoiceItemAdjustment.  # noqa: E501
        :type: str
        """
