...
class ProxyGetPaymentMethodSnapshot(object):
    ...
    def ach_account_type(self, ach_account_type):
        ...
        if self.local_vars_configuration.client_side_validation and ach_account_type not in allowed_values:  # noqa: E501
            raise ValueError(
    ...
    def bank_transfer_type(self, bank_transfer_type):
        ...
        if self.local_vars_configuration.client_side_validation and bank_transfer_type not in allowed_values:  # noqa: E501
            raise ValueError(
    ...
    def credit_card_type(self, credit_card_type):
        ...
        if self.local_vars_configuration.client_side_validation and credit_card_type not in allowed_values:  # noqa: E501
            raise ValueError(
    ...
    def existing_mandate(self, existing_mandate):
        ...
        if self.local_vars_configuration.client_side_validation and existing_mandate not in allowed_values:  # noqa: E501
            raise ValueError(
    ...
    def payment_method_status(self, payment_method_status):
        ...
        if self.local_vars_configuration.client_side_validation and payment_method_status not in allowed_values:  # noqa: E501
            raise ValueError(
    ...
    def paypal_type(self, paypal_type):
        ...
        if self.local_vars_configuration.client_side_validation and paypal_type not in allowed_values:  # noqa: E501
            raise ValueError(
