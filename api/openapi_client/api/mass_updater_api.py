...
class MassUpdaterApi(object):
    ...
    def g_et_mass_updater_with_http_info(self, bulk_key, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(GETMassUpdateType, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('bulk_key' not in local_var_params or  # noqa: E501
                                                        local_var_params['bulk_key'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `bulk_key` when calling `g_et_mass_updater`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_mass_updater`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}

        path_params = {}
        if 'bulk_key' in local_var_params:
            path_params['bulk-key'] = local_var_params['bulk_key']  # noqa: E501
    ...
    def p_ost_mass_updater_with_http_info(self, file, params, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(POSTMassUpdateResponseType, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('file' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `file` when calling `p_ost_mass_updater`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('params' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `params` when calling `p_ost_mass_updater`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `p_ost_mass_updater`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ut_mass_updater_with_http_info(self, bulk_key, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('bulk_key' not in local_var_params or  # noqa: E501
                                                        local_var_params['bulk_key'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `bulk_key` when calling `p_ut_mass_updater`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `p_ut_mass_updater`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
