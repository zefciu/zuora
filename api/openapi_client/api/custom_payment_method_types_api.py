...
class CustomPaymentMethodTypesApi(object):
    ...
    def g_et_open_payment_method_type_publish_with_http_info(self, payment_method_type_name, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(GETOpenPaymentMethodTypeRevisionResponse, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('payment_method_type_name' not in local_var_params or  # noqa: E501
                                                        local_var_params['payment_method_type_name'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `payment_method_type_name` when calling `g_et_open_payment_method_type_publish`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_open_payment_method_type_publish`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}

        path_params = {}
        if 'payment_method_type_name' in local_var_params:
            path_params['paymentMethodTypeName'] = local_var_params['payment_method_type_name']  # noqa: E501
    ...
    def g_et_open_payment_method_type_revision_with_http_info(self, payment_method_type_name, revision_number, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('payment_method_type_name' not in local_var_params or  # noqa: E501
                                                        local_var_params['payment_method_type_name'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `payment_method_type_name` when calling `g_et_open_payment_method_type_revision`")  # noqa: E501
        # verify the required parameter 'revision_number' is set
        if self.api_client.client_side_validation and ('revision_number' not in local_var_params or  # noqa: E501
                                                        local_var_params['revision_number'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `revision_number` when calling `g_et_open_payment_method_type_revision`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_open_payment_method_type_revision`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ost_create_draft_open_payment_method_type(self, request, **kwargs):  # noqa: E501
        """Create a draft custom payment method type  # noqa: E501

        Creates a draft version of a custom payment method type.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_create_draft_open_payment_method_type(request, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param POSTCreateOpenPaymentMethodTypeRequest request: (required)
        :param str zuora_track_id: A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`\"`), and quote (`'`). 
        :param str zuora_entity_ids: An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.p_ost_create_draft_open_payment_method_type_with_http_info(request, **kwargs)  # noqa: E501

    def p_ost_create_draft_open_payment_method_type_with_http_info(self, request, **kwargs):  # noqa: E501
        """Create a draft custom payment method type  # noqa: E501

        Creates a draft version of a custom payment method type.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_create_draft_open_payment_method_type_with_http_info(request, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(POSTCreateOpenPaymentMethodTypeResponse, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('request' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `request` when calling `p_ost_create_draft_open_payment_method_type`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `p_ost_create_draft_open_payment_method_type`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ut_publish_open_payment_method_type_with_http_info(self, payment_method_type_name, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(PUTPublishOpenPaymentMethodTypeResponse, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('payment_method_type_name' not in local_var_params or  # noqa: E501
                                                        local_var_params['payment_method_type_name'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `payment_method_type_name` when calling `p_ut_publish_open_payment_method_type`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `p_ut_publish_open_payment_method_type`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ut_update_open_payment_method_type(self, payment_method_type_name, body, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ut_update_open_payment_method_type(payment_method_type_name, body, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.p_ut_update_open_payment_method_type_with_http_info(payment_method_type_name, body, **kwargs)  # noqa: E501

    def p_ut_update_open_payment_method_type_with_http_info(self, payment_method_type_name, body, **kwargs):  # noqa: E501
        """Update a custom payment method type  # noqa: E501

        Update the latest draft version of your custom payment method type.   **Note:** In the request body, you need to provide all the fields that define this custom payment method type including fields to be updated and the unchanged fields.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ut_update_open_payment_method_type_with_http_info(payment_method_type_name, body, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(PUTUpdateOpenPaymentMethodTypeResponse, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('payment_method_type_name' not in local_var_params or  # noqa: E501
                                                        local_var_params['payment_method_type_name'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `payment_method_type_name` when calling `p_ut_update_open_payment_method_type`")  # noqa: E501
        # verify the required parameter 'body' is set
        if self.api_client.client_side_validation and ('body' not in local_var_params or  # noqa: E501
                                                        local_var_params['body'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `body` when calling `p_ut_update_open_payment_method_type`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `p_ut_update_open_payment_method_type`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
