...
class DocumentPropertiesApi(object):
    ...
    def d_elete_document_properties_with_http_info(self, document_properties_id, **kwargs):  # noqa: E501
        ...
        **Note:** This feature is available only if you have the Billing Document Properties Setup feature enabled. The Billing Document Properties Setup feature is in **Limited Availability**. If you wish to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/).  Deletes document properties with a specific ID for a billing document. Billing documents include invoices, credit memos, and debit memos.  **Note:** You can delete document properties for credit and debit memos only if you have the Invoice Settlement feature enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you want to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information.   # noqa: E501
        ...
        if self.api_client.client_side_validation and ('document_properties_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['document_properties_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `document_properties_id` when calling `d_elete_document_properties`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `d_elete_document_properties`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}

        path_params = {}
        if 'document_properties_id' in local_var_params:
            path_params['documentPropertiesId'] = local_var_params['document_properties_id']  # noqa: E501
    ...
    def g_et_document_properies_with_http_info(self, document_type, document_id, **kwargs):  # noqa: E501
        ...
        **Note:** This feature is available only if you have the Billing Document Properties Setup feature enabled. The Billing Document Properties Setup feature is in **Limited Availability**. If you wish to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/).   Retrieve information about document properties of a billing document. Billing documents include invoices, credit memos, and debit memos.    **Note:** You can retrieve information about document properties of credit and debit memos only if you have the Invoice Settlement feature enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you want to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information.   # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(GETDocumentPropertiesResponseType, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('document_type' not in local_var_params or  # noqa: E501
                                                        local_var_params['document_type'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `document_type` when calling `g_et_document_properies`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('document_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `document_id` when calling `g_et_document_properies`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_document_properies`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}

        path_params = {}
        if 'document_type' in local_var_params:
            path_params['documentType'] = local_var_params['document_type']  # noqa: E501
    ...
    def p_ost_document_properties_with_http_info(self, request, **kwargs):  # noqa: E501
        ...
        **Note:** This feature is available only if you have the Billing Document Properties Setup feature enabled. The Billing Document Properties Setup feature is in **Limited Availability**. If you wish to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/).  Creates custom document properties for a billing document. For example, a document property can be a custom name used for files generated for billing documents. Billing documents include invoices, credit memos, and debit memos.  If you want to configure custom file names for billing documents created through API operations, you have to call this operation before posting the billing documents.   **Note:** You can create document properties for credit and debit memos only if you have the Invoice Settlement feature enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you want to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information.   # noqa: E501
        ...
        if self.api_client.client_side_validation and ('request' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `request` when calling `p_ost_document_properties`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `p_ost_document_properties`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ut_document_properties(self, document_properties_id, request, **kwargs):  # noqa: E501
        ...
        **Note:** This feature is available only if you have the Billing Document Properties Setup feature enabled. The Billing Document Properties Setup feature is in **Limited Availability**. If you wish to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/).  Updates document properties with a specific ID for a billing document. Billing documents include invoices, credit memos, and debit memos.  **Note:** You can update document properties for credit and debit memos only if you have the Invoice Settlement feature enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you want to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ut_document_properties(document_properties_id, request, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.p_ut_document_properties_with_http_info(document_properties_id, request, **kwargs)  # noqa: E501

    def p_ut_document_properties_with_http_info(self, document_properties_id, request, **kwargs):  # noqa: E501
        """Update document properties  # noqa: E501

        **Note:** This feature is available only if you have the Billing Document Properties Setup feature enabled. The Billing Document Properties Setup feature is in **Limited Availability**. If you wish to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/).  Updates document properties with a specific ID for a billing document. Billing documents include invoices, credit memos, and debit memos.  **Note:** You can update document properties for credit and debit memos only if you have the Invoice Settlement feature enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you want to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ut_document_properties_with_http_info(document_properties_id, request, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('document_properties_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['document_properties_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `document_properties_id` when calling `p_ut_document_properties`")  # noqa: E501
        # verify the required parameter 'request' is set
        if self.api_client.client_side_validation and ('request' not in local_var_params or  # noqa: E501
                                                        local_var_params['request'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `request` when calling `p_ut_document_properties`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `p_ut_document_properties`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
