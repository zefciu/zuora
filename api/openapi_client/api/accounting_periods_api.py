...
class AccountingPeriodsApi(object):
    ...
    def d_elete_accounting_period_with_http_info(self, ap_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('ap_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['ap_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `ap_id` when calling `d_elete_accounting_period`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `d_elete_accounting_period`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}

        path_params = {}
        if 'ap_id' in local_var_params:
            path_params['ap-id'] = local_var_params['ap_id']  # noqa: E501
    ...
    def g_et_accounting_period_with_http_info(self, ap_id, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(GETAccountingPeriodType, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('ap_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['ap_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `ap_id` when calling `g_et_accounting_period`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_accounting_period`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def g_et_all_accounting_periods_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(GETAccountingPeriodsType, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_all_accounting_periods`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and 'page_size' in local_var_params and local_var_params['page_size'] > 300:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `page_size` when calling `g_et_all_accounting_periods`, must be a value less than or equal to `300`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ost_accounting_period(self, request, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param POSTAccountingPeriodType request: (required)
        :param str zuora_track_id: A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`\"`), and quote (`'`). 
        :param str zuora_entity_ids: An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
    ...
    def p_ost_accounting_period_with_http_info(self, request, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(POSTAccountingPeriodResponseType, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('request' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `request` when calling `p_ost_accounting_period`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `p_ost_accounting_period`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ut_close_accounting_period_with_http_info(self, ap_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('ap_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['ap_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `ap_id` when calling `p_ut_close_accounting_period`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `p_ut_close_accounting_period`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ut_pending_close_accounting_period_with_http_info(self, ap_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('ap_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['ap_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `ap_id` when calling `p_ut_pending_close_accounting_period`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `p_ut_pending_close_accounting_period`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ut_reopen_accounting_period_with_http_info(self, ap_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('ap_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['ap_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `ap_id` when calling `p_ut_reopen_accounting_period`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `p_ut_reopen_accounting_period`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ut_run_trial_balance_with_http_info(self, ap_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('ap_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['ap_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `ap_id` when calling `p_ut_run_trial_balance`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `p_ut_run_trial_balance`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ut_update_accounting_period(self, ap_id, request, **kwargs):  # noqa: E501
        ...
        :param PUTAccountingPeriodType request: (required)
        :param str zuora_track_id: A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`\"`), and quote (`'`). 
        :param str zuora_entity_ids: An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
    ...
    def p_ut_update_accounting_period_with_http_info(self, ap_id, request, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('ap_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['ap_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `ap_id` when calling `p_ut_update_accounting_period`")  # noqa: E501
        # verify the required parameter 'request' is set
        if self.api_client.client_side_validation and ('request' not in local_var_params or  # noqa: E501
                                                        local_var_params['request'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `request` when calling `p_ut_update_accounting_period`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `p_ut_update_accounting_period`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
