...
class RevenueItemsApi(object):
    ...
    def g_et_revenue_items_by_charge_revenue_event_number_with_http_info(self, event_number, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(GETRevenueItemsType, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('event_number' not in local_var_params or  # noqa: E501
                                                        local_var_params['event_number'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `event_number` when calling `g_et_revenue_items_by_charge_revenue_event_number`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_revenue_items_by_charge_revenue_event_number`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and 'page_size' in local_var_params and local_var_params['page_size'] > 300:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `page_size` when calling `g_et_revenue_items_by_charge_revenue_event_number`, must be a value less than or equal to `300`")  # noqa: E501
        collection_formats = {}

        path_params = {}
        if 'event_number' in local_var_params:
            path_params['event-number'] = local_var_params['event_number']  # noqa: E501
    ...
    def g_et_revenue_items_by_charge_revenue_summary_number_with_http_info(self, crs_number, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('crs_number' not in local_var_params or  # noqa: E501
                                                        local_var_params['crs_number'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `crs_number` when calling `g_et_revenue_items_by_charge_revenue_summary_number`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_revenue_items_by_charge_revenue_summary_number`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and 'page_size' in local_var_params and local_var_params['page_size'] > 300:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `page_size` when calling `g_et_revenue_items_by_charge_revenue_summary_number`, must be a value less than or equal to `300`")  # noqa: E501
        collection_formats = {}

        path_params = {}
        if 'crs_number' in local_var_params:
            path_params['crs-number'] = local_var_params['crs_number']  # noqa: E501
    ...
    def g_et_revenue_items_by_revenue_schedule_with_http_info(self, rs_number, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(GETRsRevenueItemsType, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('rs_number' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `rs_number` when calling `g_et_revenue_items_by_revenue_schedule`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_revenue_items_by_revenue_schedule`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and 'page_size' in local_var_params and local_var_params['page_size'] > 300:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `page_size` when calling `g_et_revenue_items_by_revenue_schedule`, must be a value less than or equal to `300`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ut_custom_fieldson_revenue_items_by_revenue_event_with_http_info(self, event_number, request, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('event_number' not in local_var_params or  # noqa: E501
                                                        local_var_params['event_number'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `event_number` when calling `p_ut_custom_fieldson_revenue_items_by_revenue_event`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('request' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `request` when calling `p_ut_custom_fieldson_revenue_items_by_revenue_event`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `p_ut_custom_fieldson_revenue_items_by_revenue_event`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ut_custom_fieldson_revenue_items_by_revenue_schedule_with_http_info(self, rs_number, request, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('rs_number' not in local_var_params or  # noqa: E501
                                                        local_var_params['rs_number'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `rs_number` when calling `p_ut_custom_fieldson_revenue_items_by_revenue_schedule`")  # noqa: E501
        # verify the required parameter 'request' is set
        if self.api_client.client_side_validation and ('request' not in local_var_params or  # noqa: E501
                                                        local_var_params['request'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `request` when calling `p_ut_custom_fieldson_revenue_items_by_revenue_schedule`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `p_ut_custom_fieldson_revenue_items_by_revenue_schedule`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
