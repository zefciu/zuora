...
class RevenueSchedulesApi(object):
    ...
    def d_eleters_with_http_info(self, rs_number, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('rs_number' not in local_var_params or  # noqa: E501
                                                        local_var_params['rs_number'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `rs_number` when calling `d_eleters`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `d_eleters`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}

        path_params = {}
        if 'rs_number' in local_var_params:
            path_params['rs-number'] = local_var_params['rs_number']  # noqa: E501
    ...
    def g_etr_sby_credit_memo_item_with_http_info(self, cmi_id, **kwargs):  # noqa: E501
        ...
        **Note:** This operation is only available if you have [Invoice Settlement](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement) enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you want to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information.  Retrieves the details about a revenue schedule by specifying a valid credit memo item ID.   # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(GETRSDetailType, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('cmi_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['cmi_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `cmi_id` when calling `g_etr_sby_credit_memo_item`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `g_etr_sby_credit_memo_item`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}

        path_params = {}
        if 'cmi_id' in local_var_params:
            path_params['cmi-id'] = local_var_params['cmi_id']  # noqa: E501
    ...
    def g_etr_sby_debit_memo_item_with_http_info(self, dmi_id, **kwargs):  # noqa: E501
        ...
        **Note:** This operation is only available if you have [Invoice Settlement](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement) enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you want to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information.  Retrieves the details about a revenue schedule by specifying a valid debit memo item ID.   # noqa: E501
        ...
        if self.api_client.client_side_validation and ('dmi_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['dmi_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `dmi_id` when calling `g_etr_sby_debit_memo_item`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `g_etr_sby_debit_memo_item`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}

        path_params = {}
        if 'dmi_id' in local_var_params:
            path_params['dmi-id'] = local_var_params['dmi_id']  # noqa: E501
    ...
    def g_etr_sby_invoice_item_with_http_info(self, invoice_item_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('invoice_item_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['invoice_item_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `invoice_item_id` when calling `g_etr_sby_invoice_item`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `g_etr_sby_invoice_item`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}

        path_params = {}
        if 'invoice_item_id' in local_var_params:
            path_params['invoice-item-id'] = local_var_params['invoice_item_id']  # noqa: E501
    ...
    def g_etr_sby_invoice_item_adjustment_with_http_info(self, invoice_item_adj_key, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('invoice_item_adj_key' not in local_var_params or  # noqa: E501
                                                        local_var_params['invoice_item_adj_key'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `invoice_item_adj_key` when calling `g_etr_sby_invoice_item_adjustment`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `g_etr_sby_invoice_item_adjustment`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}

        path_params = {}
        if 'invoice_item_adj_key' in local_var_params:
            path_params['invoice-item-adj-key'] = local_var_params['invoice_item_adj_key']  # noqa: E501
    ...
    def g_etr_sby_product_charge_and_billing_account_with_http_info(self, account_key, charge_key, **kwargs):  # noqa: E501
        ...
        **Note:** This operation is only available if you have [Invoice Settlement](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement) enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you want to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information.  Retrieves the details about all revenue schedules of a product rate plan charge by specifying the charge ID and billing account ID.   # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(GETRSDetailsByProductChargeType, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('account_key' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `account_key` when calling `g_etr_sby_product_charge_and_billing_account`")  # noqa: E501
        # verify the required parameter 'charge_key' is set
        if self.api_client.client_side_validation and ('charge_key' not in local_var_params or  # noqa: E501
                                                        local_var_params['charge_key'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `charge_key` when calling `g_etr_sby_product_charge_and_billing_account`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `g_etr_sby_product_charge_and_billing_account`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and 'page_size' in local_var_params and local_var_params['page_size'] > 300:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `page_size` when calling `g_etr_sby_product_charge_and_billing_account`, must be a value less than or equal to `300`")  # noqa: E501
        collection_formats = {}

        path_params = {}
        if 'account_key' in local_var_params:
            path_params['account-key'] = local_var_params['account_key']  # noqa: E501
        if 'charge_key' in local_var_params:
            path_params['charge-key'] = local_var_params['charge_key']  # noqa: E501
    ...
    def g_etr_sfor_subsc_charge_with_http_info(self, charge_key, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(GETRSDetailsByChargeType, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('charge_key' not in local_var_params or  # noqa: E501
                                                        local_var_params['charge_key'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `charge_key` when calling `g_etr_sfor_subsc_charge`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `g_etr_sfor_subsc_charge`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and 'page_size' in local_var_params and local_var_params['page_size'] > 300:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `page_size` when calling `g_etr_sfor_subsc_charge`, must be a value less than or equal to `300`")  # noqa: E501
        collection_formats = {}
    ...
    def g_etrs_with_http_info(self, rs_number, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('rs_number' not in local_var_params or  # noqa: E501
                                                        local_var_params['rs_number'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `rs_number` when calling `g_etrs`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `g_etrs`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ostr_sfor_credit_memo_item_distribute_by_date_range_with_http_info(self, cmi_id, body, **kwargs):  # noqa: E501
        ...
        **Note:** This operation is only available if you have [Invoice Settlement](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement) enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you want to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information.  Creates a revenue schedule for a credit memo item, and automatically distribute the revenue by specifying the recognition start and end dates.   # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(POSTRevenueScheduleByTransactionResponseType, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('cmi_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['cmi_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `cmi_id` when calling `p_ostr_sfor_credit_memo_item_distribute_by_date_range`")  # noqa: E501
        # verify the required parameter 'body' is set
        if self.api_client.client_side_validation and ('body' not in local_var_params or  # noqa: E501
                                                        local_var_params['body'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `body` when calling `p_ostr_sfor_credit_memo_item_distribute_by_date_range`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `p_ostr_sfor_credit_memo_item_distribute_by_date_range`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ostr_sfor_credit_memo_item_manual_distribution_with_http_info(self, cmi_id, body, **kwargs):  # noqa: E501
        ...
        **Note:** This operation is only available if you have [Invoice Settlement](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement) enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you want to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information.  Creates a revenue schedule for a credit memo item, and manually distribute the revenue.   # noqa: E501
        ...
        if self.api_client.client_side_validation and ('cmi_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['cmi_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `cmi_id` when calling `p_ostr_sfor_credit_memo_item_manual_distribution`")  # noqa: E501
        # verify the required parameter 'body' is set
        if self.api_client.client_side_validation and ('body' not in local_var_params or  # noqa: E501
                                                        local_var_params['body'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `body` when calling `p_ostr_sfor_credit_memo_item_manual_distribution`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `p_ostr_sfor_credit_memo_item_manual_distribution`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ostr_sfor_debit_memo_item_distribute_by_date_range_with_http_info(self, dmi_id, body, **kwargs):  # noqa: E501
        ...
        **Note:** This operation is only available if you have [Invoice Settlement](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement) enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you want to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information.  Creates a revenue schedule for a debit memo item, and automatically distribute the revenue by specifying the recognition start and end dates.   # noqa: E501
        ...
        if self.api_client.client_side_validation and ('dmi_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['dmi_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `dmi_id` when calling `p_ostr_sfor_debit_memo_item_distribute_by_date_range`")  # noqa: E501
        # verify the required parameter 'body' is set
        if self.api_client.client_side_validation and ('body' not in local_var_params or  # noqa: E501
                                                        local_var_params['body'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `body` when calling `p_ostr_sfor_debit_memo_item_distribute_by_date_range`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `p_ostr_sfor_debit_memo_item_distribute_by_date_range`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ostr_sfor_debit_memo_item_manual_distribution_with_http_info(self, dmi_id, body, **kwargs):  # noqa: E501
        ...
        **Note:** This operation is only available if you have [Invoice Settlement](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement) enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you want to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information.  Creates a revenue schedule for a debit memo item, and manually distribute the revenue.   # noqa: E501
        ...
        if self.api_client.client_side_validation and ('dmi_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['dmi_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `dmi_id` when calling `p_ostr_sfor_debit_memo_item_manual_distribution`")  # noqa: E501
        # verify the required parameter 'body' is set
        if self.api_client.client_side_validation and ('body' not in local_var_params or  # noqa: E501
                                                        local_var_params['body'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `body` when calling `p_ostr_sfor_debit_memo_item_manual_distribution`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `p_ostr_sfor_debit_memo_item_manual_distribution`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ostr_sfor_invoice_item_adjustment_distribute_by_date_range_with_http_info(self, invoice_item_adj_key, request, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('invoice_item_adj_key' not in local_var_params or  # noqa: E501
                                                        local_var_params['invoice_item_adj_key'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `invoice_item_adj_key` when calling `p_ostr_sfor_invoice_item_adjustment_distribute_by_date_range`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('request' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `request` when calling `p_ostr_sfor_invoice_item_adjustment_distribute_by_date_range`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `p_ostr_sfor_invoice_item_adjustment_distribute_by_date_range`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ostr_sfor_invoice_item_adjustment_manual_distribution_with_http_info(self, invoice_item_adj_key, request, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('invoice_item_adj_key' not in local_var_params or  # noqa: E501
                                                        local_var_params['invoice_item_adj_key'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `invoice_item_adj_key` when calling `p_ostr_sfor_invoice_item_adjustment_manual_distribution`")  # noqa: E501
        # verify the required parameter 'request' is set
        if self.api_client.client_side_validation and ('request' not in local_var_params or  # noqa: E501
                                                        local_var_params['request'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `request` when calling `p_ostr_sfor_invoice_item_adjustment_manual_distribution`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `p_ostr_sfor_invoice_item_adjustment_manual_distribution`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ostr_sfor_invoice_item_distribute_by_date_range_with_http_info(self, invoice_item_id, request, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('invoice_item_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['invoice_item_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `invoice_item_id` when calling `p_ostr_sfor_invoice_item_distribute_by_date_range`")  # noqa: E501
        # verify the required parameter 'request' is set
        if self.api_client.client_side_validation and ('request' not in local_var_params or  # noqa: E501
                                                        local_var_params['request'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `request` when calling `p_ostr_sfor_invoice_item_distribute_by_date_range`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `p_ostr_sfor_invoice_item_distribute_by_date_range`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ostr_sfor_invoice_item_manual_distribution_with_http_info(self, invoice_item_id, request, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('invoice_item_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['invoice_item_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `invoice_item_id` when calling `p_ostr_sfor_invoice_item_manual_distribution`")  # noqa: E501
        # verify the required parameter 'request' is set
        if self.api_client.client_side_validation and ('request' not in local_var_params or  # noqa: E501
                                                        local_var_params['request'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `request` when calling `p_ostr_sfor_invoice_item_manual_distribution`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `p_ostr_sfor_invoice_item_manual_distribution`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ostr_sfor_subsc_charge_with_http_info(self, charge_key, request, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(POSTRevenueScheduleByChargeResponseType, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('charge_key' not in local_var_params or  # noqa: E501
                                                        local_var_params['charge_key'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `charge_key` when calling `p_ostr_sfor_subsc_charge`")  # noqa: E501
        # verify the required parameter 'request' is set
        if self.api_client.client_side_validation and ('request' not in local_var_params or  # noqa: E501
                                                        local_var_params['request'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `request` when calling `p_ostr_sfor_subsc_charge`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `p_ostr_sfor_subsc_charge`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ut_revenue_across_ap_with_http_info(self, rs_number, request, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(PUTRevenueScheduleResponseType, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('rs_number' not in local_var_params or  # noqa: E501
                                                        local_var_params['rs_number'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `rs_number` when calling `p_ut_revenue_across_ap`")  # noqa: E501
        # verify the required parameter 'request' is set
        if self.api_client.client_side_validation and ('request' not in local_var_params or  # noqa: E501
                                                        local_var_params['request'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `request` when calling `p_ut_revenue_across_ap`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `p_ut_revenue_across_ap`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ut_revenue_by_recognition_startand_end_dates_with_http_info(self, rs_number, request, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('rs_number' not in local_var_params or  # noqa: E501
                                                        local_var_params['rs_number'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `rs_number` when calling `p_ut_revenue_by_recognition_startand_end_dates`")  # noqa: E501
        # verify the required parameter 'request' is set
        if self.api_client.client_side_validation and ('request' not in local_var_params or  # noqa: E501
                                                        local_var_params['request'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `request` when calling `p_ut_revenue_by_recognition_startand_end_dates`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `p_ut_revenue_by_recognition_startand_end_dates`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ut_revenue_specific_date_with_http_info(self, rs_number, request, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('rs_number' not in local_var_params or  # noqa: E501
                                                        local_var_params['rs_number'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `rs_number` when calling `p_ut_revenue_specific_date`")  # noqa: E501
        # verify the required parameter 'request' is set
        if self.api_client.client_side_validation and ('request' not in local_var_params or  # noqa: E501
                                                        local_var_params['request'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `request` when calling `p_ut_revenue_specific_date`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `p_ut_revenue_specific_date`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_utrs_basic_info_with_http_info(self, rs_number, request, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('rs_number' not in local_var_params or  # noqa: E501
                                                        local_var_params['rs_number'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `rs_number` when calling `p_utrs_basic_info`")  # noqa: E501
        # verify the required parameter 'request' is set
        if self.api_client.client_side_validation and ('request' not in local_var_params or  # noqa: E501
                                                        local_var_params['request'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `request` when calling `p_utrs_basic_info`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `p_utrs_basic_info`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
