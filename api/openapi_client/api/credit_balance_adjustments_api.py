...
class CreditBalanceAdjustmentsApi(object):
    ...
    def object_get_credit_balance_adjustment(self, id, **kwargs):  # noqa: E501
        """CRUD: Retrieve a credit balance adjustment  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.object_get_credit_balance_adjustment(id, async_req=True)
        >>> result = thread.get()
        ...
        return self.object_get_credit_balance_adjustment_with_http_info(id, **kwargs)  # noqa: E501

    def object_get_credit_balance_adjustment_with_http_info(self, id, **kwargs):  # noqa: E501
        """CRUD: Retrieve a credit balance adjustment  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.object_get_credit_balance_adjustment_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(ProxyGetCreditBalanceAdjustment, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method object_get_credit_balance_adjustment" % key
                )
        ...
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `id` when calling `object_get_credit_balance_adjustment`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `object_get_credit_balance_adjustment`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            '/v1/object/credit-balance-adjustment/{id}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='ProxyGetCreditBalanceAdjustment',  # noqa: E501
    ...
    def object_post_credit_balance_adjustment(self, create_request, **kwargs):  # noqa: E501
        """CRUD: Create a credit balance adjustment  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.object_post_credit_balance_adjustment(create_request, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param ProxyCreateCreditBalanceAdjustment create_request: (required)
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.object_post_credit_balance_adjustment_with_http_info(create_request, **kwargs)  # noqa: E501

    def object_post_credit_balance_adjustment_with_http_info(self, create_request, **kwargs):  # noqa: E501
        """CRUD: Create a credit balance adjustment  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.object_post_credit_balance_adjustment_with_http_info(create_request, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method object_post_credit_balance_adjustment" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        if self.api_client.client_side_validation and ('create_request' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `create_request` when calling `object_post_credit_balance_adjustment`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `object_post_credit_balance_adjustment`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            '/v1/object/credit-balance-adjustment', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def object_put_credit_balance_adjustment(self, id, modify_request, **kwargs):  # noqa: E501
        """CRUD: Update a credit balance adjustment  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.object_put_credit_balance_adjustment(id, modify_request, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str id: Object id (required)
        :param ProxyModifyCreditBalanceAdjustment modify_request: (required)
        :param bool reject_unknown_fields: Specifies whether the call fails if the request body contains unknown fields. With `rejectUnknownFields` set to `true`, Zuora returns a 400 response if the request body contains unknown fields. The body of the 400 response is:  ```json {     \"message\": \"Error - unrecognised fields\" } ```  By default, Zuora ignores unknown fields in the request body. 
        :param str zuora_entity_ids: An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
        :param str zuora_track_id: A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`\"`), and quote (`'`). 
        :param _preload_content: if False, the urllib3.HTTPResponse object will
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.object_put_credit_balance_adjustment_with_http_info(id, modify_request, **kwargs)  # noqa: E501

    def object_put_credit_balance_adjustment_with_http_info(self, id, modify_request, **kwargs):  # noqa: E501
        """CRUD: Update a credit balance adjustment  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.object_put_credit_balance_adjustment_with_http_info(id, modify_request, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method object_put_credit_balance_adjustment" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'id' is set
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
                                                        local_var_params['id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `id` when calling `object_put_credit_balance_adjustment`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('modify_request' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `modify_request` when calling `object_put_credit_balance_adjustment`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `object_put_credit_balance_adjustment`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            '/v1/object/credit-balance-adjustment/{id}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
