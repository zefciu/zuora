...
class AttachmentsApi(object):
    ...
    def d_elete_attachments_with_http_info(self, attachment_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('attachment_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `attachment_id` when calling `d_elete_attachments`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `d_elete_attachments`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}

        path_params = {}
        if 'attachment_id' in local_var_params:
            path_params['attachment-id'] = local_var_params['attachment_id']  # noqa: E501
    ...
    def g_et_attachments_with_http_info(self, attachment_id, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(GETAttachmentResponseType, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('attachment_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['attachment_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `attachment_id` when calling `g_et_attachments`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_attachments`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def g_et_attachments_list_with_http_info(self, object_type, object_key, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(GETAttachmentsResponseType, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('object_type' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `object_type` when calling `g_et_attachments_list`")  # noqa: E501
        # verify the required parameter 'object_key' is set
        if self.api_client.client_side_validation and ('object_key' not in local_var_params or  # noqa: E501
                                                        local_var_params['object_key'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `object_key` when calling `g_et_attachments_list`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_attachments_list`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and 'page_size' in local_var_params and local_var_params['page_size'] > 40:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `page_size` when calling `g_et_attachments_list`, must be a value less than or equal to `40`")  # noqa: E501
        collection_formats = {}

        path_params = {}
        if 'object_type' in local_var_params:
            path_params['object-type'] = local_var_params['object_type']  # noqa: E501
        if 'object_key' in local_var_params:
            path_params['object-key'] = local_var_params['object_key']  # noqa: E501
    ...
    def p_ost_attachments_with_http_info(self, associated_object_type, associated_object_key, file, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(POSTAttachmentResponseType, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('associated_object_type' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `associated_object_type` when calling `p_ost_attachments`")  # noqa: E501
        # verify the required parameter 'associated_object_key' is set
        if self.api_client.client_side_validation and ('associated_object_key' not in local_var_params or  # noqa: E501
                                                        local_var_params['associated_object_key'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `associated_object_key` when calling `p_ost_attachments`")  # noqa: E501
        # verify the required parameter 'file' is set
        if self.api_client.client_side_validation and ('file' not in local_var_params or  # noqa: E501
                                                        local_var_params['file'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `file` when calling `p_ost_attachments`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `p_ost_attachments`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
        ...
        if 'associated_object_type' in local_var_params and local_var_params['associated_object_type'] is not None:  # noqa: E501
            query_params.append(('associatedObjectType', local_var_params['associated_object_type']))  # noqa: E501
        if 'associated_object_key' in local_var_params and local_var_params['associated_object_key'] is not None:  # noqa: E501
            query_params.append(('associatedObjectKey', local_var_params['associated_object_key']))  # noqa: E501
    ...
    def p_ut_attachments_with_http_info(self, attachment_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('attachment_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['attachment_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `attachment_id` when calling `p_ut_attachments`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `p_ut_attachments`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
