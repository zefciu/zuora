...
class SummaryJournalEntriesApi(object):
    ...
    def d_elete_summary_journal_entry_with_http_info(self, je_number, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('je_number' not in local_var_params or  # noqa: E501
                                                        local_var_params['je_number'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `je_number` when calling `d_elete_summary_journal_entry`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `d_elete_summary_journal_entry`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}

        path_params = {}
        if 'je_number' in local_var_params:
            path_params['je-number'] = local_var_params['je_number']  # noqa: E501
    ...
    def g_et_all_summary_journal_entries_with_http_info(self, jr_number, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(GETJournalEntriesInJournalRunType, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('jr_number' not in local_var_params or  # noqa: E501
                                                        local_var_params['jr_number'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `jr_number` when calling `g_et_all_summary_journal_entries`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_all_summary_journal_entries`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and 'page_size' in local_var_params and local_var_params['page_size'] > 300:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `page_size` when calling `g_et_all_summary_journal_entries`, must be a value less than or equal to `300`")  # noqa: E501
        collection_formats = {}

        path_params = {}
        if 'jr_number' in local_var_params:
            path_params['jr-number'] = local_var_params['jr_number']  # noqa: E501
    ...
    def g_et_summary_journal_entry_with_http_info(self, je_number, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(GETJournalEntryDetailType, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('je_number' not in local_var_params or  # noqa: E501
                                                        local_var_params['je_number'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `je_number` when calling `g_et_summary_journal_entry`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_summary_journal_entry`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ost_summary_journal_entry_with_http_info(self, request, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(POSTJournalEntryResponseType, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('request' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `request` when calling `p_ost_summary_journal_entry`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `p_ost_summary_journal_entry`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ut_basic_summary_journal_entry_with_http_info(self, je_number, request, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('je_number' not in local_var_params or  # noqa: E501
                                                        local_var_params['je_number'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `je_number` when calling `p_ut_basic_summary_journal_entry`")  # noqa: E501
        # verify the required parameter 'request' is set
        if self.api_client.client_side_validation and ('request' not in local_var_params or  # noqa: E501
                                                        local_var_params['request'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `request` when calling `p_ut_basic_summary_journal_entry`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `p_ut_basic_summary_journal_entry`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ut_summary_journal_entry_with_http_info(self, je_number, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('je_number' not in local_var_params or  # noqa: E501
                                                        local_var_params['je_number'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `je_number` when calling `p_ut_summary_journal_entry`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `p_ut_summary_journal_entry`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
