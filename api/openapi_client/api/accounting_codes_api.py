...
class AccountingCodesApi(object):
    ...
    def d_elete_accounting_code_with_http_info(self, ac_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('ac_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['ac_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `ac_id` when calling `d_elete_accounting_code`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `d_elete_accounting_code`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}

        path_params = {}
        if 'ac_id' in local_var_params:
            path_params['ac-id'] = local_var_params['ac_id']  # noqa: E501
    ...
    def g_et_accounting_code_with_http_info(self, ac_id, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(GETAccountingCodeItemType, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('ac_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['ac_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `ac_id` when calling `g_et_accounting_code`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_accounting_code`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def g_et_all_accounting_codes_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(GETAccountingCodesType, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_all_accounting_codes`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and 'page_size' in local_var_params and local_var_params['page_size'] > 300:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `page_size` when calling `g_et_all_accounting_codes`, must be a value less than or equal to `300`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ost_accounting_code_with_http_info(self, request, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(POSTAccountingCodeResponseType, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('request' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `request` when calling `p_ost_accounting_code`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `p_ost_accounting_code`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ut_accounting_code_with_http_info(self, ac_id, request, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('ac_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['ac_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `ac_id` when calling `p_ut_accounting_code`")  # noqa: E501
        # verify the required parameter 'request' is set
        if self.api_client.client_side_validation and ('request' not in local_var_params or  # noqa: E501
                                                        local_var_params['request'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `request` when calling `p_ut_accounting_code`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `p_ut_accounting_code`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ut_activate_accounting_code_with_http_info(self, ac_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('ac_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['ac_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `ac_id` when calling `p_ut_activate_accounting_code`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `p_ut_activate_accounting_code`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ut_deactivate_accounting_code_with_http_info(self, ac_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('ac_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['ac_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `ac_id` when calling `p_ut_deactivate_accounting_code`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `p_ut_deactivate_accounting_code`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
