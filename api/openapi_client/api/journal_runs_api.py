...
class JournalRunsApi(object):
    ...
    def d_elete_journal_run_with_http_info(self, jr_number, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('jr_number' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `jr_number` when calling `d_elete_journal_run`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `d_elete_journal_run`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def g_et_journal_run_with_http_info(self, jr_number, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(GETJournalRunType, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('jr_number' not in local_var_params or  # noqa: E501
                                                        local_var_params['jr_number'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `jr_number` when calling `g_et_journal_run`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_journal_run`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ost_journal_run_with_http_info(self, request, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(POSTJournalRunResponseType, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('request' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `request` when calling `p_ost_journal_run`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `p_ost_journal_run`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ut_journal_run_with_http_info(self, jr_number, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('jr_number' not in local_var_params or  # noqa: E501
                                                        local_var_params['jr_number'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `jr_number` when calling `p_ut_journal_run`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `p_ut_journal_run`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
