...
class ProductRatePlansApi(object):
    ...
    def g_et_product_rate_plans(self, product_id, **kwargs):  # noqa: E501
        ...
        :param str product_id: The unique ID of a product. For example, 2c92c0f96487e16a016487f663c71a61.  (required)
    ...
    def g_et_product_rate_plans_with_http_info(self, product_id, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(GETProductRatePlansResponse, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('product_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `product_id` when calling `g_et_product_rate_plans`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_product_rate_plans`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and 'page' in local_var_params and local_var_params['page'] < 1:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `page` when calling `g_et_product_rate_plans`, must be a value greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and 'page_size' in local_var_params and local_var_params['page_size'] > 40:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `page_size` when calling `g_et_product_rate_plans`, must be a value less than or equal to `40`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            '/v1/rateplan/{product_id}/productRatePlan', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def object_delete_product_rate_plan_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `id` when calling `object_delete_product_rate_plan`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `object_delete_product_rate_plan`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def object_get_product_rate_plan_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(ProxyGetProductRatePlan, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
                                                        local_var_params['id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `id` when calling `object_get_product_rate_plan`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `object_get_product_rate_plan`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def object_post_product_rate_plan(self, create_request, **kwargs):  # noqa: E501
        """CRUD: Create a product rate plan  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.object_post_product_rate_plan(create_request, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param ProxyCreateProductRatePlan create_request: (required)
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.object_post_product_rate_plan_with_http_info(create_request, **kwargs)  # noqa: E501

    def object_post_product_rate_plan_with_http_info(self, create_request, **kwargs):  # noqa: E501
        """CRUD: Create a product rate plan  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.object_post_product_rate_plan_with_http_info(create_request, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('create_request' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `create_request` when calling `object_post_product_rate_plan`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `object_post_product_rate_plan`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def object_put_product_rate_plan(self, id, modify_request, **kwargs):  # noqa: E501
        """CRUD: Update a product rate plan  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.object_put_product_rate_plan(id, modify_request, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str id: Object id (required)
        :param ProxyModifyProductRatePlan modify_request: (required)
        :param bool reject_unknown_fields: Specifies whether the call fails if the request body contains unknown fields. With `rejectUnknownFields` set to `true`, Zuora returns a 400 response if the request body contains unknown fields. The body of the 400 response is:  ```json {     \"message\": \"Error - unrecognised fields\" } ```  By default, Zuora ignores unknown fields in the request body. 
        :param str zuora_entity_ids: An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
        :param str zuora_track_id: A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`\"`), and quote (`'`). 
        :param _preload_content: if False, the urllib3.HTTPResponse object will
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.object_put_product_rate_plan_with_http_info(id, modify_request, **kwargs)  # noqa: E501

    def object_put_product_rate_plan_with_http_info(self, id, modify_request, **kwargs):  # noqa: E501
        """CRUD: Update a product rate plan  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.object_put_product_rate_plan_with_http_info(id, modify_request, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
                                                        local_var_params['id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `id` when calling `object_put_product_rate_plan`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('modify_request' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `modify_request` when calling `object_put_product_rate_plan`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['zuora_track_id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `zuora_track_id` when calling `object_put_product_rate_plan`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
