# openapi_client.RefundTransactionLogsApi

All URIs are relative to *https://rest.zuora.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**object_get_refund_transaction_log**](RefundTransactionLogsApi.md#object_get_refund_transaction_log) | **GET** /v1/object/refund-transaction-log/{id} | CRUD: Retrieve a refund transaction log
...
with openapi_client.ApiClient() as api_client:
    ...
    api_instance = openapi_client.RefundTransactionLogsApi(api_client)
