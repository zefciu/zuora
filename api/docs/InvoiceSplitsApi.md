# openapi_client.InvoiceSplitsApi

All URIs are relative to *https://rest.zuora.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**object_get_invoice_split**](InvoiceSplitsApi.md#object_get_invoice_split) | **GET** /v1/object/invoice-split/{id} | CRUD: Retrieve an invoice split


# **object_get_invoice_split**
> ProxyGetInvoiceSplit object_get_invoice_split(id, zuora_entity_ids=zuora_entity_ids, zuora_track_id=zuora_track_id, fields=fields)
...
with openapi_client.ApiClient() as api_client:
    ...
    api_instance = openapi_client.InvoiceSplitsApi(api_client)
...
fields = 'fields_example' # str | Object fields to return (optional)
    ...
    try:
        # CRUD: Retrieve an invoice split
        api_response = api_instance.object_get_invoice_split(id, zuora_entity_ids=zuora_entity_ids, zuora_track_id=zuora_track_id, fields=fields)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling InvoiceSplitsApi->object_get_invoice_split: %s\n" % e)
```
