# openapi_client.SubscriptionProductFeaturesApi

All URIs are relative to *https://rest.zuora.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**object_get_subscription_product_feature**](SubscriptionProductFeaturesApi.md#object_get_subscription_product_feature) | **GET** /v1/object/subscription-product-feature/{id} | CRUD: Retrieve a subscription product feature
...
with openapi_client.ApiClient() as api_client:
    ...
    api_instance = openapi_client.SubscriptionProductFeaturesApi(api_client)
