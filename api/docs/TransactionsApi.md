...
------------- | ------------- | -------------
[**g_et_transaction_invoice**](TransactionsApi.md#g_et_transaction_invoice) | **GET** /v1/transactions/invoices/accounts/{account-key} | List all invoices for an account
[**g_et_transaction_payment**](TransactionsApi.md#g_et_transaction_payment) | **GET** /v1/transactions/payments/accounts/{account-key} | List all payments for an account


# **g_et_transaction_invoice**
> GETInvoiceFileWrapper g_et_transaction_invoice(account_key, zuora_track_id=zuora_track_id, zuora_entity_ids=zuora_entity_ids, page_size=page_size)
...
page_size = 20 # int | Number of rows returned per page.  (optional) (default to 20)
    ...
    try:
        # List all invoices for an account
        api_response = api_instance.g_et_transaction_invoice(account_key, zuora_track_id=zuora_track_id, zuora_entity_ids=zuora_entity_ids, page_size=page_size)
        pprint(api_response)
...
> GETPaymentsType g_et_transaction_payment(account_key, zuora_track_id=zuora_track_id, zuora_entity_ids=zuora_entity_ids, page_size=page_size)
...
page_size = 20 # int | Number of rows returned per page.  (optional) (default to 20)
    ...
    try:
        # List all payments for an account
        api_response = api_instance.g_et_transaction_payment(account_key, zuora_track_id=zuora_track_id, zuora_entity_ids=zuora_entity_ids, page_size=page_size)
        pprint(api_response)
    except ApiException as e:
