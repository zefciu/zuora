# openapi_client.CommunicationProfilesApi

All URIs are relative to *https://rest.zuora.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**object_get_communication_profile**](CommunicationProfilesApi.md#object_get_communication_profile) | **GET** /v1/object/communication-profile/{id} | CRUD: Retrieve a communication profile
...
with openapi_client.ApiClient() as api_client:
    ...
    api_instance = openapi_client.CommunicationProfilesApi(api_client)
