...
------------- | ------------- | -------------
[**object_get_import**](ImportsApi.md#object_get_import) | **GET** /v1/object/import/{id} | CRUD: Retrieve an import
[**object_post_import**](ImportsApi.md#object_post_import) | **POST** /v1/object/import | CRUD: Create an import


# **object_get_import**
> ProxyGetImport object_get_import(id, zuora_entity_ids=zuora_entity_ids, zuora_track_id=zuora_track_id, fields=fields)
...
fields = 'fields_example' # str | Object fields to return (optional)
    ...
    try:
        # CRUD: Retrieve an import
        api_response = api_instance.object_get_import(id, zuora_entity_ids=zuora_entity_ids, zuora_track_id=zuora_track_id, fields=fields)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling ImportsApi->object_get_import: %s\n" % e)
```
...
# **object_post_import**
> ProxyPostImport object_post_import(import_type, name, file, reject_unknown_fields=reject_unknown_fields, zuora_entity_ids=zuora_entity_ids, zuora_track_id=zuora_track_id)
...
with openapi_client.ApiClient() as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.ImportsApi(api_client)
    import_type = 'import_type_example' # str | The type of data to import. 
name = 'name_example' # str | A descriptive name for the import. 
file = '/path/to/file' # file | The data to import. 
...
zuora_track_id = 'zuora_track_id_example' # str | A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`\"`), and quote (`'`).  (optional)
    ...
    try:
        # CRUD: Create an import
        api_response = api_instance.object_post_import(import_type, name, file, reject_unknown_fields=reject_unknown_fields, zuora_entity_ids=zuora_entity_ids, zuora_track_id=zuora_track_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling ImportsApi->object_post_import: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **import_type** | **str**| The type of data to import.  | 
 **name** | **str**| A descriptive name for the import.  | 
