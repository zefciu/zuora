# openapi_client.InvoiceSplitItemsApi

All URIs are relative to *https://rest.zuora.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**object_get_invoice_split_item**](InvoiceSplitItemsApi.md#object_get_invoice_split_item) | **GET** /v1/object/invoice-split-item/{id} | CRUD: Retrieve an invoice split item


# **object_get_invoice_split_item**
> ProxyGetInvoiceSplitItem object_get_invoice_split_item(id, zuora_entity_ids=zuora_entity_ids, zuora_track_id=zuora_track_id, fields=fields)
...
with openapi_client.ApiClient() as api_client:
    ...
    api_instance = openapi_client.InvoiceSplitItemsApi(api_client)
...
fields = 'fields_example' # str | Object fields to return (optional)
    ...
    try:
        # CRUD: Retrieve an invoice split item
        api_response = api_instance.object_get_invoice_split_item(id, zuora_entity_ids=zuora_entity_ids, zuora_track_id=zuora_track_id, fields=fields)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling InvoiceSplitItemsApi->object_get_invoice_split_item: %s\n" % e)
```
