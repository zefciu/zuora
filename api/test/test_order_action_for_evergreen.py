...
from openapi_client.models.order_action_for_evergreen import OrderActionForEvergreen  # noqa: E501
from openapi_client.rest import ApiException

class TestOrderActionForEvergreen(unittest.TestCase):
    """OrderActionForEvergreen unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test OrderActionForEvergreen
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = openapi_client.models.order_action_for_evergreen.OrderActionForEvergreen()  # noqa: E501
        if include_optional :
            return OrderActionForEvergreen(
                add_product = openapi_client.models.rate_plan.ratePlan(
                    charge_overrides = [
                        openapi_client.models.charge.charge(
                            billing = openapi_client.models.charge_override_billing.ChargeOverride_billing(
                                bill_cycle_day = 0, 
                            ...
                            description = '0', 
                            end_date = openapi_client.models.end_date.endDate(
                            ...
                            pricing = openapi_client.models.charge_override_pricing.ChargeOverride_pricing(
                                charge_model_data = openapi_client.models.charge_model_data.chargeModelData(
                                    charge_model_configuration = openapi_client.models.charge_model_data_override_charge_model_configuration.ChargeModelDataOverride_chargeModelConfiguration(
                                        custom_field_per_unit_rate = '0', 
                                        custom_field_total_amount = '0', 
                                        formula = '0', ), 
                                    quantity = 0, 
                                    tiers = [
                                        openapi_client.models.charge_tier.chargeTier(
                                            ending_unit = 1.337, 
                                            price = 1.337, 
                                ...
                                one_time_flat_fee = openapi_client.models.one_time_flat_fee.oneTimeFlatFee(
                                    list_price = 1.337, ), 
                                one_time_per_unit = openapi_client.models.one_time_per_unit.oneTimePerUnit(
                                    list_price = 1.337, 
                                    quantity = 0, ), 
                                one_time_tiered = openapi_client.models.one_time_tiered.oneTimeTiered(
                                    quantity = 0, ), 
                                one_time_volume = openapi_client.models.one_time_volume.oneTimeVolume(
                                    quantity = 0, ), 
                    ...
                    new_rate_plan_id = '0', 
                    product_rate_plan_id = '0', 
                    unique_token = '0', ), 
                cancel_subscription = openapi_client.models.cancel_subscription.cancelSubscription(
                    cancellation_effective_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                    cancellation_policy = 'EndOfCurrentTerm', ), 
                create_subscription = openapi_client.models.create_subscription.createSubscription(
                    invoice_separately = True, 
                    new_subscription_owner_account = openapi_client.models.create_subscription_for_evergreen_new_subscription_owner_account.CreateSubscriptionForEvergreen_newSubscriptionOwnerAccount(
                        account_number = '0', 
                        auto_pay = True, 
                        batch = '0', 
                        bill_cycle_day = 0, 
                        bill_to_contact = null, 
                        communication_profile_id = '0', 
                        credit_card = openapi_client.models.credit_card.creditCard(
                            card_holder_info = openapi_client.models.account_credit_card_holder.AccountCreditCardHolder(
                                address_line1 = '0', 
                                address_line2 = '0', 
                                card_holder_name = '0', 
                                city = '0', 
                        ...
                        hpm_credit_card_payment_method_id = '0', 
                        ...
                        tax_info = openapi_client.models.tax_info.taxInfo(
                            vat_id = '0', 
                            company_code = '0', 
                            exempt_certificate_id = '0', 
                            exempt_certificate_type = '0', 
                            exempt_description = '0', 
                            ...
                            exempt_issuing_jurisdiction = '0', 
                            exempt_status = 'No', ), ), 
                    notes = '0', 
                    subscribe_to_rate_plans = [
                        openapi_client.models.rate_plan.ratePlan(
                            charge_overrides = [
                                openapi_client.models.charge.charge(
                                    billing = openapi_client.models.charge_override_billing.ChargeOverride_billing(
                                        bill_cycle_day = 0, 
                    ...
                    subscription_owner_account_number = '0', 
                    terms = openapi_client.models.create_subscription_terms.CreateSubscription_terms(
                        auto_renew = True, 
                        initial_term = openapi_client.models.create_order_create_subscription_terms_initial_term.CreateOrderCreateSubscription_terms_initialTerm(
                            period = 56, 
                            period_type = 'Month', 
                            term_type = 'TERMED', ), 
                        renewal_setting = 'RENEW_WITH_SPECIFIC_TERM', 
                        renewal_terms = [
                            openapi_client.models.renewal_term.RenewalTerm(
                                period = 56, 
                                period_type = 'Month', )
                            ], ), ), 
                custom_fields = {
                ...
                id = '0', 
                order_metrics = [
                    openapi_client.models.order_metrics_for_evergreen.OrderMetricsForEvergreen(
                        charge_number = '0', 
                        mrr = [
                            openapi_client.models.time_sliced_net_metrics_for_evergreen.TimeSlicedNetMetricsForEvergreen(
                                amount = 1.337, 
                                discount_charge_number = '0', 
                                end_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                                invoice_owner = '0', 
                                start_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                                subscription_owner = '0', 
                                term_number = 1.337, 
                                type = 'Regular', )
                            ], 
                        origin_rate_plan_id = '0', 
                        product_rate_plan_charge_id = '0', 
                        product_rate_plan_id = '0', 
                        quantity = [
                            openapi_client.models.time_sliced_metrics_for_evergreen.TimeSlicedMetricsForEvergreen(
                                amount = 1.337, 
                                end_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                                invoice_owner = '0', 
                                start_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                        ...
                        tcb = [
                            openapi_client.models.time_sliced_tcb_net_metrics_for_evergreen.TimeSlicedTcbNetMetricsForEvergreen(
                                amount = 1.337, 
                                discount_charge_number = '0', 
                                end_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                                invoice_owner = '0', 
                ...
                owner_transfer = openapi_client.models.owner_transfer.ownerTransfer(
                    destination_account_number = '0', 
                    destination_invoice_account_number = '0', ), 
                remove_product = openapi_client.models.remove_product.removeProduct(
                    rate_plan_id = '0', 
                    unique_token = '0', ), 
                resume = openapi_client.models.resume.Resume(
                    extends_term = True, 
                ...
                sequence = 56, 
                suspend = openapi_client.models.suspend.Suspend(
                ...
                terms_and_conditions = openapi_client.models.terms_and_conditions.termsAndConditions(
                    auto_renew = True, 
                    initial_term = openapi_client.models.initial_term.InitialTerm(
                        period = 0, 
                        period_type = 'Month', 
                        start_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                        term_type = 'TERMED', ), 
                ...
                trigger_dates = [
                    openapi_client.models.trigger_date.triggerDate(
                        name = 'ContractEffective', 
                        trigger_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), )
                    ], 
                type = 'CreateSubscription', 
                update_product = openapi_client.models.update_product.updateProduct(
                    charge_updates = [
                        openapi_client.models.charge_update_for_evergreen.ChargeUpdateForEvergreen(
                            billing = openapi_client.models.billing_update.BillingUpdate(
                                billing_period_alignment = 'AlignToCharge', ), 
                            charge_number = '0', 
                            custom_fields = {
                                'key' : None
                            ...
                            description = '0', 
                            effective_date = openapi_client.models.start_date.startDate(
                                specific_trigger_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                                trigger_event = 'ContractEffective', ), 
                            pricing = openapi_client.models.pricing_update_for_evergreen.PricingUpdateForEvergreen(
                                charge_model_data = openapi_client.models.charge_model_data.chargeModelData(
                                    charge_model_configuration = openapi_client.models.charge_model_data_override_charge_model_configuration.ChargeModelDataOverride_chargeModelConfiguration(
                                        custom_field_per_unit_rate = '0', 
                                        custom_field_total_amount = '0', 
                                ...
                                discount = openapi_client.models.discount_pricing_update.DiscountPricingUpdate(
                                    apply_discount_to = 'ONETIME', 
                                    discount_level = 'rateplan', 
                                    discount_percentage = 1.337, 
                                    price_change_option = 'NoChange', ), 
    ...
    def testOrderActionForEvergreen(self):
        """Test OrderActionForEvergreen"""
