...
from openapi_client.models.order_action import OrderAction  # noqa: E501
...
class TestOrderAction(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = openapi_client.models.order_action.OrderAction()  # noqa: E501
        if include_optional :
            return OrderAction(
                ...
                create_subscription = openapi_client.models.create_subscription.createSubscription(
                    ...
                    new_subscription_owner_account = openapi_client.models.create_subscription_new_subscription_owner_account.CreateSubscription_newSubscriptionOwnerAccount(
                        account_number = '0', 
                        auto_pay = True, 
                        batch = '0', 
                        bill_cycle_day = 0, 
                ...
                order_metrics = [
                    openapi_client.models.order_metric.orderMetric(
                        charge_number = '0', 
                        elp = [
                            openapi_client.models.time_sliced_elp_net_metrics.TimeSlicedElpNetMetrics(
                                amount = 1.337, 
                                end_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                        ...
                        mrr = [
                            openapi_client.models.time_sliced_net_metrics.TimeSlicedNetMetrics(
                                amount = 1.337, 
                        ...
                        product_rate_plan_id = '0', 
                        quantity = [
                            openapi_client.models.time_sliced_metrics.TimeSlicedMetrics(
                                amount = 1.337, 
                                end_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                                generated_reason = 'IncreaseQuantity', 
                                invoice_owner = '0', 
                        ...
                        tcb = [
                            openapi_client.models.time_sliced_tcb_net_metrics.TimeSlicedTcbNetMetrics(
                                amount = 1.337, 
                                discount_charge_number = '0', 
                                end_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                                generated_reason = 'IncreaseQuantity', 
                ...
                update_product = openapi_client.models.update_product.updateProduct(
                    charge_updates = [
                        openapi_client.models.charge_update.ChargeUpdate(
                            ...
                            effective_date = openapi_client.models.start_date.startDate(
                                specific_trigger_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                                trigger_event = 'ContractEffective', ), 
                            pricing = openapi_client.models.pricing_update.PricingUpdate(
                                charge_model_data = openapi_client.models.charge_model_data.chargeModelData(
                                    charge_model_configuration = openapi_client.models.charge_model_data_override_charge_model_configuration.ChargeModelDataOverride_chargeModelConfiguration(
                                        custom_field_per_unit_rate = '0', 
                                        custom_field_total_amount = '0', 
